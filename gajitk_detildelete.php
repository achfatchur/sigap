...
<?php } ?>
<?php if ($gajitk_detil_delete->jp->Visible) { // jp ?>
		<th class="<?php echo $gajitk_detil_delete->jp->headerCellClass() ?>"><span id="elh_gajitk_detil_jp" class="gajitk_detil_jp"><?php echo $gajitk_detil_delete->jp->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($gajitk_detil_delete->jp->Visible) { // jp ?>
		<td <?php echo $gajitk_detil_delete->jp->cellAttributes() ?>>
<span id="el<?php echo $gajitk_detil_delete->RowCount ?>_gajitk_detil_jp" class="gajitk_detil_jp">
<span<?php echo $gajitk_detil_delete->jp->viewAttributes() ?>><?php echo $gajitk_detil_delete->jp->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
