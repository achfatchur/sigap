...
<?php } ?>
<?php if ($gajitk_detil_view->jp->Visible) { // jp ?>
	<tr id="r_jp">
		<td class="<?php echo $gajitk_detil_view->TableLeftColumnClass ?>"><span id="elh_gajitk_detil_jp"><?php echo $gajitk_detil_view->jp->caption() ?></span></td>
		<td data-name="jp" <?php echo $gajitk_detil_view->jp->cellAttributes() ?>>
<span id="el_gajitk_detil_jp">
<span<?php echo $gajitk_detil_view->jp->viewAttributes() ?>><?php echo $gajitk_detil_view->jp->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
