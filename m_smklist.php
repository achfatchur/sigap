...
<div id="xsr_<?php echo $m_smk_list->SearchRowCount ?>" class="ew-row d-sm-flex">
	...
	<div id="xsc_bulan" class="ew-cell form-group">
		<label for="x_bulan" class="ew-search-caption ew-label"><?php echo $m_smk_list->bulan->caption() ?></label>
		<span class="ew-search-operator">
<?php echo $Language->phrase("=") ?>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_smk" data-field="x_bulan" data-value-separator="<?php echo $m_smk_list->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_smk_list->bulan->editAttributes() ?>>
			<?php echo $m_smk_list->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
