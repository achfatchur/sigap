...
<?php } ?>
<?php if ($potongan_tk_view->tahun->Visible) { // tahun ?>
	<tr id="r_tahun">
		<td class="<?php echo $potongan_tk_view->TableLeftColumnClass ?>"><span id="elh_potongan_tk_tahun"><?php echo $potongan_tk_view->tahun->caption() ?></span></td>
		<td data-name="tahun" <?php echo $potongan_tk_view->tahun->cellAttributes() ?>>
<span id="el_potongan_tk_tahun">
<span<?php echo $potongan_tk_view->tahun->viewAttributes() ?>><?php echo $potongan_tk_view->tahun->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($potongan_tk_view->bulan->Visible) { // bulan ?>
	<tr id="r_bulan">
		<td class="<?php echo $potongan_tk_view->TableLeftColumnClass ?>"><span id="elh_potongan_tk_bulan"><?php echo $potongan_tk_view->bulan->caption() ?></span></td>
		<td data-name="bulan" <?php echo $potongan_tk_view->bulan->cellAttributes() ?>>
<span id="el_potongan_tk_bulan">
<span<?php echo $potongan_tk_view->bulan->viewAttributes() ?>><?php echo $potongan_tk_view->bulan->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_tk_view->sertif->Visible) { // sertif ?>
	<tr id="r_sertif">
		<td class="<?php echo $potongan_tk_view->TableLeftColumnClass ?>"><span id="elh_potongan_tk_sertif"><?php echo $potongan_tk_view->sertif->caption() ?></span></td>
		<td data-name="sertif" <?php echo $potongan_tk_view->sertif->cellAttributes() ?>>
<span id="el_potongan_tk_sertif">
<span<?php echo $potongan_tk_view->sertif->viewAttributes() ?>><?php echo $potongan_tk_view->sertif->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_tk_view->pid->Visible) { // pid ?>
	<tr id="r_pid">
		<td class="<?php echo $potongan_tk_view->TableLeftColumnClass ?>"><span id="elh_potongan_tk_pid"><?php echo $potongan_tk_view->pid->caption() ?></span></td>
		<td data-name="pid" <?php echo $potongan_tk_view->pid->cellAttributes() ?>>
<span id="el_potongan_tk_pid">
<span<?php echo $potongan_tk_view->pid->viewAttributes() ?>><?php echo $potongan_tk_view->pid->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
