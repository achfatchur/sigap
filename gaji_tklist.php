...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_tk_list->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_tk_list->bulan->getSessionValue()) ?>">
<?php } ?>
...
?>
<?php if ($gaji_tk_list->tahun->Visible) { // tahun ?>
	<?php if ($gaji_tk_list->SortUrl($gaji_tk_list->tahun) == "") { ?>
		<th data-name="tahun" class="<?php echo $gaji_tk_list->tahun->headerCellClass() ?>"><div id="elh_gaji_tk_tahun" class="gaji_tk_tahun"><div class="ew-table-header-caption"><?php echo $gaji_tk_list->tahun->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tahun" class="<?php echo $gaji_tk_list->tahun->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_tk_list->SortUrl($gaji_tk_list->tahun) ?>', 1);"><div id="elh_gaji_tk_tahun" class="gaji_tk_tahun">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tk_list->tahun->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tk_list->tahun->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tk_list->tahun->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_tk_list->bulan->Visible) { // bulan ?>
	<?php if ($gaji_tk_list->SortUrl($gaji_tk_list->bulan) == "") { ?>
		<th data-name="bulan" class="<?php echo $gaji_tk_list->bulan->headerCellClass() ?>"><div id="elh_gaji_tk_bulan" class="gaji_tk_bulan"><div class="ew-table-header-caption"><?php echo $gaji_tk_list->bulan->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="bulan" class="<?php echo $gaji_tk_list->bulan->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_tk_list->SortUrl($gaji_tk_list->bulan) ?>', 1);"><div id="elh_gaji_tk_bulan" class="gaji_tk_bulan">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tk_list->bulan->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tk_list->bulan->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tk_list->bulan->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_tk_list->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_tk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_tk_list->SortUrl($gaji_tk_list->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_tk_list->potongan_bendahara->headerCellClass() ?>"><div id="elh_gaji_tk_potongan_bendahara" class="gaji_tk_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $gaji_tk_list->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_tk_list->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_tk_list->SortUrl($gaji_tk_list->potongan_bendahara) ?>', 1);"><div id="elh_gaji_tk_potongan_bendahara" class="gaji_tk_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tk_list->potongan_bendahara->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($gaji_tk_list->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tk_list->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_tk_list->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_tk_list->voucher->Visible) { // voucher ?>
	<?php if ($gaji_tk_list->SortUrl($gaji_tk_list->voucher) == "") { ?>
		<th data-name="voucher" class="<?php echo $gaji_tk_list->voucher->headerCellClass() ?>"><div id="elh_gaji_tk_voucher" class="gaji_tk_voucher"><div class="ew-table-header-caption"><?php echo $gaji_tk_list->voucher->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="voucher" class="<?php echo $gaji_tk_list->voucher->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_tk_list->SortUrl($gaji_tk_list->voucher) ?>', 1);"><div id="elh_gaji_tk_voucher" class="gaji_tk_voucher">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tk_list->voucher->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tk_list->voucher->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tk_list->voucher->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($gaji_tk_list->tahun->Visible) { // tahun ?>
		<td data-name="tahun" <?php echo $gaji_tk_list->tahun->cellAttributes() ?>>
<span id="el<?php echo $gaji_tk_list->RowCount ?>_gaji_tk_tahun">
<span<?php echo $gaji_tk_list->tahun->viewAttributes() ?>><?php echo $gaji_tk_list->tahun->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_tk_list->bulan->Visible) { // bulan ?>
		<td data-name="bulan" <?php echo $gaji_tk_list->bulan->cellAttributes() ?>>
<span id="el<?php echo $gaji_tk_list->RowCount ?>_gaji_tk_bulan">
<span<?php echo $gaji_tk_list->bulan->viewAttributes() ?>><?php echo $gaji_tk_list->bulan->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_tk_list->pegawai->Visible) { // pegawai ?>
...
<span<?php echo $gaji_tk_list->penyesuaian->viewAttributes() ?>><?php echo $gaji_tk_list->penyesuaian->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_tk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $gaji_tk_list->potongan_bendahara->cellAttributes() ?>>
<span id="el<?php echo $gaji_tk_list->RowCount ?>_gaji_tk_potongan_bendahara">
<span<?php echo $gaji_tk_list->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_tk_list->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_tk_list->total->Visible) { // total ?>
...
<span<?php echo $gaji_tk_list->total->viewAttributes() ?>><?php echo $gaji_tk_list->total->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_tk_list->voucher->Visible) { // voucher ?>
		<td data-name="voucher" <?php echo $gaji_tk_list->voucher->cellAttributes() ?>>
<span id="el<?php echo $gaji_tk_list->RowCount ?>_gaji_tk_voucher">
<span<?php echo $gaji_tk_list->voucher->viewAttributes() ?>><?php echo $gaji_tk_list->voucher->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
