...
<?php if ($gajitk_detil_preview->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajitk_detil_preview->jp->Visible) { // jp ?>
	<?php if ($gajitk_detil->SortUrl($gajitk_detil_preview->jp) == "") { ?>
		<th class="<?php echo $gajitk_detil_preview->jp->headerCellClass() ?>"><?php echo $gajitk_detil_preview->jp->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gajitk_detil_preview->jp->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gajitk_detil_preview->jp->Name) ?>" data-sort-order="<?php echo $gajitk_detil_preview->SortField == $gajitk_detil_preview->jp->Name && $gajitk_detil_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajitk_detil_preview->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajitk_detil_preview->SortField == $gajitk_detil_preview->jp->Name) { ?><?php if ($gajitk_detil_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajitk_detil_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php if ($gajitk_detil_preview->jp->Visible) { // jp ?>
		<!-- jp -->
		<td<?php echo $gajitk_detil_preview->jp->cellAttributes() ?>>
<span<?php echo $gajitk_detil_preview->jp->viewAttributes() ?>><?php echo $gajitk_detil_preview->jp->getViewValue() ?></span>
</td>
<?php } ?>
<?php
