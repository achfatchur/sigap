...
<?php } ?>
<?php if ($terlambat_delete->valuejam->Visible) { // valuejam ?>
		<th class="<?php echo $terlambat_delete->valuejam->headerCellClass() ?>"><span id="elh_terlambat_valuejam" class="terlambat_valuejam"><?php echo $terlambat_delete->valuejam->caption() ?></span></th>
<?php } ?>
<?php if ($terlambat_delete->jenis_jabatan->Visible) { // jenis_jabatan ?>
		<th class="<?php echo $terlambat_delete->jenis_jabatan->headerCellClass() ?>"><span id="elh_terlambat_jenis_jabatan" class="terlambat_jenis_jabatan"><?php echo $terlambat_delete->jenis_jabatan->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($terlambat_delete->valuejam->Visible) { // valuejam ?>
		<td <?php echo $terlambat_delete->valuejam->cellAttributes() ?>>
<span id="el<?php echo $terlambat_delete->RowCount ?>_terlambat_valuejam" class="terlambat_valuejam">
<span<?php echo $terlambat_delete->valuejam->viewAttributes() ?>><?php echo $terlambat_delete->valuejam->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($terlambat_delete->jenis_jabatan->Visible) { // jenis_jabatan ?>
		<td <?php echo $terlambat_delete->jenis_jabatan->cellAttributes() ?>>
<span id="el<?php echo $terlambat_delete->RowCount ?>_terlambat_jenis_jabatan" class="terlambat_jenis_jabatan">
<span<?php echo $terlambat_delete->jenis_jabatan->viewAttributes() ?>><?php echo $terlambat_delete->jenis_jabatan->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
