...
<?php if ($gajisd_detil_preview->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajisd_detil_preview->jp->Visible) { // jp ?>
	<?php if ($gajisd_detil->SortUrl($gajisd_detil_preview->jp) == "") { ?>
		<th class="<?php echo $gajisd_detil_preview->jp->headerCellClass() ?>"><?php echo $gajisd_detil_preview->jp->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gajisd_detil_preview->jp->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gajisd_detil_preview->jp->Name) ?>" data-sort-order="<?php echo $gajisd_detil_preview->SortField == $gajisd_detil_preview->jp->Name && $gajisd_detil_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajisd_detil_preview->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajisd_detil_preview->SortField == $gajisd_detil_preview->jp->Name) { ?><?php if ($gajisd_detil_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajisd_detil_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php if ($gajisd_detil_preview->jp->Visible) { // jp ?>
		<!-- jp -->
		<td<?php echo $gajisd_detil_preview->jp->cellAttributes() ?>>
<span<?php echo $gajisd_detil_preview->jp->viewAttributes() ?>><?php echo $gajisd_detil_preview->jp->getViewValue() ?></span>
</td>
<?php } ?>
<?php
