...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_tk" data-field="x_bulan" data-value-separator="<?php echo $m_tk_list->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_tk_list->bulan->editAttributes() ?>>
			<?php echo $m_tk_list->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
