...
<?php if ($gaji_tu_tk_preview->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_tu_tk_preview->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_tu_tk->SortUrl($gaji_tu_tk_preview->potongan_bendahara) == "") { ?>
		<th class="<?php echo $gaji_tu_tk_preview->potongan_bendahara->headerCellClass() ?>"><?php echo $gaji_tu_tk_preview->potongan_bendahara->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_tu_tk_preview->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_tu_tk_preview->potongan_bendahara->Name) ?>" data-sort-order="<?php echo $gaji_tu_tk_preview->SortField == $gaji_tu_tk_preview->potongan_bendahara->Name && $gaji_tu_tk_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tu_tk_preview->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tu_tk_preview->SortField == $gaji_tu_tk_preview->potongan_bendahara->Name) { ?><?php if ($gaji_tu_tk_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tu_tk_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_tu_tk_preview->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<!-- potongan_bendahara -->
		<td<?php echo $gaji_tu_tk_preview->potongan_bendahara->cellAttributes() ?>>
<span<?php echo $gaji_tu_tk_preview->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_tu_tk_preview->potongan_bendahara->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_tu_tk_preview->total->Visible) { // total ?>
		<!-- total -->
