...
loadjs.ready("head", function() {
	...
	fpeg_skillgrid.lists["x_c_by"] = <?php echo $peg_skill_grid->c_by->Lookup->toClientList($peg_skill_grid) ?>;
	fpeg_skillgrid.lists["x_c_by"].options = <?php echo JsonEncode($peg_skill_grid->c_by->lookupOptions()) ?>;
	fpeg_skillgrid.autoSuggests["x_c_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	fpeg_skillgrid.lists["x_u_by"] = <?php echo $peg_skill_grid->u_by->Lookup->toClientList($peg_skill_grid) ?>;
	fpeg_skillgrid.lists["x_u_by"].options = <?php echo JsonEncode($peg_skill_grid->u_by->lookupOptions()) ?>;
	fpeg_skillgrid.autoSuggests["x_u_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
