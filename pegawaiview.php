...
<?php } ?>
<?php if ($pegawai_view->jjm->Visible) { // jjm ?>
	<tr id="r_jjm">
		<td class="<?php echo $pegawai_view->TableLeftColumnClass ?>"><span id="elh_pegawai_jjm"><?php echo $pegawai_view->jjm->caption() ?></span></td>
		<td data-name="jjm" <?php echo $pegawai_view->jjm->cellAttributes() ?>>
<span id="el_pegawai_jjm">
<span<?php echo $pegawai_view->jjm->viewAttributes() ?>><?php echo $pegawai_view->jjm->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pegawai_view->status_peg->Visible) { // status_peg ?>
	<tr id="r_status_peg">
		<td class="<?php echo $pegawai_view->TableLeftColumnClass ?>"><span id="elh_pegawai_status_peg"><?php echo $pegawai_view->status_peg->caption() ?></span></td>
		<td data-name="status_peg" <?php echo $pegawai_view->status_peg->cellAttributes() ?>>
<span id="el_pegawai_status_peg">
<span<?php echo $pegawai_view->status_peg->viewAttributes() ?>><?php echo $pegawai_view->status_peg->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($pegawai_view->kehadiran->Visible) { // kehadiran ?>
	<tr id="r_kehadiran">
		<td class="<?php echo $pegawai_view->TableLeftColumnClass ?>"><span id="elh_pegawai_kehadiran"><?php echo $pegawai_view->kehadiran->caption() ?></span></td>
		<td data-name="kehadiran" <?php echo $pegawai_view->kehadiran->cellAttributes() ?>>
<span id="el_pegawai_kehadiran">
<span<?php echo $pegawai_view->kehadiran->viewAttributes() ?>><?php echo $pegawai_view->kehadiran->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
