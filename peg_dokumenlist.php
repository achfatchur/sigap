...
<span<?php echo $peg_dokumen_list->file_dokumen->viewAttributes() ?>><?php echo GetFileViewTag($peg_dokumen_list->file_dokumen, $peg_dokumen_list->file_dokumen->getViewValue(), FALSE) ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($peg_dokumen_list->keterangan->Visible) { // keterangan ?>
