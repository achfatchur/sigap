...
<?php if ($gajisma_detil_list->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajisma_detil_list->jp->Visible) { // jp ?>
	<?php if ($gajisma_detil_list->SortUrl($gajisma_detil_list->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajisma_detil_list->jp->headerCellClass() ?>"><div id="elh_gajisma_detil_jp" class="gajisma_detil_jp"><div class="ew-table-header-caption"><?php echo $gajisma_detil_list->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajisma_detil_list->jp->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gajisma_detil_list->SortUrl($gajisma_detil_list->jp) ?>', 1);"><div id="elh_gajisma_detil_jp" class="gajisma_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajisma_detil_list->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajisma_detil_list->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajisma_detil_list->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gajisma_detil_list->jumlahterima->viewAttributes() ?>><?php echo $gajisma_detil_list->jumlahterima->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gajisma_detil_list->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajisma_detil_list->jp->cellAttributes() ?>>
<span id="el<?php echo $gajisma_detil_list->RowCount ?>_gajisma_detil_jp">
<span<?php echo $gajisma_detil_list->jp->viewAttributes() ?>><?php echo $gajisma_detil_list->jp->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
