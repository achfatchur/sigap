...
<?php if ($gaji_smk_delete->tahun->Visible) { // tahun ?>
		<th class="<?php echo $gaji_smk_delete->tahun->headerCellClass() ?>"><span id="elh_gaji_smk_tahun" class="gaji_smk_tahun"><?php echo $gaji_smk_delete->tahun->caption() ?></span></th>
<?php } ?>
<?php if ($gaji_smk_delete->bulan->Visible) { // bulan ?>
		<th class="<?php echo $gaji_smk_delete->bulan->headerCellClass() ?>"><span id="elh_gaji_smk_bulan" class="gaji_smk_bulan"><?php echo $gaji_smk_delete->bulan->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_smk_delete->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<th class="<?php echo $gaji_smk_delete->potongan_bendahara->headerCellClass() ?>"><span id="elh_gaji_smk_potongan_bendahara" class="gaji_smk_potongan_bendahara"><?php echo $gaji_smk_delete->potongan_bendahara->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_smk_delete->voucher->Visible) { // voucher ?>
		<th class="<?php echo $gaji_smk_delete->voucher->headerCellClass() ?>"><span id="elh_gaji_smk_voucher" class="gaji_smk_voucher"><?php echo $gaji_smk_delete->voucher->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($gaji_smk_delete->tahun->Visible) { // tahun ?>
		<td <?php echo $gaji_smk_delete->tahun->cellAttributes() ?>>
<span id="el<?php echo $gaji_smk_delete->RowCount ?>_gaji_smk_tahun" class="gaji_smk_tahun">
<span<?php echo $gaji_smk_delete->tahun->viewAttributes() ?>><?php echo $gaji_smk_delete->tahun->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($gaji_smk_delete->bulan->Visible) { // bulan ?>
		<td <?php echo $gaji_smk_delete->bulan->cellAttributes() ?>>
<span id="el<?php echo $gaji_smk_delete->RowCount ?>_gaji_smk_bulan" class="gaji_smk_bulan">
<span<?php echo $gaji_smk_delete->bulan->viewAttributes() ?>><?php echo $gaji_smk_delete->bulan->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($gaji_smk_delete->pegawai->Visible) { // pegawai ?>
...
<?php } ?>
<?php if ($gaji_smk_delete->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td <?php echo $gaji_smk_delete->potongan_bendahara->cellAttributes() ?>>
<span id="el<?php echo $gaji_smk_delete->RowCount ?>_gaji_smk_potongan_bendahara" class="gaji_smk_potongan_bendahara">
<span<?php echo $gaji_smk_delete->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_smk_delete->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($gaji_smk_delete->total->Visible) { // total ?>
...
<?php } ?>
<?php if ($gaji_smk_delete->voucher->Visible) { // voucher ?>
		<td <?php echo $gaji_smk_delete->voucher->cellAttributes() ?>>
<span id="el<?php echo $gaji_smk_delete->RowCount ?>_gaji_smk_voucher" class="gaji_smk_voucher">
<span<?php echo $gaji_smk_delete->voucher->viewAttributes() ?>><?php echo $gaji_smk_delete->voucher->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
