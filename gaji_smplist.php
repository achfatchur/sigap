...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_smp_list->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_smp_list->bulan->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($gaji_smp_list->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_smp_list->voucher->Visible) { // voucher ?>
	<?php if ($gaji_smp_list->SortUrl($gaji_smp_list->voucher) == "") { ?>
		<th data-name="voucher" class="<?php echo $gaji_smp_list->voucher->headerCellClass() ?>"><div id="elh_gaji_smp_voucher" class="gaji_smp_voucher"><div class="ew-table-header-caption"><?php echo $gaji_smp_list->voucher->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="voucher" class="<?php echo $gaji_smp_list->voucher->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_smp_list->SortUrl($gaji_smp_list->voucher) ?>', 1);"><div id="elh_gaji_smp_voucher" class="gaji_smp_voucher">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smp_list->voucher->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smp_list->voucher->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smp_list->voucher->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gaji_smp_list->total->viewAttributes() ?>><?php echo $gaji_smp_list->total->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_smp_list->voucher->Visible) { // voucher ?>
		<td data-name="voucher" <?php echo $gaji_smp_list->voucher->cellAttributes() ?>>
<span id="el<?php echo $gaji_smp_list->RowCount ?>_gaji_smp_voucher">
<span<?php echo $gaji_smp_list->voucher->viewAttributes() ?>><?php echo $gaji_smp_list->voucher->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
