...
<span<?php echo $peg_dokumen_delete->file_dokumen->viewAttributes() ?>><?php echo GetFileViewTag($peg_dokumen_delete->file_dokumen, $peg_dokumen_delete->file_dokumen->getViewValue(), FALSE) ?></span>
</span>
</td>
<?php } ?>
<?php if ($peg_dokumen_delete->keterangan->Visible) { // keterangan ?>
