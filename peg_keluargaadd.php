...
loadjs.ready("head", function() {
	...
	fpeg_keluargaadd.lists["x_jen_kel"] = <?php echo $peg_keluarga_add->jen_kel->Lookup->toClientList($peg_keluarga_add) ?>;
	fpeg_keluargaadd.lists["x_jen_kel"].options = <?php echo JsonEncode($peg_keluarga_add->jen_kel->lookupOptions()) ?>;
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="peg_keluarga" data-field="x_jen_kel" data-value-separator="<?php echo $peg_keluarga_add->jen_kel->displayValueSeparatorAttribute() ?>" id="x_jen_kel" name="x_jen_kel"<?php echo $peg_keluarga_add->jen_kel->editAttributes() ?>>
			<?php echo $peg_keluarga_add->jen_kel->selectOptionListHtml("x_jen_kel") ?>
		</select>
</div>
<?php echo $peg_keluarga_add->jen_kel->Lookup->getParamTag($peg_keluarga_add, "p_x_jen_kel") ?>
</span>
