...
<?php } ?>
<?php if ($terlambat_view->valuejam->Visible) { // valuejam ?>
	<tr id="r_valuejam">
		<td class="<?php echo $terlambat_view->TableLeftColumnClass ?>"><span id="elh_terlambat_valuejam"><?php echo $terlambat_view->valuejam->caption() ?></span></td>
		<td data-name="valuejam" <?php echo $terlambat_view->valuejam->cellAttributes() ?>>
<span id="el_terlambat_valuejam">
<span<?php echo $terlambat_view->valuejam->viewAttributes() ?>><?php echo $terlambat_view->valuejam->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($terlambat_view->jenis_jabatan->Visible) { // jenis_jabatan ?>
	<tr id="r_jenis_jabatan">
		<td class="<?php echo $terlambat_view->TableLeftColumnClass ?>"><span id="elh_terlambat_jenis_jabatan"><?php echo $terlambat_view->jenis_jabatan->caption() ?></span></td>
		<td data-name="jenis_jabatan" <?php echo $terlambat_view->jenis_jabatan->cellAttributes() ?>>
<span id="el_terlambat_jenis_jabatan">
<span<?php echo $terlambat_view->jenis_jabatan->viewAttributes() ?>><?php echo $terlambat_view->jenis_jabatan->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
