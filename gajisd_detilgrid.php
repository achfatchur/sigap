...
loadjs.ready("head", function() {
	...
	fgajisd_detilgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gajisd_detil_grid->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gajisd_detil_grid->jp->caption(), $gajisd_detil_grid->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gajisd_detil_grid->jp->errorMessage()) ?>");
...
<?php if ($gajisd_detil_grid->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajisd_detil_grid->jp->Visible) { // jp ?>
	<?php if ($gajisd_detil_grid->SortUrl($gajisd_detil_grid->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajisd_detil_grid->jp->headerCellClass() ?>"><div id="elh_gajisd_detil_jp" class="gajisd_detil_jp"><div class="ew-table-header-caption"><?php echo $gajisd_detil_grid->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajisd_detil_grid->jp->headerCellClass() ?>"><div><div id="elh_gajisd_detil_jp" class="gajisd_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajisd_detil_grid->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajisd_detil_grid->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajisd_detil_grid->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x<?php echo $gajisd_detil_grid->RowIndex ?>_jabatan_id"><?php echo EmptyValue(strval($gajisd_detil_grid->jabatan_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $gajisd_detil_grid->jabatan_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($gajisd_detil_grid->jabatan_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($gajisd_detil_grid->jabatan_id->ReadOnly || $gajisd_detil_grid->jabatan_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x<?php echo $gajisd_detil_grid->RowIndex ?>_jabatan_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $gajisd_detil_grid->jabatan_id->Lookup->getParamTag($gajisd_detil_grid, "p_x" . $gajisd_detil_grid->RowIndex . "_jabatan_id") ?>
<input type="hidden" data-table="gajisd_detil" data-field="x_jabatan_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $gajisd_detil_grid->jabatan_id->displayValueSeparatorAttribute() ?>" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jabatan_id" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jabatan_id" value="<?php echo $gajisd_detil_grid->jabatan_id->CurrentValue ?>"<?php echo $gajisd_detil_grid->jabatan_id->editAttributes() ?>>
</span>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gajisd_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajisd_detil_grid->jp->cellAttributes() ?>>
<?php if ($gajisd_detil->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gajisd_detil_grid->RowCount ?>_gajisd_detil_jp" class="form-group">
<input type="text" data-table="gajisd_detil" data-field="x_jp" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisd_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisd_detil_grid->jp->EditValue ?>"<?php echo $gajisd_detil_grid->jp->editAttributes() ?>>
</span>
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php if ($gajisd_detil->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gajisd_detil_grid->RowCount ?>_gajisd_detil_jp" class="form-group">
<input type="text" data-table="gajisd_detil" data-field="x_jp" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisd_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisd_detil_grid->jp->EditValue ?>"<?php echo $gajisd_detil_grid->jp->editAttributes() ?>>
...
<?php } ?>
<?php if ($gajisd_detil->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gajisd_detil_grid->RowCount ?>_gajisd_detil_jp">
<span<?php echo $gajisd_detil_grid->jp->viewAttributes() ?>><?php echo $gajisd_detil_grid->jp->getViewValue() ?></span>
</span>
<?php if (!$gajisd_detil->isConfirm()) { ?>
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="fgajisd_detilgrid$x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="fgajisd_detilgrid$x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="fgajisd_detilgrid$o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="fgajisd_detilgrid$o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="gajisd_detil" data-field="x_jumlahterima" name="o<?php echo $gajisd_detil_grid->RowIndex ?>_jumlahterima" id="o<?php echo $gajisd_detil_grid->RowIndex ?>_jumlahterima" value="<?php echo HtmlEncode($gajisd_detil_grid->jumlahterima->OldValue) ?>">
	...
	<?php if ($gajisd_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp">
<?php if (!$gajisd_detil->isConfirm()) { ?>
<span id="el$rowindex$_gajisd_detil_jp" class="form-group gajisd_detil_jp">
<input type="text" data-table="gajisd_detil" data-field="x_jp" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisd_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisd_detil_grid->jp->EditValue ?>"<?php echo $gajisd_detil_grid->jp->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gajisd_detil_jp" class="form-group gajisd_detil_jp">
<span<?php echo $gajisd_detil_grid->jp->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gajisd_detil_grid->jp->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gajisd_detil" data-field="x_jp" name="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisd_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisd_detil_grid->jp->OldValue) ?>">
