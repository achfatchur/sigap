...
<?php } ?>
<?php if ($gajisd_detil_delete->jp->Visible) { // jp ?>
		<th class="<?php echo $gajisd_detil_delete->jp->headerCellClass() ?>"><span id="elh_gajisd_detil_jp" class="gajisd_detil_jp"><?php echo $gajisd_detil_delete->jp->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($gajisd_detil_delete->jp->Visible) { // jp ?>
		<td <?php echo $gajisd_detil_delete->jp->cellAttributes() ?>>
<span id="el<?php echo $gajisd_detil_delete->RowCount ?>_gajisd_detil_jp" class="gajisd_detil_jp">
<span<?php echo $gajisd_detil_delete->jp->viewAttributes() ?>><?php echo $gajisd_detil_delete->jp->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
