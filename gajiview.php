...
<?php } ?>
<?php if ($gaji_view->tahun->Visible) { // tahun ?>
	<tr id="r_tahun">
		<td class="<?php echo $gaji_view->TableLeftColumnClass ?>"><span id="elh_gaji_tahun"><?php echo $gaji_view->tahun->caption() ?></span></td>
		<td data-name="tahun" <?php echo $gaji_view->tahun->cellAttributes() ?>>
<span id="el_gaji_tahun">
<span<?php echo $gaji_view->tahun->viewAttributes() ?>><?php echo $gaji_view->tahun->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_view->bulan->Visible) { // bulan ?>
	<tr id="r_bulan">
		<td class="<?php echo $gaji_view->TableLeftColumnClass ?>"><span id="elh_gaji_bulan"><?php echo $gaji_view->bulan->caption() ?></span></td>
		<td data-name="bulan" <?php echo $gaji_view->bulan->cellAttributes() ?>>
<span id="el_gaji_bulan">
<span<?php echo $gaji_view->bulan->viewAttributes() ?>><?php echo $gaji_view->bulan->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_view->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="<?php echo $gaji_view->TableLeftColumnClass ?>"><span id="elh_gaji_status"><?php echo $gaji_view->status->caption() ?></span></td>
		<td data-name="status" <?php echo $gaji_view->status->cellAttributes() ?>>
<span id="el_gaji_status">
<span<?php echo $gaji_view->status->viewAttributes() ?>><?php echo $gaji_view->status->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_view->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<tr id="r_potongan_bendahara">
		<td class="<?php echo $gaji_view->TableLeftColumnClass ?>"><span id="elh_gaji_potongan_bendahara"><?php echo $gaji_view->potongan_bendahara->caption() ?></span></td>
		<td data-name="potongan_bendahara" <?php echo $gaji_view->potongan_bendahara->cellAttributes() ?>>
<span id="el_gaji_potongan_bendahara">
<span<?php echo $gaji_view->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_view->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
