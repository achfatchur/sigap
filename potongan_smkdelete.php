...
<?php if ($potongan_smk_delete->tahun->Visible) { // tahun ?>
		<th class="<?php echo $potongan_smk_delete->tahun->headerCellClass() ?>"><span id="elh_potongan_smk_tahun" class="potongan_smk_tahun"><?php echo $potongan_smk_delete->tahun->caption() ?></span></th>
<?php } ?>
<?php if ($potongan_smk_delete->bulan->Visible) { // bulan ?>
		<th class="<?php echo $potongan_smk_delete->bulan->headerCellClass() ?>"><span id="elh_potongan_smk_bulan" class="potongan_smk_bulan"><?php echo $potongan_smk_delete->bulan->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_smk_delete->sertif->Visible) { // sertif ?>
		<th class="<?php echo $potongan_smk_delete->sertif->headerCellClass() ?>"><span id="elh_potongan_smk_sertif" class="potongan_smk_sertif"><?php echo $potongan_smk_delete->sertif->caption() ?></span></th>
<?php } ?>
...
<?php if ($potongan_smk_delete->tahun->Visible) { // tahun ?>
		<td <?php echo $potongan_smk_delete->tahun->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_delete->RowCount ?>_potongan_smk_tahun" class="potongan_smk_tahun">
<span<?php echo $potongan_smk_delete->tahun->viewAttributes() ?>><?php echo $potongan_smk_delete->tahun->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_smk_delete->bulan->Visible) { // bulan ?>
		<td <?php echo $potongan_smk_delete->bulan->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_delete->RowCount ?>_potongan_smk_bulan" class="potongan_smk_bulan">
<span<?php echo $potongan_smk_delete->bulan->viewAttributes() ?>><?php echo $potongan_smk_delete->bulan->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_smk_delete->nama->Visible) { // nama ?>
...
<?php } ?>
<?php if ($potongan_smk_delete->sertif->Visible) { // sertif ?>
		<td <?php echo $potongan_smk_delete->sertif->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_delete->RowCount ?>_potongan_smk_sertif" class="potongan_smk_sertif">
<span<?php echo $potongan_smk_delete->sertif->viewAttributes() ?>><?php echo $potongan_smk_delete->sertif->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_smk_delete->terlambat->Visible) { // terlambat ?>
