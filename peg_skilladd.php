...
loadjs.ready("head", function() {
	...
	fpeg_skilladd.lists["x_c_by"] = <?php echo $peg_skill_add->c_by->Lookup->toClientList($peg_skill_add) ?>;
	fpeg_skilladd.lists["x_c_by"].options = <?php echo JsonEncode($peg_skill_add->c_by->lookupOptions()) ?>;
	fpeg_skilladd.autoSuggests["x_c_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	fpeg_skilladd.lists["x_u_by"] = <?php echo $peg_skill_add->u_by->Lookup->toClientList($peg_skill_add) ?>;
	fpeg_skilladd.lists["x_u_by"].options = <?php echo JsonEncode($peg_skill_add->u_by->lookupOptions()) ?>;
	fpeg_skilladd.autoSuggests["x_u_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
