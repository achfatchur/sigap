...
loadjs.ready("head", function() {
	...
	fgajismk_detilgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gajismk_detil_grid->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gajismk_detil_grid->jp->caption(), $gajismk_detil_grid->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gajismk_detil_grid->jp->errorMessage()) ?>");
...
<?php if ($gajismk_detil_grid->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajismk_detil_grid->jp->Visible) { // jp ?>
	<?php if ($gajismk_detil_grid->SortUrl($gajismk_detil_grid->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajismk_detil_grid->jp->headerCellClass() ?>"><div id="elh_gajismk_detil_jp" class="gajismk_detil_jp"><div class="ew-table-header-caption"><?php echo $gajismk_detil_grid->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajismk_detil_grid->jp->headerCellClass() ?>"><div><div id="elh_gajismk_detil_jp" class="gajismk_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajismk_detil_grid->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajismk_detil_grid->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajismk_detil_grid->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gajismk_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajismk_detil_grid->jp->cellAttributes() ?>>
<?php if ($gajismk_detil->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gajismk_detil_grid->RowCount ?>_gajismk_detil_jp" class="form-group">
<input type="text" data-table="gajismk_detil" data-field="x_jp" name="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajismk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajismk_detil_grid->jp->EditValue ?>"<?php echo $gajismk_detil_grid->jp->editAttributes() ?>>
</span>
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php if ($gajismk_detil->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gajismk_detil_grid->RowCount ?>_gajismk_detil_jp" class="form-group">
<input type="text" data-table="gajismk_detil" data-field="x_jp" name="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajismk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajismk_detil_grid->jp->EditValue ?>"<?php echo $gajismk_detil_grid->jp->editAttributes() ?>>
...
<?php } ?>
<?php if ($gajismk_detil->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gajismk_detil_grid->RowCount ?>_gajismk_detil_jp">
<span<?php echo $gajismk_detil_grid->jp->viewAttributes() ?>><?php echo $gajismk_detil_grid->jp->getViewValue() ?></span>
</span>
<?php if (!$gajismk_detil->isConfirm()) { ?>
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="fgajismk_detilgrid$x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="fgajismk_detilgrid$x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="fgajismk_detilgrid$o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="fgajismk_detilgrid$o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="gajismk_detil" data-field="x_jumlahterima" name="o<?php echo $gajismk_detil_grid->RowIndex ?>_jumlahterima" id="o<?php echo $gajismk_detil_grid->RowIndex ?>_jumlahterima" value="<?php echo HtmlEncode($gajismk_detil_grid->jumlahterima->OldValue) ?>">
	...
	<?php if ($gajismk_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp">
<?php if (!$gajismk_detil->isConfirm()) { ?>
<span id="el$rowindex$_gajismk_detil_jp" class="form-group gajismk_detil_jp">
<input type="text" data-table="gajismk_detil" data-field="x_jp" name="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajismk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajismk_detil_grid->jp->EditValue ?>"<?php echo $gajismk_detil_grid->jp->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gajismk_detil_jp" class="form-group gajismk_detil_jp">
<span<?php echo $gajismk_detil_grid->jp->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gajismk_detil_grid->jp->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gajismk_detil" data-field="x_jp" name="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajismk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajismk_detil_grid->jp->OldValue) ?>">
