...
<?php if ($m_sakit_list->jabatan->Visible) { // jabatan ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($m_sakit_list->sertif->Visible) { // sertif ?>
	<?php if ($m_sakit_list->SortUrl($m_sakit_list->sertif) == "") { ?>
		<th data-name="sertif" class="<?php echo $m_sakit_list->sertif->headerCellClass() ?>"><div id="elh_m_sakit_sertif" class="m_sakit_sertif"><div class="ew-table-header-caption"><?php echo $m_sakit_list->sertif->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sertif" class="<?php echo $m_sakit_list->sertif->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $m_sakit_list->SortUrl($m_sakit_list->sertif) ?>', 1);"><div id="elh_m_sakit_sertif" class="m_sakit_sertif">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $m_sakit_list->sertif->caption() ?></span><span class="ew-table-header-sort"><?php if ($m_sakit_list->sertif->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($m_sakit_list->sertif->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($m_sakit_list->perjam->Visible) { // perjam ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($m_sakit_list->type->Visible) { // type ?>
	<?php if ($m_sakit_list->SortUrl($m_sakit_list->type) == "") { ?>
		<th data-name="type" class="<?php echo $m_sakit_list->type->headerCellClass() ?>"><div id="elh_m_sakit_type" class="m_sakit_type"><div class="ew-table-header-caption"><?php echo $m_sakit_list->type->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="type" class="<?php echo $m_sakit_list->type->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $m_sakit_list->SortUrl($m_sakit_list->type) ?>', 1);"><div id="elh_m_sakit_type" class="m_sakit_type">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $m_sakit_list->type->caption() ?></span><span class="ew-table-header-sort"><?php if ($m_sakit_list->type->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($m_sakit_list->type->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $m_sakit_list->jabatan->viewAttributes() ?>><?php echo $m_sakit_list->jabatan->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($m_sakit_list->sertif->Visible) { // sertif ?>
		<td data-name="sertif" <?php echo $m_sakit_list->sertif->cellAttributes() ?>>
<span id="el<?php echo $m_sakit_list->RowCount ?>_m_sakit_sertif">
<span<?php echo $m_sakit_list->sertif->viewAttributes() ?>><?php echo $m_sakit_list->sertif->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($m_sakit_list->perhari->Visible) { // perhari ?>
...
<span<?php echo $m_sakit_list->perjam->viewAttributes() ?>><?php echo $m_sakit_list->perjam->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($m_sakit_list->type->Visible) { // type ?>
		<td data-name="type" <?php echo $m_sakit_list->type->cellAttributes() ?>>
<span id="el<?php echo $m_sakit_list->RowCount ?>_m_sakit_type">
<span<?php echo $m_sakit_list->type->viewAttributes() ?>><?php echo $m_sakit_list->type->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
