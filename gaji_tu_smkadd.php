...
loadjs.ready("head", function() {
	...
	fgaji_tu_smkadd.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_tu_smk_add->tahun->Required) { ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smk_add->tahun->caption(), $gaji_tu_smk_add->tahun->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smk_add->tahun->errorMessage()) ?>");
			<?php if ($gaji_tu_smk_add->bulan->Required) { ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smk_add->bulan->caption(), $gaji_tu_smk_add->bulan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smk_add->bulan->errorMessage()) ?>");
			...
			<?php if ($gaji_tu_smk_add->sertif->Required) { ?>
				elm = this.getElements("x" + infix + "_sertif");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smk_add->sertif->caption(), $gaji_tu_smk_add->sertif->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_sertif");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smk_add->sertif->errorMessage()) ?>");
			<?php if ($gaji_tu_smk_add->lama_kerja->Required) { ?>
				elm = this.getElements("x" + infix + "_lama_kerja");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smk_add->lama_kerja->caption(), $gaji_tu_smk_add->lama_kerja->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_lama_kerja");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smk_add->lama_kerja->errorMessage()) ?>");
			...
			<?php if ($gaji_tu_smk_add->value_kehadiran->Required) { ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smk_add->value_kehadiran->caption(), $gaji_tu_smk_add->value_kehadiran->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smk_add->value_kehadiran->errorMessage()) ?>");
	...
	fgaji_tu_smkadd.lists["x_bulan"] = <?php echo $gaji_tu_smk_add->bulan->Lookup->toClientList($gaji_tu_smk_add) ?>;
	fgaji_tu_smkadd.lists["x_bulan"].options = <?php echo JsonEncode($gaji_tu_smk_add->bulan->lookupOptions()) ?>;
	fgaji_tu_smkadd.autoSuggests["x_bulan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	...
	fgaji_tu_smkadd.lists["x_type_jabatan"] = <?php echo $gaji_tu_smk_add->type_jabatan->Lookup->toClientList($gaji_tu_smk_add) ?>;
	fgaji_tu_smkadd.lists["x_type_jabatan"].options = <?php echo JsonEncode($gaji_tu_smk_add->type_jabatan->lookupOptions()) ?>;
	fgaji_tu_smkadd.autoSuggests["x_type_jabatan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	fgaji_tu_smkadd.lists["x_tambahan"] = <?php echo $gaji_tu_smk_add->tambahan->Lookup->toClientList($gaji_tu_smk_add) ?>;
	fgaji_tu_smkadd.lists["x_tambahan"].options = <?php echo JsonEncode($gaji_tu_smk_add->tambahan->lookupOptions()) ?>;
	fgaji_tu_smkadd.autoSuggests["x_tambahan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	fgaji_tu_smkadd.lists["x_sertif"] = <?php echo $gaji_tu_smk_add->sertif->Lookup->toClientList($gaji_tu_smk_add) ?>;
	fgaji_tu_smkadd.lists["x_sertif"].options = <?php echo JsonEncode($gaji_tu_smk_add->sertif->lookupOptions()) ?>;
	fgaji_tu_smkadd.autoSuggests["x_sertif"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_tu_smk_add->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_tu_smk_add->bulan->getSessionValue()) ?>">
<?php } ?>
<div class="ew-add-div"><!-- page* -->
<?php if ($gaji_tu_smk_add->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_gaji_tu_smk_tahun" for="x_tahun" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->tahun->caption() ?><?php echo $gaji_tu_smk_add->tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_smk_add->RightColumnClass ?>"><div <?php echo $gaji_tu_smk_add->tahun->cellAttributes() ?>>
<?php if ($gaji_tu_smk_add->tahun->getSessionValue() != "") { ?>
<span id="el_gaji_tu_smk_tahun">
<span<?php echo $gaji_tu_smk_add->tahun->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_tu_smk_add->tahun->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_tahun" name="x_tahun" value="<?php echo HtmlEncode($gaji_tu_smk_add->tahun->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_tu_smk_tahun">
<input type="text" data-table="gaji_tu_smk" data-field="x_tahun" name="x_tahun" id="x_tahun" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->tahun->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smk_add->tahun->EditValue ?>"<?php echo $gaji_tu_smk_add->tahun->editAttributes() ?>>
</span>
<?php } ?>
<?php echo $gaji_tu_smk_add->tahun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_smk_add->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_gaji_tu_smk_bulan" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->bulan->caption() ?><?php echo $gaji_tu_smk_add->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_smk_add->RightColumnClass ?>"><div <?php echo $gaji_tu_smk_add->bulan->cellAttributes() ?>>
<?php if ($gaji_tu_smk_add->bulan->getSessionValue() != "") { ?>
<span id="el_gaji_tu_smk_bulan">
<span<?php echo $gaji_tu_smk_add->bulan->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_tu_smk_add->bulan->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_bulan" name="x_bulan" value="<?php echo HtmlEncode($gaji_tu_smk_add->bulan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_tu_smk_bulan">
<?php
$onchange = $gaji_tu_smk_add->bulan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_smk_add->bulan->EditAttrs["onchange"] = "";
?>
<span id="as_x_bulan">
	<input type="text" class="form-control" name="sv_x_bulan" id="sv_x_bulan" value="<?php echo RemoveHtml($gaji_tu_smk_add->bulan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->bulan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->bulan->getPlaceHolder()) ?>"<?php echo $gaji_tu_smk_add->bulan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_smk" data-field="x_bulan" data-value-separator="<?php echo $gaji_tu_smk_add->bulan->displayValueSeparatorAttribute() ?>" name="x_bulan" id="x_bulan" value="<?php echo HtmlEncode($gaji_tu_smk_add->bulan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_smkadd"], function() {
	fgaji_tu_smkadd.createAutoSuggest({"id":"x_bulan","forceSelect":false});
});
</script>
<?php echo $gaji_tu_smk_add->bulan->Lookup->getParamTag($gaji_tu_smk_add, "p_x_bulan") ?>
</span>
<?php } ?>
<?php echo $gaji_tu_smk_add->bulan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($gaji_tu_smk_add->type_jabatan->Visible) { // type_jabatan ?>
	<div id="r_type_jabatan" class="form-group row">
		<label id="elh_gaji_tu_smk_type_jabatan" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->type_jabatan->caption() ?><?php echo $gaji_tu_smk_add->type_jabatan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php
$onchange = $gaji_tu_smk_add->type_jabatan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_smk_add->type_jabatan->EditAttrs["onchange"] = "";
?>
<span id="as_x_type_jabatan">
	<input type="text" class="form-control" name="sv_x_type_jabatan" id="sv_x_type_jabatan" value="<?php echo RemoveHtml($gaji_tu_smk_add->type_jabatan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->type_jabatan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->type_jabatan->getPlaceHolder()) ?>"<?php echo $gaji_tu_smk_add->type_jabatan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_smk" data-field="x_type_jabatan" data-value-separator="<?php echo $gaji_tu_smk_add->type_jabatan->displayValueSeparatorAttribute() ?>" name="x_type_jabatan" id="x_type_jabatan" value="<?php echo HtmlEncode($gaji_tu_smk_add->type_jabatan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_smkadd"], function() {
	fgaji_tu_smkadd.createAutoSuggest({"id":"x_type_jabatan","forceSelect":false});
});
</script>
<?php echo $gaji_tu_smk_add->type_jabatan->Lookup->getParamTag($gaji_tu_smk_add, "p_x_type_jabatan") ?>
</span>
...
<?php if ($gaji_tu_smk_add->tambahan->Visible) { // tambahan ?>
	<div id="r_tambahan" class="form-group row">
		<label id="elh_gaji_tu_smk_tambahan" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->tambahan->caption() ?><?php echo $gaji_tu_smk_add->tambahan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php
$onchange = $gaji_tu_smk_add->tambahan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_smk_add->tambahan->EditAttrs["onchange"] = "";
?>
<span id="as_x_tambahan">
	<input type="text" class="form-control" name="sv_x_tambahan" id="sv_x_tambahan" value="<?php echo RemoveHtml($gaji_tu_smk_add->tambahan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->tambahan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->tambahan->getPlaceHolder()) ?>"<?php echo $gaji_tu_smk_add->tambahan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_smk" data-field="x_tambahan" data-value-separator="<?php echo $gaji_tu_smk_add->tambahan->displayValueSeparatorAttribute() ?>" name="x_tambahan" id="x_tambahan" value="<?php echo HtmlEncode($gaji_tu_smk_add->tambahan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_smkadd"], function() {
	fgaji_tu_smkadd.createAutoSuggest({"id":"x_tambahan","forceSelect":false});
});
</script>
<?php echo $gaji_tu_smk_add->tambahan->Lookup->getParamTag($gaji_tu_smk_add, "p_x_tambahan") ?>
</span>
<?php echo $gaji_tu_smk_add->tambahan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_smk_add->sertif->Visible) { // sertif ?>
	<div id="r_sertif" class="form-group row">
		<label id="elh_gaji_tu_smk_sertif" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->sertif->caption() ?><?php echo $gaji_tu_smk_add->sertif->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_smk_add->RightColumnClass ?>"><div <?php echo $gaji_tu_smk_add->sertif->cellAttributes() ?>>
<span id="el_gaji_tu_smk_sertif">
<?php
$onchange = $gaji_tu_smk_add->sertif->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_smk_add->sertif->EditAttrs["onchange"] = "";
?>
<span id="as_x_sertif">
	<input type="text" class="form-control" name="sv_x_sertif" id="sv_x_sertif" value="<?php echo RemoveHtml($gaji_tu_smk_add->sertif->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->sertif->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->sertif->getPlaceHolder()) ?>"<?php echo $gaji_tu_smk_add->sertif->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_smk" data-field="x_sertif" data-value-separator="<?php echo $gaji_tu_smk_add->sertif->displayValueSeparatorAttribute() ?>" name="x_sertif" id="x_sertif" value="<?php echo HtmlEncode($gaji_tu_smk_add->sertif->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_smkadd"], function() {
	fgaji_tu_smkadd.createAutoSuggest({"id":"x_sertif","forceSelect":false});
});
</script>
<?php echo $gaji_tu_smk_add->sertif->Lookup->getParamTag($gaji_tu_smk_add, "p_x_sertif") ?>
</span>
<?php echo $gaji_tu_smk_add->sertif->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_smk_add->lama_kerja->Visible) { // lama_kerja ?>
	<div id="r_lama_kerja" class="form-group row">
		<label id="elh_gaji_tu_smk_lama_kerja" for="x_lama_kerja" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->lama_kerja->caption() ?><?php echo $gaji_tu_smk_add->lama_kerja->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_smk_add->RightColumnClass ?>"><div <?php echo $gaji_tu_smk_add->lama_kerja->cellAttributes() ?>>
<span id="el_gaji_tu_smk_lama_kerja">
<input type="text" data-table="gaji_tu_smk" data-field="x_lama_kerja" name="x_lama_kerja" id="x_lama_kerja" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->lama_kerja->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smk_add->lama_kerja->EditValue ?>"<?php echo $gaji_tu_smk_add->lama_kerja->editAttributes() ?>>
</span>
<?php echo $gaji_tu_smk_add->lama_kerja->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_smk_add->value_kehadiran->Visible) { // value_kehadiran ?>
	<div id="r_value_kehadiran" class="form-group row">
		<label id="elh_gaji_tu_smk_value_kehadiran" for="x_value_kehadiran" class="<?php echo $gaji_tu_smk_add->LeftColumnClass ?>"><?php echo $gaji_tu_smk_add->value_kehadiran->caption() ?><?php echo $gaji_tu_smk_add->value_kehadiran->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_smk_add->RightColumnClass ?>"><div <?php echo $gaji_tu_smk_add->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_tu_smk_value_kehadiran">
<input type="text" data-table="gaji_tu_smk" data-field="x_value_kehadiran" name="x_value_kehadiran" id="x_value_kehadiran" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_smk_add->value_kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smk_add->value_kehadiran->EditValue ?>"<?php echo $gaji_tu_smk_add->value_kehadiran->editAttributes() ?>>
</span>
<?php echo $gaji_tu_smk_add->value_kehadiran->CustomMsg ?></div></div>
	</div>
<?php } ?>
