...
<?php } ?>
<?php if ($gaji_tu_smp_view->tahun->Visible) { // tahun ?>
	<tr id="r_tahun">
		<td class="<?php echo $gaji_tu_smp_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_smp_tahun"><?php echo $gaji_tu_smp_view->tahun->caption() ?></span></td>
		<td data-name="tahun" <?php echo $gaji_tu_smp_view->tahun->cellAttributes() ?>>
<span id="el_gaji_tu_smp_tahun">
<span<?php echo $gaji_tu_smp_view->tahun->viewAttributes() ?>><?php echo $gaji_tu_smp_view->tahun->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_tu_smp_view->bulan->Visible) { // bulan ?>
	<tr id="r_bulan">
		<td class="<?php echo $gaji_tu_smp_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_smp_bulan"><?php echo $gaji_tu_smp_view->bulan->caption() ?></span></td>
		<td data-name="bulan" <?php echo $gaji_tu_smp_view->bulan->cellAttributes() ?>>
<span id="el_gaji_tu_smp_bulan">
<span<?php echo $gaji_tu_smp_view->bulan->viewAttributes() ?>><?php echo $gaji_tu_smp_view->bulan->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_smp_view->lama_kerja->Visible) { // lama_kerja ?>
	<tr id="r_lama_kerja">
		<td class="<?php echo $gaji_tu_smp_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_smp_lama_kerja"><?php echo $gaji_tu_smp_view->lama_kerja->caption() ?></span></td>
		<td data-name="lama_kerja" <?php echo $gaji_tu_smp_view->lama_kerja->cellAttributes() ?>>
<span id="el_gaji_tu_smp_lama_kerja">
<span<?php echo $gaji_tu_smp_view->lama_kerja->viewAttributes() ?>><?php echo $gaji_tu_smp_view->lama_kerja->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_smp_view->sertif->Visible) { // sertif ?>
	<tr id="r_sertif">
		<td class="<?php echo $gaji_tu_smp_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_smp_sertif"><?php echo $gaji_tu_smp_view->sertif->caption() ?></span></td>
		<td data-name="sertif" <?php echo $gaji_tu_smp_view->sertif->cellAttributes() ?>>
<span id="el_gaji_tu_smp_sertif">
<span<?php echo $gaji_tu_smp_view->sertif->viewAttributes() ?>><?php echo $gaji_tu_smp_view->sertif->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_smp_view->value_kehadiran->Visible) { // value_kehadiran ?>
	<tr id="r_value_kehadiran">
		<td class="<?php echo $gaji_tu_smp_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_smp_value_kehadiran"><?php echo $gaji_tu_smp_view->value_kehadiran->caption() ?></span></td>
		<td data-name="value_kehadiran" <?php echo $gaji_tu_smp_view->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_tu_smp_value_kehadiran">
<span<?php echo $gaji_tu_smp_view->value_kehadiran->viewAttributes() ?>><?php echo $gaji_tu_smp_view->value_kehadiran->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
