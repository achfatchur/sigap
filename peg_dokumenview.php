...
<span<?php echo $peg_dokumen_view->file_dokumen->viewAttributes() ?>><?php echo GetFileViewTag($peg_dokumen_view->file_dokumen, $peg_dokumen_view->file_dokumen->getViewValue(), FALSE) ?></span>
</span>
</td>
	</tr>
<?php } ?>
