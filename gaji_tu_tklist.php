...
<?php if ($gaji_tu_tk_list->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_tu_tk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_tu_tk_list->SortUrl($gaji_tu_tk_list->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_tu_tk_list->potongan_bendahara->headerCellClass() ?>"><div id="elh_gaji_tu_tk_potongan_bendahara" class="gaji_tu_tk_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $gaji_tu_tk_list->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_tu_tk_list->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_tu_tk_list->SortUrl($gaji_tu_tk_list->potongan_bendahara) ?>', 1);"><div id="elh_gaji_tu_tk_potongan_bendahara" class="gaji_tu_tk_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tu_tk_list->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tu_tk_list->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tu_tk_list->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<span<?php echo $gaji_tu_tk_list->penyesuaian->viewAttributes() ?>><?php echo $gaji_tu_tk_list->penyesuaian->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_tu_tk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $gaji_tu_tk_list->potongan_bendahara->cellAttributes() ?>>
<span id="el<?php echo $gaji_tu_tk_list->RowCount ?>_gaji_tu_tk_potongan_bendahara">
<span<?php echo $gaji_tu_tk_list->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_tu_tk_list->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_tu_tk_list->total->Visible) { // total ?>
