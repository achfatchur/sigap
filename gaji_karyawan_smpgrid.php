...
loadjs.ready("head", function() {
	...
	fgaji_karyawan_smpgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_karyawan_smp_grid->voucher->Required) { ?>
				elm = this.getElements("x" + infix + "_voucher");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_smp_grid->voucher->caption(), $gaji_karyawan_smp_grid->voucher->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_voucher");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_smp_grid->voucher->errorMessage()) ?>");
			<?php if ($gaji_karyawan_smp_grid->potongan_bendahara->Required) { ?>
				elm = this.getElements("x" + infix + "_potongan_bendahara");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_smp_grid->potongan_bendahara->caption(), $gaji_karyawan_smp_grid->potongan_bendahara->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_potongan_bendahara");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_smp_grid->potongan_bendahara->errorMessage()) ?>");
...
<?php if ($gaji_karyawan_smp_grid->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_smp_grid->voucher->Visible) { // voucher ?>
	<?php if ($gaji_karyawan_smp_grid->SortUrl($gaji_karyawan_smp_grid->voucher) == "") { ?>
		<th data-name="voucher" class="<?php echo $gaji_karyawan_smp_grid->voucher->headerCellClass() ?>"><div id="elh_gaji_karyawan_smp_voucher" class="gaji_karyawan_smp_voucher"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_smp_grid->voucher->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="voucher" class="<?php echo $gaji_karyawan_smp_grid->voucher->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_smp_voucher" class="gaji_karyawan_smp_voucher">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_smp_grid->voucher->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_smp_grid->voucher->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_smp_grid->voucher->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_smp_grid->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_karyawan_smp_grid->SortUrl($gaji_karyawan_smp_grid->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->headerCellClass() ?>"><div id="elh_gaji_karyawan_smp_potongan_bendahara" class="gaji_karyawan_smp_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_smp_grid->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_smp_potongan_bendahara" class="gaji_karyawan_smp_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_smp_grid->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_smp_grid->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_smp_grid->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gaji_karyawan_smp_grid->voucher->Visible) { // voucher ?>
		<td data-name="voucher" <?php echo $gaji_karyawan_smp_grid->voucher->cellAttributes() ?>>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_voucher" class="form-group">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_voucher" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->voucher->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->voucher->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_voucher" class="form-group">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_voucher" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->voucher->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->voucher->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_voucher">
<span<?php echo $gaji_karyawan_smp_grid->voucher->viewAttributes() ?>><?php echo $gaji_karyawan_smp_grid->voucher->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_smp->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="fgaji_karyawan_smpgrid$x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="fgaji_karyawan_smpgrid$x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="fgaji_karyawan_smpgrid$o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="fgaji_karyawan_smpgrid$o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_smp_grid->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $gaji_karyawan_smp_grid->potongan_bendahara->cellAttributes() ?>>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_potongan_bendahara" class="form-group">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_potongan_bendahara" class="form-group">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_smp->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_smp_grid->RowCount ?>_gaji_karyawan_smp_potongan_bendahara">
<span<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_karyawan_smp_grid->potongan_bendahara->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_smp->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="fgaji_karyawan_smpgrid$x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="fgaji_karyawan_smpgrid$x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="fgaji_karyawan_smpgrid$o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="fgaji_karyawan_smpgrid$o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<?php if (!$gaji_karyawan_smp->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_smp_voucher" class="form-group gaji_karyawan_smp_voucher">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_voucher" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->voucher->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->voucher->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_smp_voucher" class="form-group gaji_karyawan_smp_voucher">
<span<?php echo $gaji_karyawan_smp_grid->voucher->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_smp_grid->voucher->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_voucher" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->voucher->OldValue) ?>">
...
<?php if (!$gaji_karyawan_smp->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_smp_potongan_bendahara" class="form-group gaji_karyawan_smp_potongan_bendahara">
<input type="text" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_smp_potongan_bendahara" class="form-group gaji_karyawan_smp_potongan_bendahara">
<span<?php echo $gaji_karyawan_smp_grid->potongan_bendahara->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_smp_grid->potongan_bendahara->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_karyawan_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_karyawan_smp_grid->potongan_bendahara->OldValue) ?>">
