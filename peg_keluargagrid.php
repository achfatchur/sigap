...
loadjs.ready("head", function() {
	...
	fpeg_keluargagrid.lists["x_jen_kel"] = <?php echo $peg_keluarga_grid->jen_kel->Lookup->toClientList($peg_keluarga_grid) ?>;
	fpeg_keluargagrid.lists["x_jen_kel"].options = <?php echo JsonEncode($peg_keluarga_grid->jen_kel->lookupOptions()) ?>;
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="peg_keluarga" data-field="x_jen_kel" data-value-separator="<?php echo $peg_keluarga_grid->jen_kel->displayValueSeparatorAttribute() ?>" id="x<?php echo $peg_keluarga_grid->RowIndex ?>_jen_kel" name="x<?php echo $peg_keluarga_grid->RowIndex ?>_jen_kel"<?php echo $peg_keluarga_grid->jen_kel->editAttributes() ?>>
			<?php echo $peg_keluarga_grid->jen_kel->selectOptionListHtml("x{$peg_keluarga_grid->RowIndex}_jen_kel") ?>
		</select>
</div>
<?php echo $peg_keluarga_grid->jen_kel->Lookup->getParamTag($peg_keluarga_grid, "p_x" . $peg_keluarga_grid->RowIndex . "_jen_kel") ?>
</span>
