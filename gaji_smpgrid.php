...
loadjs.ready("head", function() {
	...
	fgaji_smpgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_smp_grid->potongan_bendahara->Required) { ?>
				elm = this.getElements("x" + infix + "_potongan_bendahara");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_grid->potongan_bendahara->caption(), $gaji_smp_grid->potongan_bendahara->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_potongan_bendahara");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_smp_grid->potongan_bendahara->errorMessage()) ?>");
...
<?php if ($gaji_smp_grid->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_smp_grid->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_smp_grid->SortUrl($gaji_smp_grid->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_smp_grid->potongan_bendahara->headerCellClass() ?>"><div id="elh_gaji_smp_potongan_bendahara" class="gaji_smp_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $gaji_smp_grid->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_smp_grid->potongan_bendahara->headerCellClass() ?>"><div><div id="elh_gaji_smp_potongan_bendahara" class="gaji_smp_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smp_grid->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smp_grid->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smp_grid->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gaji_smp_grid->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $gaji_smp_grid->potongan_bendahara->cellAttributes() ?>>
<?php if ($gaji_smp->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_smp_grid->RowCount ?>_gaji_smp_potongan_bendahara" class="form-group">
<input type="text" data-table="gaji_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_smp_grid->potongan_bendahara->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } ?>
<?php if ($gaji_smp->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_smp_grid->RowCount ?>_gaji_smp_potongan_bendahara" class="form-group">
<input type="text" data-table="gaji_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_smp_grid->potongan_bendahara->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_smp->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_smp_grid->RowCount ?>_gaji_smp_potongan_bendahara">
<span<?php echo $gaji_smp_grid->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_smp_grid->potongan_bendahara->getViewValue() ?></span>
</span>
<?php if (!$gaji_smp->isConfirm()) { ?>
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->FormValue) ?>">
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="fgaji_smpgrid$x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="fgaji_smpgrid$x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->FormValue) ?>">
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="fgaji_smpgrid$o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="fgaji_smpgrid$o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<?php if (!$gaji_smp->isConfirm()) { ?>
<span id="el$rowindex$_gaji_smp_potongan_bendahara" class="form-group gaji_smp_potongan_bendahara">
<input type="text" data-table="gaji_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_grid->potongan_bendahara->EditValue ?>"<?php echo $gaji_smp_grid->potongan_bendahara->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_smp_potongan_bendahara" class="form-group gaji_smp_potongan_bendahara">
<span<?php echo $gaji_smp_grid->potongan_bendahara->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_smp_grid->potongan_bendahara->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="x<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_smp" data-field="x_potongan_bendahara" name="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" id="o<?php echo $gaji_smp_grid->RowIndex ?>_potongan_bendahara" value="<?php echo HtmlEncode($gaji_smp_grid->potongan_bendahara->OldValue) ?>">
