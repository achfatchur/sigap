...
<?php } ?>
<?php if ($gaji_karyawan_sd_view->tahun->Visible) { // tahun ?>
	<tr id="r_tahun">
		<td class="<?php echo $gaji_karyawan_sd_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_sd_tahun"><?php echo $gaji_karyawan_sd_view->tahun->caption() ?></span></td>
		<td data-name="tahun" <?php echo $gaji_karyawan_sd_view->tahun->cellAttributes() ?>>
<span id="el_gaji_karyawan_sd_tahun">
<span<?php echo $gaji_karyawan_sd_view->tahun->viewAttributes() ?>><?php echo $gaji_karyawan_sd_view->tahun->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_karyawan_sd_view->bulan->Visible) { // bulan ?>
	<tr id="r_bulan">
		<td class="<?php echo $gaji_karyawan_sd_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_sd_bulan"><?php echo $gaji_karyawan_sd_view->bulan->caption() ?></span></td>
		<td data-name="bulan" <?php echo $gaji_karyawan_sd_view->bulan->cellAttributes() ?>>
<span id="el_gaji_karyawan_sd_bulan">
<span<?php echo $gaji_karyawan_sd_view->bulan->viewAttributes() ?>><?php echo $gaji_karyawan_sd_view->bulan->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sd_view->value_kehadiran->Visible) { // value_kehadiran ?>
	<tr id="r_value_kehadiran">
		<td class="<?php echo $gaji_karyawan_sd_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_sd_value_kehadiran"><?php echo $gaji_karyawan_sd_view->value_kehadiran->caption() ?></span></td>
		<td data-name="value_kehadiran" <?php echo $gaji_karyawan_sd_view->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_karyawan_sd_value_kehadiran">
<span<?php echo $gaji_karyawan_sd_view->value_kehadiran->viewAttributes() ?>><?php echo $gaji_karyawan_sd_view->value_kehadiran->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sd_view->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="<?php echo $gaji_karyawan_sd_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_sd_status"><?php echo $gaji_karyawan_sd_view->status->caption() ?></span></td>
		<td data-name="status" <?php echo $gaji_karyawan_sd_view->status->cellAttributes() ?>>
<span id="el_gaji_karyawan_sd_status">
<span<?php echo $gaji_karyawan_sd_view->status->viewAttributes() ?>><?php echo $gaji_karyawan_sd_view->status->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
