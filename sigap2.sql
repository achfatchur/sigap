...
-- Dumping data for table sigap2.gaji_tu_sma: ~16 rows (approximately)
...
-- Dumping data for table sigap2.m_pph21: ~1 rows (approximately)
...
-- Dumping data for table sigap2.userlevelpermissions: ~2,033 rows (approximately)
