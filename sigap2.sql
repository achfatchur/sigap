...
CREATE TABLE IF NOT EXISTS `gaji_karyawan_sma` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=650 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
-- Dumping data for table sigap2.gaji_karyawan_smp: ~12 rows (approximately)
...
-- Dumping data for table sigap2.gaji_karyawan_tk: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `gaji_sma` (
  ...
  `bpjs_kesehatan` bigint DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4317 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
-- Dumping data for table sigap2.gaji_tk: ~2 rows (approximately)
...
-- Dumping data for table sigap2.gaji_tu_sd: ~9 rows (approximately)
...
-- Dumping data for table sigap2.gaji_tu_smk: ~3 rows (approximately)
...
-- Dumping data for table sigap2.gaji_tu_smp: ~3 rows (approximately)
...
-- Dumping data for table sigap2.generate_pertahun_sd: ~7 rows (approximately)
...
-- Dumping data for table sigap2.m_karyawan_smp: ~4 rows (approximately)
...
-- Dumping data for table sigap2.m_sd: ~4 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_sma` (
  ...
  `createby` int DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=608 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
-- Dumping data for table sigap2.m_smp: ~4 rows (approximately)
...
-- Dumping data for table sigap2.m_tu_sd: ~4 rows (approximately)
...
-- Dumping data for table sigap2.m_tu_smp: ~4 rows (approximately)
...
-- Dumping data for table sigap2.solved_sma: ~0 rows (approximately)
