...
<?php } ?>
<?php if ($pegawai_delete->jjm->Visible) { // jjm ?>
		<th class="<?php echo $pegawai_delete->jjm->headerCellClass() ?>"><span id="elh_pegawai_jjm" class="pegawai_jjm"><?php echo $pegawai_delete->jjm->caption() ?></span></th>
<?php } ?>
<?php if ($pegawai_delete->status_peg->Visible) { // status_peg ?>
		<th class="<?php echo $pegawai_delete->status_peg->headerCellClass() ?>"><span id="elh_pegawai_status_peg" class="pegawai_status_peg"><?php echo $pegawai_delete->status_peg->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($pegawai_delete->jjm->Visible) { // jjm ?>
		<td <?php echo $pegawai_delete->jjm->cellAttributes() ?>>
<span id="el<?php echo $pegawai_delete->RowCount ?>_pegawai_jjm" class="pegawai_jjm">
<span<?php echo $pegawai_delete->jjm->viewAttributes() ?>><?php echo $pegawai_delete->jjm->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($pegawai_delete->status_peg->Visible) { // status_peg ?>
		<td <?php echo $pegawai_delete->status_peg->cellAttributes() ?>>
<span id="el<?php echo $pegawai_delete->RowCount ?>_pegawai_status_peg" class="pegawai_status_peg">
<span<?php echo $pegawai_delete->status_peg->viewAttributes() ?>><?php echo $pegawai_delete->status_peg->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($pegawai_delete->type->Visible) { // type ?>
