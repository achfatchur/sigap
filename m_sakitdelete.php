...
<?php } ?>
<?php if ($m_sakit_delete->sertif->Visible) { // sertif ?>
		<th class="<?php echo $m_sakit_delete->sertif->headerCellClass() ?>"><span id="elh_m_sakit_sertif" class="m_sakit_sertif"><?php echo $m_sakit_delete->sertif->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($m_sakit_delete->type->Visible) { // type ?>
		<th class="<?php echo $m_sakit_delete->type->headerCellClass() ?>"><span id="elh_m_sakit_type" class="m_sakit_type"><?php echo $m_sakit_delete->type->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($m_sakit_delete->sertif->Visible) { // sertif ?>
		<td <?php echo $m_sakit_delete->sertif->cellAttributes() ?>>
<span id="el<?php echo $m_sakit_delete->RowCount ?>_m_sakit_sertif" class="m_sakit_sertif">
<span<?php echo $m_sakit_delete->sertif->viewAttributes() ?>><?php echo $m_sakit_delete->sertif->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($m_sakit_delete->perhari->Visible) { // perhari ?>
...
<?php } ?>
<?php if ($m_sakit_delete->type->Visible) { // type ?>
		<td <?php echo $m_sakit_delete->type->cellAttributes() ?>>
<span id="el<?php echo $m_sakit_delete->RowCount ?>_m_sakit_type" class="m_sakit_type">
<span<?php echo $m_sakit_delete->type->viewAttributes() ?>><?php echo $m_sakit_delete->type->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
