...
// Create page object
$laporan_bpjs_unit = new laporan_bpjs_unit();

// Run the page
$laporan_bpjs_unit->run();
		...
		<tbody>
				<?php
					...
					if(ExecuteRows("SELECT * FROM ".$tabel." WHERE bulan = '".$bulan."' AND tahun = '".$tahun."'") != false){
						...
						$bpjs = ExecuteScalar("select golongan from m_bpjs where id='".$pegawai['bpjs_kesehatan']."'");
			...
			<tr>
				...
				<td>Rp. <?= number_format($data['bpjs_kesehatan'],0,',','.');?></td>
			</tr>
				<?php
					} 
					}else{ 
					...
					$bpjs1 = ExecuteScalar("select golongan from m_bpjs where id='".$pegawai1['bpjs_kesehatan']."'");
			...
			<tr>
				...
				<td><center><?=$bpjs1?></center></td>
				<td>Rp. <?= number_format($data1['bpjs_kesehatan'],0,',','.');?></td>
			</tr>
				<?php	
					}
					}else{ 
					...
					$bpjs2 = ExecuteScalar("select golongan from m_bpjs where id='".$pegawai2['bpjs_kesehatan']."'");
			...
			<tr>
				...
				<td><center><?=$bpjs2?></center></td>
				<td><cRp. <?= number_format($data2['bpjs__kesehatan'],0,',','.');?></td>
			</tr>
				<?php	
					}
					}else{ 
