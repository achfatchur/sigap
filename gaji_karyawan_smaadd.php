...
loadjs.ready("head", function() {
	...
	fgaji_karyawan_smaadd.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_karyawan_sma_add->tahun->Required) { ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_add->tahun->caption(), $gaji_karyawan_sma_add->tahun->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_add->tahun->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sma_add->bulan->Required) { ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_add->bulan->caption(), $gaji_karyawan_sma_add->bulan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_add->bulan->errorMessage()) ?>");
			...
			<?php if ($gaji_karyawan_sma_add->value_kehadiran->Required) { ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_add->value_kehadiran->caption(), $gaji_karyawan_sma_add->value_kehadiran->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_add->value_kehadiran->errorMessage()) ?>");
			...
			<?php if ($gaji_karyawan_sma_add->status->Required) { ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_add->status->caption(), $gaji_karyawan_sma_add->status->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_add->status->errorMessage()) ?>");
	...
	fgaji_karyawan_smaadd.lists["x_bulan"] = <?php echo $gaji_karyawan_sma_add->bulan->Lookup->toClientList($gaji_karyawan_sma_add) ?>;
	fgaji_karyawan_smaadd.lists["x_bulan"].options = <?php echo JsonEncode($gaji_karyawan_sma_add->bulan->lookupOptions()) ?>;
	fgaji_karyawan_smaadd.autoSuggests["x_bulan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_karyawan_sma_add->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_add->bulan->getSessionValue()) ?>">
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_add->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_gaji_karyawan_sma_tahun" for="x_tahun" class="<?php echo $gaji_karyawan_sma_add->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_add->tahun->caption() ?><?php echo $gaji_karyawan_sma_add->tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_add->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_add->tahun->cellAttributes() ?>>
<?php if ($gaji_karyawan_sma_add->tahun->getSessionValue() != "") { ?>
<span id="el_gaji_karyawan_sma_tahun">
<span<?php echo $gaji_karyawan_sma_add->tahun->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sma_add->tahun->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_tahun" name="x_tahun" value="<?php echo HtmlEncode($gaji_karyawan_sma_add->tahun->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_karyawan_sma_tahun">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_tahun" name="x_tahun" id="x_tahun" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_add->tahun->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_add->tahun->EditValue ?>"<?php echo $gaji_karyawan_sma_add->tahun->editAttributes() ?>>
</span>
<?php } ?>
<?php echo $gaji_karyawan_sma_add->tahun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_karyawan_sma_add->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_gaji_karyawan_sma_bulan" class="<?php echo $gaji_karyawan_sma_add->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_add->bulan->caption() ?><?php echo $gaji_karyawan_sma_add->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_add->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_add->bulan->cellAttributes() ?>>
<?php if ($gaji_karyawan_sma_add->bulan->getSessionValue() != "") { ?>
<span id="el_gaji_karyawan_sma_bulan">
<span<?php echo $gaji_karyawan_sma_add->bulan->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sma_add->bulan->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_bulan" name="x_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_add->bulan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_karyawan_sma_bulan">
<?php
$onchange = $gaji_karyawan_sma_add->bulan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_karyawan_sma_add->bulan->EditAttrs["onchange"] = "";
?>
<span id="as_x_bulan">
	<input type="text" class="form-control" name="sv_x_bulan" id="sv_x_bulan" value="<?php echo RemoveHtml($gaji_karyawan_sma_add->bulan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_add->bulan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_add->bulan->getPlaceHolder()) ?>"<?php echo $gaji_karyawan_sma_add->bulan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sma" data-field="x_bulan" data-value-separator="<?php echo $gaji_karyawan_sma_add->bulan->displayValueSeparatorAttribute() ?>" name="x_bulan" id="x_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_add->bulan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_karyawan_smaadd"], function() {
	fgaji_karyawan_smaadd.createAutoSuggest({"id":"x_bulan","forceSelect":false});
});
</script>
<?php echo $gaji_karyawan_sma_add->bulan->Lookup->getParamTag($gaji_karyawan_sma_add, "p_x_bulan") ?>
</span>
<?php } ?>
<?php echo $gaji_karyawan_sma_add->bulan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_add->value_kehadiran->Visible) { // value_kehadiran ?>
	<div id="r_value_kehadiran" class="form-group row">
		<label id="elh_gaji_karyawan_sma_value_kehadiran" for="x_value_kehadiran" class="<?php echo $gaji_karyawan_sma_add->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_add->value_kehadiran->caption() ?><?php echo $gaji_karyawan_sma_add->value_kehadiran->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_add->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_add->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_karyawan_sma_value_kehadiran">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_value_kehadiran" name="x_value_kehadiran" id="x_value_kehadiran" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_add->value_kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_add->value_kehadiran->EditValue ?>"<?php echo $gaji_karyawan_sma_add->value_kehadiran->editAttributes() ?>>
</span>
<?php echo $gaji_karyawan_sma_add->value_kehadiran->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_add->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_gaji_karyawan_sma_status" for="x_status" class="<?php echo $gaji_karyawan_sma_add->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_add->status->caption() ?><?php echo $gaji_karyawan_sma_add->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_add->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_add->status->cellAttributes() ?>>
<span id="el_gaji_karyawan_sma_status">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_status" name="x_status" id="x_status" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_add->status->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_add->status->EditValue ?>"<?php echo $gaji_karyawan_sma_add->status->editAttributes() ?>>
</span>
<?php echo $gaji_karyawan_sma_add->status->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
