...
<?php } ?>
<?php if ($gajismk_detil_view->jp->Visible) { // jp ?>
	<tr id="r_jp">
		<td class="<?php echo $gajismk_detil_view->TableLeftColumnClass ?>"><span id="elh_gajismk_detil_jp"><?php echo $gajismk_detil_view->jp->caption() ?></span></td>
		<td data-name="jp" <?php echo $gajismk_detil_view->jp->cellAttributes() ?>>
<span id="el_gajismk_detil_jp">
<span<?php echo $gajismk_detil_view->jp->viewAttributes() ?>><?php echo $gajismk_detil_view->jp->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
