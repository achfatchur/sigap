...
?>
<?php if ($generate_pertahun_sd_list->profesi->Visible) { // profesi ?>
	<?php if ($generate_pertahun_sd_list->SortUrl($generate_pertahun_sd_list->profesi) == "") { ?>
		<th data-name="profesi" class="<?php echo $generate_pertahun_sd_list->profesi->headerCellClass() ?>"><div id="elh_generate_pertahun_sd_profesi" class="generate_pertahun_sd_profesi"><div class="ew-table-header-caption"><?php echo $generate_pertahun_sd_list->profesi->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="profesi" class="<?php echo $generate_pertahun_sd_list->profesi->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $generate_pertahun_sd_list->SortUrl($generate_pertahun_sd_list->profesi) ?>', 1);"><div id="elh_generate_pertahun_sd_profesi" class="generate_pertahun_sd_profesi">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $generate_pertahun_sd_list->profesi->caption() ?></span><span class="ew-table-header-sort"><?php if ($generate_pertahun_sd_list->profesi->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($generate_pertahun_sd_list->profesi->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($generate_pertahun_sd_list->profesi->Visible) { // profesi ?>
		<td data-name="profesi" <?php echo $generate_pertahun_sd_list->profesi->cellAttributes() ?>>
<span id="el<?php echo $generate_pertahun_sd_list->RowCount ?>_generate_pertahun_sd_profesi">
<span<?php echo $generate_pertahun_sd_list->profesi->viewAttributes() ?>><?php echo $generate_pertahun_sd_list->profesi->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($generate_pertahun_sd_list->tahun->Visible) { // tahun ?>
