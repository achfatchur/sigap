...
loadjs.ready("head", function() {
	...
	fgajisma_detilgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gajisma_detil_grid->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gajisma_detil_grid->jp->caption(), $gajisma_detil_grid->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gajisma_detil_grid->jp->errorMessage()) ?>");
...
<?php if ($gajisma_detil_grid->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajisma_detil_grid->jp->Visible) { // jp ?>
	<?php if ($gajisma_detil_grid->SortUrl($gajisma_detil_grid->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajisma_detil_grid->jp->headerCellClass() ?>"><div id="elh_gajisma_detil_jp" class="gajisma_detil_jp"><div class="ew-table-header-caption"><?php echo $gajisma_detil_grid->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajisma_detil_grid->jp->headerCellClass() ?>"><div><div id="elh_gajisma_detil_jp" class="gajisma_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajisma_detil_grid->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajisma_detil_grid->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajisma_detil_grid->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php } ?>
<?php if ($gajisma_detil->RowType == ROWTYPE_EDIT || $gajisma_detil->CurrentMode == "edit") { ?>
<input type="hidden" data-table="gajisma_detil" data-field="x_id" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_id" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_id" value="<?php echo HtmlEncode($gajisma_detil_grid->id->CurrentValue) ?>">
<?php } ?>
	<?php if ($gajisma_detil_grid->jabatan_id->Visible) { // jabatan_id ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gajisma_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajisma_detil_grid->jp->cellAttributes() ?>>
<?php if ($gajisma_detil->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gajisma_detil_grid->RowCount ?>_gajisma_detil_jp" class="form-group">
<input type="text" data-table="gajisma_detil" data-field="x_jp" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisma_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisma_detil_grid->jp->EditValue ?>"<?php echo $gajisma_detil_grid->jp->editAttributes() ?>>
</span>
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php if ($gajisma_detil->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gajisma_detil_grid->RowCount ?>_gajisma_detil_jp" class="form-group">
<input type="text" data-table="gajisma_detil" data-field="x_jp" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisma_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisma_detil_grid->jp->EditValue ?>"<?php echo $gajisma_detil_grid->jp->editAttributes() ?>>
...
<?php } ?>
<?php if ($gajisma_detil->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gajisma_detil_grid->RowCount ?>_gajisma_detil_jp">
<span<?php echo $gajisma_detil_grid->jp->viewAttributes() ?>><?php echo $gajisma_detil_grid->jp->getViewValue() ?></span>
</span>
<?php if (!$gajisma_detil->isConfirm()) { ?>
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="fgajisma_detilgrid$x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="fgajisma_detilgrid$x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="fgajisma_detilgrid$o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="fgajisma_detilgrid$o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="gajisma_detil" data-field="x_jumlahterima" name="o<?php echo $gajisma_detil_grid->RowIndex ?>_jumlahterima" id="o<?php echo $gajisma_detil_grid->RowIndex ?>_jumlahterima" value="<?php echo HtmlEncode($gajisma_detil_grid->jumlahterima->OldValue) ?>">
	...
	<?php if ($gajisma_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp">
<?php if (!$gajisma_detil->isConfirm()) { ?>
<span id="el$rowindex$_gajisma_detil_jp" class="form-group gajisma_detil_jp">
<input type="text" data-table="gajisma_detil" data-field="x_jp" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisma_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajisma_detil_grid->jp->EditValue ?>"<?php echo $gajisma_detil_grid->jp->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gajisma_detil_jp" class="form-group gajisma_detil_jp">
<span<?php echo $gajisma_detil_grid->jp->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gajisma_detil_grid->jp->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gajisma_detil" data-field="x_jp" name="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajisma_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajisma_detil_grid->jp->OldValue) ?>">
