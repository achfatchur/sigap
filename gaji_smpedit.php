...
loadjs.ready("head", function() {
	...
	fgaji_smpedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_smp_edit->tahun->Required) { ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_edit->tahun->caption(), $gaji_smp_edit->tahun->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_smp_edit->tahun->errorMessage()) ?>");
			<?php if ($gaji_smp_edit->bulan->Required) { ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_edit->bulan->caption(), $gaji_smp_edit->bulan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_smp_edit->bulan->errorMessage()) ?>");
			...
			<?php if ($gaji_smp_edit->status->Required) { ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_edit->status->caption(), $gaji_smp_edit->status->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_smp_edit->status->errorMessage()) ?>");
			<?php if ($gaji_smp_edit->potongan_bendahara->Required) { ?>
				elm = this.getElements("x" + infix + "_potongan_bendahara");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_edit->potongan_bendahara->caption(), $gaji_smp_edit->potongan_bendahara->RequiredErrorMessage)) ?>");
			<?php } ?>
			<?php if ($gaji_smp_edit->voucher->Required) { ?>
				elm = this.getElements("x" + infix + "_voucher");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_smp_edit->voucher->caption(), $gaji_smp_edit->voucher->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_voucher");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_smp_edit->voucher->errorMessage()) ?>");
	...
	fgaji_smpedit.lists["x_bulan"] = <?php echo $gaji_smp_edit->bulan->Lookup->toClientList($gaji_smp_edit) ?>;
	fgaji_smpedit.lists["x_bulan"].options = <?php echo JsonEncode($gaji_smp_edit->bulan->lookupOptions()) ?>;
	fgaji_smpedit.autoSuggests["x_bulan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_smp_edit->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_smp_edit->bulan->getSessionValue()) ?>">
<?php } ?>
...
<?php } ?>
<?php if ($gaji_smp_edit->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_gaji_smp_tahun" for="x_tahun" class="<?php echo $gaji_smp_edit->LeftColumnClass ?>"><?php echo $gaji_smp_edit->tahun->caption() ?><?php echo $gaji_smp_edit->tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_smp_edit->RightColumnClass ?>"><div <?php echo $gaji_smp_edit->tahun->cellAttributes() ?>>
<?php if ($gaji_smp_edit->tahun->getSessionValue() != "") { ?>
<span id="el_gaji_smp_tahun">
<span<?php echo $gaji_smp_edit->tahun->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_smp_edit->tahun->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_tahun" name="x_tahun" value="<?php echo HtmlEncode($gaji_smp_edit->tahun->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_smp_tahun">
<input type="text" data-table="gaji_smp" data-field="x_tahun" name="x_tahun" id="x_tahun" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_smp_edit->tahun->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_edit->tahun->EditValue ?>"<?php echo $gaji_smp_edit->tahun->editAttributes() ?>>
</span>
<?php } ?>
<?php echo $gaji_smp_edit->tahun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_smp_edit->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_gaji_smp_bulan" class="<?php echo $gaji_smp_edit->LeftColumnClass ?>"><?php echo $gaji_smp_edit->bulan->caption() ?><?php echo $gaji_smp_edit->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_smp_edit->RightColumnClass ?>"><div <?php echo $gaji_smp_edit->bulan->cellAttributes() ?>>
<?php if ($gaji_smp_edit->bulan->getSessionValue() != "") { ?>
<span id="el_gaji_smp_bulan">
<span<?php echo $gaji_smp_edit->bulan->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_smp_edit->bulan->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_bulan" name="x_bulan" value="<?php echo HtmlEncode($gaji_smp_edit->bulan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_smp_bulan">
<?php
$onchange = $gaji_smp_edit->bulan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_smp_edit->bulan->EditAttrs["onchange"] = "";
?>
<span id="as_x_bulan">
	<input type="text" class="form-control" name="sv_x_bulan" id="sv_x_bulan" value="<?php echo RemoveHtml($gaji_smp_edit->bulan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_smp_edit->bulan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_smp_edit->bulan->getPlaceHolder()) ?>"<?php echo $gaji_smp_edit->bulan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_smp" data-field="x_bulan" data-value-separator="<?php echo $gaji_smp_edit->bulan->displayValueSeparatorAttribute() ?>" name="x_bulan" id="x_bulan" value="<?php echo HtmlEncode($gaji_smp_edit->bulan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_smpedit"], function() {
	fgaji_smpedit.createAutoSuggest({"id":"x_bulan","forceSelect":false});
});
</script>
<?php echo $gaji_smp_edit->bulan->Lookup->getParamTag($gaji_smp_edit, "p_x_bulan") ?>
</span>
<?php } ?>
<?php echo $gaji_smp_edit->bulan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_smp_edit->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_gaji_smp_status" for="x_status" class="<?php echo $gaji_smp_edit->LeftColumnClass ?>"><?php echo $gaji_smp_edit->status->caption() ?><?php echo $gaji_smp_edit->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_smp_edit->RightColumnClass ?>"><div <?php echo $gaji_smp_edit->status->cellAttributes() ?>>
<span id="el_gaji_smp_status">
<input type="text" data-table="gaji_smp" data-field="x_status" name="x_status" id="x_status" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_smp_edit->status->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_edit->status->EditValue ?>"<?php echo $gaji_smp_edit->status->editAttributes() ?>>
</span>
<?php echo $gaji_smp_edit->status->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_smp_edit->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<div id="r_potongan_bendahara" class="form-group row">
		<label id="elh_gaji_smp_potongan_bendahara" for="x_potongan_bendahara" class="<?php echo $gaji_smp_edit->LeftColumnClass ?>"><?php echo $gaji_smp_edit->potongan_bendahara->caption() ?><?php echo $gaji_smp_edit->potongan_bendahara->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_smp_edit->RightColumnClass ?>"><div <?php echo $gaji_smp_edit->potongan_bendahara->cellAttributes() ?>>
<span id="el_gaji_smp_potongan_bendahara">
<textarea data-table="gaji_smp" data-field="x_potongan_bendahara" name="x_potongan_bendahara" id="x_potongan_bendahara" cols="35" rows="4" placeholder="<?php echo HtmlEncode($gaji_smp_edit->potongan_bendahara->getPlaceHolder()) ?>"<?php echo $gaji_smp_edit->potongan_bendahara->editAttributes() ?>><?php echo $gaji_smp_edit->potongan_bendahara->EditValue ?></textarea>
</span>
<?php echo $gaji_smp_edit->potongan_bendahara->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_smp_edit->voucher->Visible) { // voucher ?>
	<div id="r_voucher" class="form-group row">
		<label id="elh_gaji_smp_voucher" for="x_voucher" class="<?php echo $gaji_smp_edit->LeftColumnClass ?>"><?php echo $gaji_smp_edit->voucher->caption() ?><?php echo $gaji_smp_edit->voucher->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_smp_edit->RightColumnClass ?>"><div <?php echo $gaji_smp_edit->voucher->cellAttributes() ?>>
<span id="el_gaji_smp_voucher">
<input type="text" data-table="gaji_smp" data-field="x_voucher" name="x_voucher" id="x_voucher" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_smp_edit->voucher->getPlaceHolder()) ?>" value="<?php echo $gaji_smp_edit->voucher->EditValue ?>"<?php echo $gaji_smp_edit->voucher->editAttributes() ?>>
</span>
<?php echo $gaji_smp_edit->voucher->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
