...
?>
<?php if ($gaji_smk_preview->tahun->Visible) { // tahun ?>
	<?php if ($gaji_smk->SortUrl($gaji_smk_preview->tahun) == "") { ?>
		<th class="<?php echo $gaji_smk_preview->tahun->headerCellClass() ?>"><?php echo $gaji_smk_preview->tahun->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_smk_preview->tahun->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_smk_preview->tahun->Name) ?>" data-sort-order="<?php echo $gaji_smk_preview->SortField == $gaji_smk_preview->tahun->Name && $gaji_smk_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smk_preview->tahun->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smk_preview->SortField == $gaji_smk_preview->tahun->Name) { ?><?php if ($gaji_smk_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smk_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_smk_preview->bulan->Visible) { // bulan ?>
	<?php if ($gaji_smk->SortUrl($gaji_smk_preview->bulan) == "") { ?>
		<th class="<?php echo $gaji_smk_preview->bulan->headerCellClass() ?>"><?php echo $gaji_smk_preview->bulan->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_smk_preview->bulan->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_smk_preview->bulan->Name) ?>" data-sort-order="<?php echo $gaji_smk_preview->SortField == $gaji_smk_preview->bulan->Name && $gaji_smk_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smk_preview->bulan->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smk_preview->SortField == $gaji_smk_preview->bulan->Name) { ?><?php if ($gaji_smk_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smk_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_smk_preview->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_smk_preview->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_smk->SortUrl($gaji_smk_preview->potongan_bendahara) == "") { ?>
		<th class="<?php echo $gaji_smk_preview->potongan_bendahara->headerCellClass() ?>"><?php echo $gaji_smk_preview->potongan_bendahara->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_smk_preview->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_smk_preview->potongan_bendahara->Name) ?>" data-sort-order="<?php echo $gaji_smk_preview->SortField == $gaji_smk_preview->potongan_bendahara->Name && $gaji_smk_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smk_preview->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smk_preview->SortField == $gaji_smk_preview->potongan_bendahara->Name) { ?><?php if ($gaji_smk_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smk_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_smk_preview->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_smk_preview->voucher->Visible) { // voucher ?>
	<?php if ($gaji_smk->SortUrl($gaji_smk_preview->voucher) == "") { ?>
		<th class="<?php echo $gaji_smk_preview->voucher->headerCellClass() ?>"><?php echo $gaji_smk_preview->voucher->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_smk_preview->voucher->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_smk_preview->voucher->Name) ?>" data-sort-order="<?php echo $gaji_smk_preview->SortField == $gaji_smk_preview->voucher->Name && $gaji_smk_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_smk_preview->voucher->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_smk_preview->SortField == $gaji_smk_preview->voucher->Name) { ?><?php if ($gaji_smk_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_smk_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php if ($gaji_smk_preview->tahun->Visible) { // tahun ?>
		<!-- tahun -->
		<td<?php echo $gaji_smk_preview->tahun->cellAttributes() ?>>
<span<?php echo $gaji_smk_preview->tahun->viewAttributes() ?>><?php echo $gaji_smk_preview->tahun->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_smk_preview->bulan->Visible) { // bulan ?>
		<!-- bulan -->
		<td<?php echo $gaji_smk_preview->bulan->cellAttributes() ?>>
<span<?php echo $gaji_smk_preview->bulan->viewAttributes() ?>><?php echo $gaji_smk_preview->bulan->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_smk_preview->pegawai->Visible) { // pegawai ?>
		<!-- pegawai -->
...
<?php if ($gaji_smk_preview->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<!-- potongan_bendahara -->
		<td<?php echo $gaji_smk_preview->potongan_bendahara->cellAttributes() ?>>
<span<?php echo $gaji_smk_preview->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_smk_preview->potongan_bendahara->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_smk_preview->total->Visible) { // total ?>
		<!-- total -->
...
<?php if ($gaji_smk_preview->voucher->Visible) { // voucher ?>
		<!-- voucher -->
		<td<?php echo $gaji_smk_preview->voucher->cellAttributes() ?>>
<span<?php echo $gaji_smk_preview->voucher->viewAttributes() ?>><?php echo $gaji_smk_preview->voucher->getViewValue() ?></span>
</td>
<?php } ?>
<?php
