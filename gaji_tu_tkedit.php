...
loadjs.ready("head", function() {
	...
	fgaji_tu_tkedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_tu_tk_edit->tahun->Required) { ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_tk_edit->tahun->caption(), $gaji_tu_tk_edit->tahun->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_tk_edit->tahun->errorMessage()) ?>");
			<?php if ($gaji_tu_tk_edit->bulan->Required) { ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_tk_edit->bulan->caption(), $gaji_tu_tk_edit->bulan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_tk_edit->bulan->errorMessage()) ?>");
			...
			<?php if ($gaji_tu_tk_edit->lama_kerja->Required) { ?>
				elm = this.getElements("x" + infix + "_lama_kerja");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_tk_edit->lama_kerja->caption(), $gaji_tu_tk_edit->lama_kerja->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_lama_kerja");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_tk_edit->lama_kerja->errorMessage()) ?>");
			<?php if ($gaji_tu_tk_edit->sertif->Required) { ?>
				elm = this.getElements("x" + infix + "_sertif");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_tk_edit->sertif->caption(), $gaji_tu_tk_edit->sertif->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_sertif");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_tk_edit->sertif->errorMessage()) ?>");
			...
			<?php if ($gaji_tu_tk_edit->value_kehadiran->Required) { ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_tk_edit->value_kehadiran->caption(), $gaji_tu_tk_edit->value_kehadiran->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_tk_edit->value_kehadiran->errorMessage()) ?>");
	...
	fgaji_tu_tkedit.lists["x_bulan"] = <?php echo $gaji_tu_tk_edit->bulan->Lookup->toClientList($gaji_tu_tk_edit) ?>;
	fgaji_tu_tkedit.lists["x_bulan"].options = <?php echo JsonEncode($gaji_tu_tk_edit->bulan->lookupOptions()) ?>;
	fgaji_tu_tkedit.autoSuggests["x_bulan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	...
	fgaji_tu_tkedit.lists["x_sertif"] = <?php echo $gaji_tu_tk_edit->sertif->Lookup->toClientList($gaji_tu_tk_edit) ?>;
	fgaji_tu_tkedit.lists["x_sertif"].options = <?php echo JsonEncode($gaji_tu_tk_edit->sertif->lookupOptions()) ?>;
	fgaji_tu_tkedit.autoSuggests["x_sertif"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_tu_tk_edit->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_tu_tk_edit->bulan->getSessionValue()) ?>">
<?php } ?>
<div class="ew-edit-div"><!-- page* -->
<?php if ($gaji_tu_tk_edit->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_gaji_tu_tk_tahun" for="x_tahun" class="<?php echo $gaji_tu_tk_edit->LeftColumnClass ?>"><?php echo $gaji_tu_tk_edit->tahun->caption() ?><?php echo $gaji_tu_tk_edit->tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_tk_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_tk_edit->tahun->cellAttributes() ?>>
<?php if ($gaji_tu_tk_edit->tahun->getSessionValue() != "") { ?>
<span id="el_gaji_tu_tk_tahun">
<span<?php echo $gaji_tu_tk_edit->tahun->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_tu_tk_edit->tahun->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_tahun" name="x_tahun" value="<?php echo HtmlEncode($gaji_tu_tk_edit->tahun->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_tu_tk_tahun">
<input type="text" data-table="gaji_tu_tk" data-field="x_tahun" name="x_tahun" id="x_tahun" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->tahun->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_tk_edit->tahun->EditValue ?>"<?php echo $gaji_tu_tk_edit->tahun->editAttributes() ?>>
</span>
<?php } ?>
<?php echo $gaji_tu_tk_edit->tahun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_tk_edit->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_gaji_tu_tk_bulan" class="<?php echo $gaji_tu_tk_edit->LeftColumnClass ?>"><?php echo $gaji_tu_tk_edit->bulan->caption() ?><?php echo $gaji_tu_tk_edit->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_tk_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_tk_edit->bulan->cellAttributes() ?>>
<?php if ($gaji_tu_tk_edit->bulan->getSessionValue() != "") { ?>
<span id="el_gaji_tu_tk_bulan">
<span<?php echo $gaji_tu_tk_edit->bulan->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_tu_tk_edit->bulan->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_bulan" name="x_bulan" value="<?php echo HtmlEncode($gaji_tu_tk_edit->bulan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_tu_tk_bulan">
<?php
$onchange = $gaji_tu_tk_edit->bulan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_tk_edit->bulan->EditAttrs["onchange"] = "";
?>
<span id="as_x_bulan">
	<input type="text" class="form-control" name="sv_x_bulan" id="sv_x_bulan" value="<?php echo RemoveHtml($gaji_tu_tk_edit->bulan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->bulan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->bulan->getPlaceHolder()) ?>"<?php echo $gaji_tu_tk_edit->bulan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_tk" data-field="x_bulan" data-value-separator="<?php echo $gaji_tu_tk_edit->bulan->displayValueSeparatorAttribute() ?>" name="x_bulan" id="x_bulan" value="<?php echo HtmlEncode($gaji_tu_tk_edit->bulan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_tkedit"], function() {
	fgaji_tu_tkedit.createAutoSuggest({"id":"x_bulan","forceSelect":false});
});
</script>
<?php echo $gaji_tu_tk_edit->bulan->Lookup->getParamTag($gaji_tu_tk_edit, "p_x_bulan") ?>
</span>
<?php } ?>
<?php echo $gaji_tu_tk_edit->bulan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_tk_edit->lama_kerja->Visible) { // lama_kerja ?>
	<div id="r_lama_kerja" class="form-group row">
		<label id="elh_gaji_tu_tk_lama_kerja" for="x_lama_kerja" class="<?php echo $gaji_tu_tk_edit->LeftColumnClass ?>"><?php echo $gaji_tu_tk_edit->lama_kerja->caption() ?><?php echo $gaji_tu_tk_edit->lama_kerja->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_tk_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_tk_edit->lama_kerja->cellAttributes() ?>>
<span id="el_gaji_tu_tk_lama_kerja">
<input type="text" data-table="gaji_tu_tk" data-field="x_lama_kerja" name="x_lama_kerja" id="x_lama_kerja" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->lama_kerja->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_tk_edit->lama_kerja->EditValue ?>"<?php echo $gaji_tu_tk_edit->lama_kerja->editAttributes() ?>>
</span>
<?php echo $gaji_tu_tk_edit->lama_kerja->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_tk_edit->sertif->Visible) { // sertif ?>
	<div id="r_sertif" class="form-group row">
		<label id="elh_gaji_tu_tk_sertif" class="<?php echo $gaji_tu_tk_edit->LeftColumnClass ?>"><?php echo $gaji_tu_tk_edit->sertif->caption() ?><?php echo $gaji_tu_tk_edit->sertif->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_tk_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_tk_edit->sertif->cellAttributes() ?>>
<span id="el_gaji_tu_tk_sertif">
<?php
$onchange = $gaji_tu_tk_edit->sertif->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_tu_tk_edit->sertif->EditAttrs["onchange"] = "";
?>
<span id="as_x_sertif">
	<input type="text" class="form-control" name="sv_x_sertif" id="sv_x_sertif" value="<?php echo RemoveHtml($gaji_tu_tk_edit->sertif->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->sertif->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->sertif->getPlaceHolder()) ?>"<?php echo $gaji_tu_tk_edit->sertif->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_tk" data-field="x_sertif" data-value-separator="<?php echo $gaji_tu_tk_edit->sertif->displayValueSeparatorAttribute() ?>" name="x_sertif" id="x_sertif" value="<?php echo HtmlEncode($gaji_tu_tk_edit->sertif->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_tu_tkedit"], function() {
	fgaji_tu_tkedit.createAutoSuggest({"id":"x_sertif","forceSelect":false});
});
</script>
<?php echo $gaji_tu_tk_edit->sertif->Lookup->getParamTag($gaji_tu_tk_edit, "p_x_sertif") ?>
</span>
<?php echo $gaji_tu_tk_edit->sertif->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_tk_edit->value_kehadiran->Visible) { // value_kehadiran ?>
	<div id="r_value_kehadiran" class="form-group row">
		<label id="elh_gaji_tu_tk_value_kehadiran" for="x_value_kehadiran" class="<?php echo $gaji_tu_tk_edit->LeftColumnClass ?>"><?php echo $gaji_tu_tk_edit->value_kehadiran->caption() ?><?php echo $gaji_tu_tk_edit->value_kehadiran->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_tk_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_tk_edit->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_tu_tk_value_kehadiran">
<input type="text" data-table="gaji_tu_tk" data-field="x_value_kehadiran" name="x_value_kehadiran" id="x_value_kehadiran" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_tu_tk_edit->value_kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_tk_edit->value_kehadiran->EditValue ?>"<?php echo $gaji_tu_tk_edit->value_kehadiran->editAttributes() ?>>
</span>
<?php echo $gaji_tu_tk_edit->value_kehadiran->CustomMsg ?></div></div>
	</div>
<?php } ?>
