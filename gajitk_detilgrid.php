...
loadjs.ready("head", function() {
	...
	fgajitk_detilgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gajitk_detil_grid->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gajitk_detil_grid->jp->caption(), $gajitk_detil_grid->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gajitk_detil_grid->jp->errorMessage()) ?>");
...
<?php if ($gajitk_detil_grid->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajitk_detil_grid->jp->Visible) { // jp ?>
	<?php if ($gajitk_detil_grid->SortUrl($gajitk_detil_grid->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajitk_detil_grid->jp->headerCellClass() ?>"><div id="elh_gajitk_detil_jp" class="gajitk_detil_jp"><div class="ew-table-header-caption"><?php echo $gajitk_detil_grid->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajitk_detil_grid->jp->headerCellClass() ?>"><div><div id="elh_gajitk_detil_jp" class="gajitk_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajitk_detil_grid->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajitk_detil_grid->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajitk_detil_grid->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gajitk_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajitk_detil_grid->jp->cellAttributes() ?>>
<?php if ($gajitk_detil->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gajitk_detil_grid->RowCount ?>_gajitk_detil_jp" class="form-group">
<input type="text" data-table="gajitk_detil" data-field="x_jp" name="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajitk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajitk_detil_grid->jp->EditValue ?>"<?php echo $gajitk_detil_grid->jp->editAttributes() ?>>
</span>
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php if ($gajitk_detil->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gajitk_detil_grid->RowCount ?>_gajitk_detil_jp" class="form-group">
<input type="text" data-table="gajitk_detil" data-field="x_jp" name="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajitk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajitk_detil_grid->jp->EditValue ?>"<?php echo $gajitk_detil_grid->jp->editAttributes() ?>>
...
<?php } ?>
<?php if ($gajitk_detil->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gajitk_detil_grid->RowCount ?>_gajitk_detil_jp">
<span<?php echo $gajitk_detil_grid->jp->viewAttributes() ?>><?php echo $gajitk_detil_grid->jp->getViewValue() ?></span>
</span>
<?php if (!$gajitk_detil->isConfirm()) { ?>
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="fgajitk_detilgrid$x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="fgajitk_detilgrid$x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="fgajitk_detilgrid$o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="fgajitk_detilgrid$o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="gajitk_detil" data-field="x_jumlahterima" name="o<?php echo $gajitk_detil_grid->RowIndex ?>_jumlahterima" id="o<?php echo $gajitk_detil_grid->RowIndex ?>_jumlahterima" value="<?php echo HtmlEncode($gajitk_detil_grid->jumlahterima->OldValue) ?>">
	...
	<?php if ($gajitk_detil_grid->jp->Visible) { // jp ?>
		<td data-name="jp">
<?php if (!$gajitk_detil->isConfirm()) { ?>
<span id="el$rowindex$_gajitk_detil_jp" class="form-group gajitk_detil_jp">
<input type="text" data-table="gajitk_detil" data-field="x_jp" name="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajitk_detil_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gajitk_detil_grid->jp->EditValue ?>"<?php echo $gajitk_detil_grid->jp->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gajitk_detil_jp" class="form-group gajitk_detil_jp">
<span<?php echo $gajitk_detil_grid->jp->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gajitk_detil_grid->jp->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="x<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gajitk_detil" data-field="x_jp" name="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" id="o<?php echo $gajitk_detil_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gajitk_detil_grid->jp->OldValue) ?>">
