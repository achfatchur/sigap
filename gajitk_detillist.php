...
<?php if ($gajitk_detil_list->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajitk_detil_list->jp->Visible) { // jp ?>
	<?php if ($gajitk_detil_list->SortUrl($gajitk_detil_list->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajitk_detil_list->jp->headerCellClass() ?>"><div id="elh_gajitk_detil_jp" class="gajitk_detil_jp"><div class="ew-table-header-caption"><?php echo $gajitk_detil_list->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajitk_detil_list->jp->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gajitk_detil_list->SortUrl($gajitk_detil_list->jp) ?>', 1);"><div id="elh_gajitk_detil_jp" class="gajitk_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajitk_detil_list->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajitk_detil_list->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajitk_detil_list->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gajitk_detil_list->jumlahterima->viewAttributes() ?>><?php echo $gajitk_detil_list->jumlahterima->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gajitk_detil_list->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajitk_detil_list->jp->cellAttributes() ?>>
<span id="el<?php echo $gajitk_detil_list->RowCount ?>_gajitk_detil_jp">
<span<?php echo $gajitk_detil_list->jp->viewAttributes() ?>><?php echo $gajitk_detil_list->jp->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
