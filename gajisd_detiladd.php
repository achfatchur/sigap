...
loadjs.ready("head", function() {
	...
	fgajisd_detiladd.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gajisd_detil_add->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gajisd_detil_add->jp->caption(), $gajisd_detil_add->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gajisd_detil_add->jp->errorMessage()) ?>");
...
<?php if ($gajisd_detil_add->pegawai_id->Visible) { // pegawai_id ?>
	<div id="r_pegawai_id" class="form-group row">
		<label id="elh_gajisd_detil_pegawai_id" for="x_pegawai_id" class="<?php echo $gajisd_detil_add->LeftColumnClass ?>"><?php echo $gajisd_detil_add->pegawai_id->caption() ?><?php echo $gajisd_detil_add->pegawai_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($gajisd_detil_add->jabatan_id->Visible) { // jabatan_id ?>
	<div id="r_jabatan_id" class="form-group row">
		<label id="elh_gajisd_detil_jabatan_id" for="x_jabatan_id" class="<?php echo $gajisd_detil_add->LeftColumnClass ?>"><?php echo $gajisd_detil_add->jabatan_id->caption() ?><?php echo $gajisd_detil_add->jabatan_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_jabatan_id"><?php echo EmptyValue(strval($gajisd_detil_add->jabatan_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $gajisd_detil_add->jabatan_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($gajisd_detil_add->jabatan_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($gajisd_detil_add->jabatan_id->ReadOnly || $gajisd_detil_add->jabatan_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_jabatan_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $gajisd_detil_add->jabatan_id->Lookup->getParamTag($gajisd_detil_add, "p_x_jabatan_id") ?>
<input type="hidden" data-table="gajisd_detil" data-field="x_jabatan_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $gajisd_detil_add->jabatan_id->displayValueSeparatorAttribute() ?>" name="x_jabatan_id" id="x_jabatan_id" value="<?php echo $gajisd_detil_add->jabatan_id->CurrentValue ?>"<?php echo $gajisd_detil_add->jabatan_id->editAttributes() ?>>
</span>
...
<?php } ?>
<?php if ($gajisd_detil_add->jp->Visible) { // jp ?>
	<div id="r_jp" class="form-group row">
		<label id="elh_gajisd_detil_jp" for="x_jp" class="<?php echo $gajisd_detil_add->LeftColumnClass ?>"><?php echo $gajisd_detil_add->jp->caption() ?><?php echo $gajisd_detil_add->jp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gajisd_detil_add->RightColumnClass ?>"><div <?php echo $gajisd_detil_add->jp->cellAttributes() ?>>
<span id="el_gajisd_detil_jp">
<input type="text" data-table="gajisd_detil" data-field="x_jp" name="x_jp" id="x_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gajisd_detil_add->jp->getPlaceHolder()) ?>" value="<?php echo $gajisd_detil_add->jp->EditValue ?>"<?php echo $gajisd_detil_add->jp->editAttributes() ?>>
</span>
<?php echo $gajisd_detil_add->jp->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
