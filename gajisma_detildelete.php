...
<?php } ?>
<?php if ($gajisma_detil_delete->jp->Visible) { // jp ?>
		<th class="<?php echo $gajisma_detil_delete->jp->headerCellClass() ?>"><span id="elh_gajisma_detil_jp" class="gajisma_detil_jp"><?php echo $gajisma_detil_delete->jp->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($gajisma_detil_delete->jp->Visible) { // jp ?>
		<td <?php echo $gajisma_detil_delete->jp->cellAttributes() ?>>
<span id="el<?php echo $gajisma_detil_delete->RowCount ?>_gajisma_detil_jp" class="gajisma_detil_jp">
<span<?php echo $gajisma_detil_delete->jp->viewAttributes() ?>><?php echo $gajisma_detil_delete->jp->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
