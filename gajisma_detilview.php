...
<?php } ?>
<?php if ($gajisma_detil_view->jp->Visible) { // jp ?>
	<tr id="r_jp">
		<td class="<?php echo $gajisma_detil_view->TableLeftColumnClass ?>"><span id="elh_gajisma_detil_jp"><?php echo $gajisma_detil_view->jp->caption() ?></span></td>
		<td data-name="jp" <?php echo $gajisma_detil_view->jp->cellAttributes() ?>>
<span id="el_gajisma_detil_jp">
<span<?php echo $gajisma_detil_view->jp->viewAttributes() ?>><?php echo $gajisma_detil_view->jp->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
