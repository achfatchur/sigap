...
?>	
	...
	//if($total_status == $total_isi && $total_status1 == $total_isi1 && $total_status2 == $total_isi2){ ?>
		<form method="get" action="">
			...
			<div class="col-auto">
			<?php if($jenjang == '1'){ ?>
				<a href="exp_pajak_tk.php"class="btn btn-danger mb-2"target="_self">Export Data Unit TK</a>
				<?php } elseif ($jenjang == '2') { ?>
					<a href="exp_pajak_sd.php"class="btn btn-danger mb-2" target="_self">Export Data Unit SD</a>
				<?php } elseif ($jenjang == '3') { ?>
					<a href="exp_pajal_smp.php"class="btn btn-danger mb-2" target="_self">Export Data Unit SMP</a>
				<?php } elseif ($jenjang == '4') { ?>
					<a href="exp_pajak_sma.php"class="btn btn-danger mb-2" target="_self">Export Data Unit SMA</a>
