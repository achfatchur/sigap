...
loadjs.ready("head", function() {
	...
	fm_karyawan_tkedit.lists["x_bulan"] = <?php echo $m_karyawan_tk_edit->bulan->Lookup->toClientList($m_karyawan_tk_edit) ?>;
	fm_karyawan_tkedit.lists["x_bulan"].options = <?php echo JsonEncode($m_karyawan_tk_edit->bulan->lookupOptions()) ?>;
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_karyawan_tk" data-field="x_bulan" data-value-separator="<?php echo $m_karyawan_tk_edit->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_karyawan_tk_edit->bulan->editAttributes() ?>>
			<?php echo $m_karyawan_tk_edit->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
<?php echo $m_karyawan_tk_edit->bulan->Lookup->getParamTag($m_karyawan_tk_edit, "p_x_bulan") ?>
</span>
