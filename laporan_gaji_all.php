...
// Create page object
$laporan_gaji_all = new laporan_gaji_all();

// Run the page
$laporan_gaji_all->run();
...
?>	
	...
	if($total_status == $total_isi && $total_status1 == $total_isi1 && $total_status2 == $total_isi2){ ?>
		...
		<?php } ?>
		<a href="exp_gaji_all.php"class="btn btn-danger mb-2" target="_self">Export Data All Unit</a>			
				</div>	
			</div>
		</form>
	<?php }else{ ?>
