...
loadjs.ready("head", function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($peg_dokumen_grid->file_dokumen->Required) { ?>
				...
				if (felm && elm && !ew.hasValue(elm))
					return this.onError(felm, "<?php echo JsEncode(str_replace("%s", $peg_dokumen_grid->file_dokumen->caption(), $peg_dokumen_grid->file_dokumen->RequiredErrorMessage)) ?>");
			<?php } ?>
	...
	fpeg_dokumengrid.lists["x_c_by"] = <?php echo $peg_dokumen_grid->c_by->Lookup->toClientList($peg_dokumen_grid) ?>;
	fpeg_dokumengrid.lists["x_c_by"].options = <?php echo JsonEncode($peg_dokumen_grid->c_by->lookupOptions()) ?>;
	fpeg_dokumengrid.autoSuggests["x_c_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
	fpeg_dokumengrid.lists["x_u_by"] = <?php echo $peg_dokumen_grid->u_by->Lookup->toClientList($peg_dokumen_grid) ?>;
	fpeg_dokumengrid.lists["x_u_by"].options = <?php echo JsonEncode($peg_dokumen_grid->u_by->lookupOptions()) ?>;
	fpeg_dokumengrid.autoSuggests["x_u_by"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php if ($peg_dokumen_grid->RowAction == "insert") { // Add record ?>
<span id="el$rowindex$_peg_dokumen_file_dokumen" class="form-group peg_dokumen_file_dokumen">
<div id="fd_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen">
<div class="input-group">
	<div class="custom-file">
		<input type="file" class="custom-file-input" title="<?php echo $peg_dokumen_grid->file_dokumen->title() ?>" data-table="peg_dokumen" data-field="x_file_dokumen" name="x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id="x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" lang="<?php echo CurrentLanguageID() ?>"<?php echo $peg_dokumen_grid->file_dokumen->editAttributes() ?><?php if ($peg_dokumen_grid->file_dokumen->ReadOnly || $peg_dokumen_grid->file_dokumen->Disabled) echo " disabled"; ?>>
		<label class="custom-file-label ew-file-label" for="x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen"><?php echo $Language->phrase("ChooseFile") ?></label>
	</div>
</div>
<input type="hidden" name="fn_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fn_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->Upload->FileName ?>">
<input type="hidden" name="fa_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fa_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="0">
<input type="hidden" name="fs_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fs_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="255">
<input type="hidden" name="fx_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fx_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fm_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->UploadMaxFileSize ?>">
</div>
<table id="ft_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" class="table table-sm float-left ew-upload-table"><tbody class="files"></tbody></table>
</span>
...
<?php } elseif ($peg_dokumen->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $peg_dokumen_grid->RowCount ?>_peg_dokumen_file_dokumen">
<span<?php echo $peg_dokumen_grid->file_dokumen->viewAttributes() ?>><?php echo GetFileViewTag($peg_dokumen_grid->file_dokumen, $peg_dokumen_grid->file_dokumen->getViewValue(), FALSE) ?></span>
</span>
<?php } else  { // Edit record ?>
<span id="el<?php echo $peg_dokumen_grid->RowCount ?>_peg_dokumen_file_dokumen" class="form-group peg_dokumen_file_dokumen">
<div id="fd_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen">
<div class="input-group">
	<div class="custom-file">
		<input type="file" class="custom-file-input" title="<?php echo $peg_dokumen_grid->file_dokumen->title() ?>" data-table="peg_dokumen" data-field="x_file_dokumen" name="x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id="x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" lang="<?php echo CurrentLanguageID() ?>"<?php echo $peg_dokumen_grid->file_dokumen->editAttributes() ?><?php if ($peg_dokumen_grid->file_dokumen->ReadOnly || $peg_dokumen_grid->file_dokumen->Disabled) echo " disabled"; ?>>
...
<input type="hidden" name="fn_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fn_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->Upload->FileName ?>">
<input type="hidden" name="fa_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fa_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo (Post("fa_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen") == "0") ? "0" : "1" ?>">
<input type="hidden" name="fs_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fs_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="255">
<input type="hidden" name="fx_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fx_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" id= "fm_x<?php echo $peg_dokumen_grid->RowIndex ?>_file_dokumen" value="<?php echo $peg_dokumen_grid->file_dokumen->UploadMaxFileSize ?>">
</div>
