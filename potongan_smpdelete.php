...
<?php } ?>
<?php if ($potongan_smp_delete->sertif->Visible) { // sertif ?>
		<th class="<?php echo $potongan_smp_delete->sertif->headerCellClass() ?>"><span id="elh_potongan_smp_sertif" class="potongan_smp_sertif"><?php echo $potongan_smp_delete->sertif->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_smp_delete->sertif->Visible) { // sertif ?>
		<td <?php echo $potongan_smp_delete->sertif->cellAttributes() ?>>
<span id="el<?php echo $potongan_smp_delete->RowCount ?>_potongan_smp_sertif" class="potongan_smp_sertif">
<span<?php echo $potongan_smp_delete->sertif->viewAttributes() ?>><?php echo $potongan_smp_delete->sertif->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_smp_delete->terlambat->Visible) { // terlambat ?>
