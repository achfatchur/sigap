...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sigap"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'J7De7qzRdIrsTsc3', // Random key for encryption
	...
	"PROJECT_ID" => "{3C64794E-EF73-47B1-9AB0-F3ADB03E5E03}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sigap2"]
	],
