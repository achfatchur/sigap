...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_karyawan_sma" data-field="x_bulan" data-value-separator="<?php echo $m_karyawan_sma_add->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_karyawan_sma_add->bulan->editAttributes() ?>>
			<?php echo $m_karyawan_sma_add->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
