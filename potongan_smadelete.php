...
<?php } ?>
<?php if ($potongan_sma_delete->tahun->Visible) { // tahun ?>
		<th class="<?php echo $potongan_sma_delete->tahun->headerCellClass() ?>"><span id="elh_potongan_sma_tahun" class="potongan_sma_tahun"><?php echo $potongan_sma_delete->tahun->caption() ?></span></th>
<?php } ?>
<?php if ($potongan_sma_delete->bulan->Visible) { // bulan ?>
		<th class="<?php echo $potongan_sma_delete->bulan->headerCellClass() ?>"><span id="elh_potongan_sma_bulan" class="potongan_sma_bulan"><?php echo $potongan_sma_delete->bulan->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_sma_delete->sertif->Visible) { // sertif ?>
		<th class="<?php echo $potongan_sma_delete->sertif->headerCellClass() ?>"><span id="elh_potongan_sma_sertif" class="potongan_sma_sertif"><?php echo $potongan_sma_delete->sertif->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_sma_delete->tahun->Visible) { // tahun ?>
		<td <?php echo $potongan_sma_delete->tahun->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_delete->RowCount ?>_potongan_sma_tahun" class="potongan_sma_tahun">
<span<?php echo $potongan_sma_delete->tahun->viewAttributes() ?>><?php echo $potongan_sma_delete->tahun->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sma_delete->bulan->Visible) { // bulan ?>
		<td <?php echo $potongan_sma_delete->bulan->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_delete->RowCount ?>_potongan_sma_bulan" class="potongan_sma_bulan">
<span<?php echo $potongan_sma_delete->bulan->viewAttributes() ?>><?php echo $potongan_sma_delete->bulan->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sma_delete->nama->Visible) { // nama ?>
...
<?php } ?>
<?php if ($potongan_sma_delete->sertif->Visible) { // sertif ?>
		<td <?php echo $potongan_sma_delete->sertif->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_delete->RowCount ?>_potongan_sma_sertif" class="potongan_sma_sertif">
<span<?php echo $potongan_sma_delete->sertif->viewAttributes() ?>><?php echo $potongan_sma_delete->sertif->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sma_delete->terlambat->Visible) { // terlambat ?>
