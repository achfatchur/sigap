...
<?php } ?>
<?php if ($gaji_smp_delete->voucher->Visible) { // voucher ?>
		<th class="<?php echo $gaji_smp_delete->voucher->headerCellClass() ?>"><span id="elh_gaji_smp_voucher" class="gaji_smp_voucher"><?php echo $gaji_smp_delete->voucher->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($gaji_smp_delete->voucher->Visible) { // voucher ?>
		<td <?php echo $gaji_smp_delete->voucher->cellAttributes() ?>>
<span id="el<?php echo $gaji_smp_delete->RowCount ?>_gaji_smp_voucher" class="gaji_smp_voucher">
<span<?php echo $gaji_smp_delete->voucher->viewAttributes() ?>><?php echo $gaji_smp_delete->voucher->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
