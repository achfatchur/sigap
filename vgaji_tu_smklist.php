...
loadjs.ready("head", function() {
	...
	fvgaji_tu_smklistsrch.lists["x_pegawai"] = <?php echo $vgaji_tu_smk_list->pegawai->Lookup->toClientList($vgaji_tu_smk_list) ?>;
	fvgaji_tu_smklistsrch.lists["x_pegawai"].options = <?php echo JsonEncode($vgaji_tu_smk_list->pegawai->lookupOptions()) ?>;
...
<div id="xsr_<?php echo $vgaji_tu_smk_list->SearchRowCount ?>" class="ew-row d-sm-flex">
	...
	<div id="xsc_pegawai" class="ew-cell form-group">
		<label for="x_pegawai" class="ew-search-caption ew-label"><?php echo $vgaji_tu_smk_list->pegawai->caption() ?></label>
		<span class="ew-search-operator">
<?php echo $Language->phrase("LIKE") ?>
<input type="hidden" name="z_pegawai" id="z_pegawai" value="LIKE">
</span>
		<span id="el_vgaji_tu_smk_pegawai" class="ew-search-field">
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_pegawai"><?php echo EmptyValue(strval($vgaji_tu_smk_list->pegawai->AdvancedSearch->ViewValue)) ? $Language->phrase("PleaseSelect") : $vgaji_tu_smk_list->pegawai->AdvancedSearch->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($vgaji_tu_smk_list->pegawai->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($vgaji_tu_smk_list->pegawai->ReadOnly || $vgaji_tu_smk_list->pegawai->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_pegawai',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $vgaji_tu_smk_list->pegawai->Lookup->getParamTag($vgaji_tu_smk_list, "p_x_pegawai") ?>
<input type="hidden" data-table="vgaji_tu_smk" data-field="x_pegawai" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $vgaji_tu_smk_list->pegawai->displayValueSeparatorAttribute() ?>" name="x_pegawai" id="x_pegawai" value="<?php echo $vgaji_tu_smk_list->pegawai->AdvancedSearch->SearchValue ?>"<?php echo $vgaji_tu_smk_list->pegawai->editAttributes() ?>>
</span>
	</div>
	<?php if ($vgaji_tu_smk_list->SearchColumnCount % $vgaji_tu_smk_list->SearchFieldsPerRow == 0) { ?>
</div>
...
<?php if ($vgaji_tu_smk_list->pegawai->Visible) { // pegawai ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($vgaji_tu_smk_list->rekbank->Visible) { // rekbank ?>
	<?php if ($vgaji_tu_smk_list->SortUrl($vgaji_tu_smk_list->rekbank) == "") { ?>
		<th data-name="rekbank" class="<?php echo $vgaji_tu_smk_list->rekbank->headerCellClass() ?>"><div id="elh_vgaji_tu_smk_rekbank" class="vgaji_tu_smk_rekbank"><div class="ew-table-header-caption"><?php echo $vgaji_tu_smk_list->rekbank->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="rekbank" class="<?php echo $vgaji_tu_smk_list->rekbank->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $vgaji_tu_smk_list->SortUrl($vgaji_tu_smk_list->rekbank) ?>', 1);"><div id="elh_vgaji_tu_smk_rekbank" class="vgaji_tu_smk_rekbank">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $vgaji_tu_smk_list->rekbank->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($vgaji_tu_smk_list->rekbank->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($vgaji_tu_smk_list->rekbank->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($vgaji_tu_smk_list->penyesuaian->Visible) { // penyesuaian ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($vgaji_tu_smk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($vgaji_tu_smk_list->SortUrl($vgaji_tu_smk_list->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $vgaji_tu_smk_list->potongan_bendahara->headerCellClass() ?>"><div id="elh_vgaji_tu_smk_potongan_bendahara" class="vgaji_tu_smk_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $vgaji_tu_smk_list->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $vgaji_tu_smk_list->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $vgaji_tu_smk_list->SortUrl($vgaji_tu_smk_list->potongan_bendahara) ?>', 1);"><div id="elh_vgaji_tu_smk_potongan_bendahara" class="vgaji_tu_smk_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $vgaji_tu_smk_list->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($vgaji_tu_smk_list->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($vgaji_tu_smk_list->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<span<?php echo $vgaji_tu_smk_list->pegawai->viewAttributes() ?>><?php echo $vgaji_tu_smk_list->pegawai->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($vgaji_tu_smk_list->rekbank->Visible) { // rekbank ?>
		<td data-name="rekbank" <?php echo $vgaji_tu_smk_list->rekbank->cellAttributes() ?>>
<span id="el<?php echo $vgaji_tu_smk_list->RowCount ?>_vgaji_tu_smk_rekbank">
<span<?php echo $vgaji_tu_smk_list->rekbank->viewAttributes() ?>><?php echo $vgaji_tu_smk_list->rekbank->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vgaji_tu_smk_list->jenjang_id->Visible) { // jenjang_id ?>
...
<span<?php echo $vgaji_tu_smk_list->penyesuaian->viewAttributes() ?>><?php echo $vgaji_tu_smk_list->penyesuaian->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($vgaji_tu_smk_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $vgaji_tu_smk_list->potongan_bendahara->cellAttributes() ?>>
<span id="el<?php echo $vgaji_tu_smk_list->RowCount ?>_vgaji_tu_smk_potongan_bendahara">
<span<?php echo $vgaji_tu_smk_list->potongan_bendahara->viewAttributes() ?>><?php echo $vgaji_tu_smk_list->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vgaji_tu_smk_list->total->Visible) { // total ?>
