...
<span<?php echo $peg_dokumen_preview->file_dokumen->viewAttributes() ?>><?php echo GetFileViewTag($peg_dokumen_preview->file_dokumen, $peg_dokumen_preview->file_dokumen->getViewValue(), FALSE) ?></span>
</td>
<?php } ?>
<?php if ($peg_dokumen_preview->keterangan->Visible) { // keterangan ?>
		<!-- keterangan -->
