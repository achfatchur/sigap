...
loadjs.ready("head", function() {
	...
	fgaji_tu_smpgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_tu_smp_grid->status->Required) { ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_smp_grid->status->caption(), $gaji_tu_smp_grid->status->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_smp_grid->status->errorMessage()) ?>");
...
<?php if ($gaji_tu_smp_grid->voucher->Visible) { // voucher ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_tu_smp_grid->status->Visible) { // status ?>
	<?php if ($gaji_tu_smp_grid->SortUrl($gaji_tu_smp_grid->status) == "") { ?>
		<th data-name="status" class="<?php echo $gaji_tu_smp_grid->status->headerCellClass() ?>"><div id="elh_gaji_tu_smp_status" class="gaji_tu_smp_status"><div class="ew-table-header-caption"><?php echo $gaji_tu_smp_grid->status->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="status" class="<?php echo $gaji_tu_smp_grid->status->headerCellClass() ?>"><div><div id="elh_gaji_tu_smp_status" class="gaji_tu_smp_status">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_tu_smp_grid->status->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_tu_smp_grid->status->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_tu_smp_grid->status->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gaji_tu_smp_grid->status->Visible) { // status ?>
		<td data-name="status" <?php echo $gaji_tu_smp_grid->status->cellAttributes() ?>>
<?php if ($gaji_tu_smp->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_tu_smp_grid->RowCount ?>_gaji_tu_smp_status" class="form-group">
<input type="text" data-table="gaji_tu_smp" data-field="x_status" name="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_tu_smp_grid->status->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smp_grid->status->EditValue ?>"<?php echo $gaji_tu_smp_grid->status->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->OldValue) ?>">
<?php } ?>
<?php if ($gaji_tu_smp->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_tu_smp_grid->RowCount ?>_gaji_tu_smp_status" class="form-group">
<input type="text" data-table="gaji_tu_smp" data-field="x_status" name="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_tu_smp_grid->status->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smp_grid->status->EditValue ?>"<?php echo $gaji_tu_smp_grid->status->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_tu_smp->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_tu_smp_grid->RowCount ?>_gaji_tu_smp_status">
<span<?php echo $gaji_tu_smp_grid->status->viewAttributes() ?>><?php echo $gaji_tu_smp_grid->status->getViewValue() ?></span>
</span>
<?php if (!$gaji_tu_smp->isConfirm()) { ?>
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->FormValue) ?>">
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="fgaji_tu_smpgrid$x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="fgaji_tu_smpgrid$x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->FormValue) ?>">
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="fgaji_tu_smpgrid$o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="fgaji_tu_smpgrid$o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="gaji_tu_smp" data-field="x_voucher" name="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_voucher" id="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_voucher" value="<?php echo HtmlEncode($gaji_tu_smp_grid->voucher->OldValue) ?>">
	...
	<?php if ($gaji_tu_smp_grid->status->Visible) { // status ?>
		<td data-name="status">
<?php if (!$gaji_tu_smp->isConfirm()) { ?>
<span id="el$rowindex$_gaji_tu_smp_status" class="form-group gaji_tu_smp_status">
<input type="text" data-table="gaji_tu_smp" data-field="x_status" name="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_tu_smp_grid->status->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_smp_grid->status->EditValue ?>"<?php echo $gaji_tu_smp_grid->status->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_tu_smp_status" class="form-group gaji_tu_smp_status">
<span<?php echo $gaji_tu_smp_grid->status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_tu_smp_grid->status->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="x<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_tu_smp" data-field="x_status" name="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" id="o<?php echo $gaji_tu_smp_grid->RowIndex ?>_status" value="<?php echo HtmlEncode($gaji_tu_smp_grid->status->OldValue) ?>">
