...
<?php if ($terlambat_list->value->Visible) { // value ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($terlambat_list->valuejam->Visible) { // valuejam ?>
	<?php if ($terlambat_list->SortUrl($terlambat_list->valuejam) == "") { ?>
		<th data-name="valuejam" class="<?php echo $terlambat_list->valuejam->headerCellClass() ?>"><div id="elh_terlambat_valuejam" class="terlambat_valuejam"><div class="ew-table-header-caption"><?php echo $terlambat_list->valuejam->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="valuejam" class="<?php echo $terlambat_list->valuejam->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $terlambat_list->SortUrl($terlambat_list->valuejam) ?>', 1);"><div id="elh_terlambat_valuejam" class="terlambat_valuejam">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $terlambat_list->valuejam->caption() ?></span><span class="ew-table-header-sort"><?php if ($terlambat_list->valuejam->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($terlambat_list->valuejam->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($terlambat_list->jenis_jabatan->Visible) { // jenis_jabatan ?>
	<?php if ($terlambat_list->SortUrl($terlambat_list->jenis_jabatan) == "") { ?>
		<th data-name="jenis_jabatan" class="<?php echo $terlambat_list->jenis_jabatan->headerCellClass() ?>"><div id="elh_terlambat_jenis_jabatan" class="terlambat_jenis_jabatan"><div class="ew-table-header-caption"><?php echo $terlambat_list->jenis_jabatan->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jenis_jabatan" class="<?php echo $terlambat_list->jenis_jabatan->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $terlambat_list->SortUrl($terlambat_list->jenis_jabatan) ?>', 1);"><div id="elh_terlambat_jenis_jabatan" class="terlambat_jenis_jabatan">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $terlambat_list->jenis_jabatan->caption() ?></span><span class="ew-table-header-sort"><?php if ($terlambat_list->jenis_jabatan->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($terlambat_list->jenis_jabatan->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $terlambat_list->value->viewAttributes() ?>><?php echo $terlambat_list->value->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($terlambat_list->valuejam->Visible) { // valuejam ?>
		<td data-name="valuejam" <?php echo $terlambat_list->valuejam->cellAttributes() ?>>
<span id="el<?php echo $terlambat_list->RowCount ?>_terlambat_valuejam">
<span<?php echo $terlambat_list->valuejam->viewAttributes() ?>><?php echo $terlambat_list->valuejam->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($terlambat_list->jenis_jabatan->Visible) { // jenis_jabatan ?>
		<td data-name="jenis_jabatan" <?php echo $terlambat_list->jenis_jabatan->cellAttributes() ?>>
<span id="el<?php echo $terlambat_list->RowCount ?>_terlambat_jenis_jabatan">
<span<?php echo $terlambat_list->jenis_jabatan->viewAttributes() ?>><?php echo $terlambat_list->jenis_jabatan->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
