...
loadjs.ready("head", function() {
	...
	fgaji_karyawan_smaedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_karyawan_sma_edit->id->Required) { ?>
				elm = this.getElements("x" + infix + "_id");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_edit->id->caption(), $gaji_karyawan_sma_edit->id->RequiredErrorMessage)) ?>");
			<?php } ?>
			...
			<?php if ($gaji_karyawan_sma_edit->tahun->Required) { ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_edit->tahun->caption(), $gaji_karyawan_sma_edit->tahun->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahun");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_edit->tahun->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sma_edit->bulan->Required) { ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_edit->bulan->caption(), $gaji_karyawan_sma_edit->bulan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_bulan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_edit->bulan->errorMessage()) ?>");
			...
			<?php if ($gaji_karyawan_sma_edit->value_kehadiran->Required) { ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_edit->value_kehadiran->caption(), $gaji_karyawan_sma_edit->value_kehadiran->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_kehadiran");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_edit->value_kehadiran->errorMessage()) ?>");
			...
			<?php if ($gaji_karyawan_sma_edit->status->Required) { ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sma_edit->status->caption(), $gaji_karyawan_sma_edit->status->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_status");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sma_edit->status->errorMessage()) ?>");
	...
	fgaji_karyawan_smaedit.lists["x_bulan"] = <?php echo $gaji_karyawan_sma_edit->bulan->Lookup->toClientList($gaji_karyawan_sma_edit) ?>;
	fgaji_karyawan_smaedit.lists["x_bulan"].options = <?php echo JsonEncode($gaji_karyawan_sma_edit->bulan->lookupOptions()) ?>;
	fgaji_karyawan_smaedit.autoSuggests["x_bulan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_karyawan_sma_edit->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_edit->bulan->getSessionValue()) ?>">
<?php } ?>
<div class="ew-edit-div"><!-- page* -->
<?php if ($gaji_karyawan_sma_edit->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_gaji_karyawan_sma_id" class="<?php echo $gaji_karyawan_sma_edit->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_edit->id->caption() ?><?php echo $gaji_karyawan_sma_edit->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_edit->id->cellAttributes() ?>>
<span id="el_gaji_karyawan_sma_id">
<span<?php echo $gaji_karyawan_sma_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sma_edit->id->EditValue)) ?>"></span>
</span>
...
<?php echo $gaji_karyawan_sma_edit->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_edit->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_gaji_karyawan_sma_tahun" for="x_tahun" class="<?php echo $gaji_karyawan_sma_edit->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_edit->tahun->caption() ?><?php echo $gaji_karyawan_sma_edit->tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_edit->tahun->cellAttributes() ?>>
<?php if ($gaji_karyawan_sma_edit->tahun->getSessionValue() != "") { ?>
<span id="el_gaji_karyawan_sma_tahun">
<span<?php echo $gaji_karyawan_sma_edit->tahun->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sma_edit->tahun->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_tahun" name="x_tahun" value="<?php echo HtmlEncode($gaji_karyawan_sma_edit->tahun->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_karyawan_sma_tahun">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_tahun" name="x_tahun" id="x_tahun" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_edit->tahun->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_edit->tahun->EditValue ?>"<?php echo $gaji_karyawan_sma_edit->tahun->editAttributes() ?>>
</span>
<?php } ?>
<?php echo $gaji_karyawan_sma_edit->tahun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_karyawan_sma_edit->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_gaji_karyawan_sma_bulan" class="<?php echo $gaji_karyawan_sma_edit->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_edit->bulan->caption() ?><?php echo $gaji_karyawan_sma_edit->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_edit->bulan->cellAttributes() ?>>
<?php if ($gaji_karyawan_sma_edit->bulan->getSessionValue() != "") { ?>
<span id="el_gaji_karyawan_sma_bulan">
<span<?php echo $gaji_karyawan_sma_edit->bulan->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sma_edit->bulan->ViewValue)) ?>"></span>
</span>
<input type="hidden" id="x_bulan" name="x_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_edit->bulan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_gaji_karyawan_sma_bulan">
<?php
$onchange = $gaji_karyawan_sma_edit->bulan->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_karyawan_sma_edit->bulan->EditAttrs["onchange"] = "";
?>
<span id="as_x_bulan">
	<input type="text" class="form-control" name="sv_x_bulan" id="sv_x_bulan" value="<?php echo RemoveHtml($gaji_karyawan_sma_edit->bulan->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_edit->bulan->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_edit->bulan->getPlaceHolder()) ?>"<?php echo $gaji_karyawan_sma_edit->bulan->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sma" data-field="x_bulan" data-value-separator="<?php echo $gaji_karyawan_sma_edit->bulan->displayValueSeparatorAttribute() ?>" name="x_bulan" id="x_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sma_edit->bulan->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_karyawan_smaedit"], function() {
	fgaji_karyawan_smaedit.createAutoSuggest({"id":"x_bulan","forceSelect":false});
});
</script>
<?php echo $gaji_karyawan_sma_edit->bulan->Lookup->getParamTag($gaji_karyawan_sma_edit, "p_x_bulan") ?>
</span>
<?php } ?>
<?php echo $gaji_karyawan_sma_edit->bulan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_edit->value_kehadiran->Visible) { // value_kehadiran ?>
	<div id="r_value_kehadiran" class="form-group row">
		<label id="elh_gaji_karyawan_sma_value_kehadiran" for="x_value_kehadiran" class="<?php echo $gaji_karyawan_sma_edit->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_edit->value_kehadiran->caption() ?><?php echo $gaji_karyawan_sma_edit->value_kehadiran->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_edit->value_kehadiran->cellAttributes() ?>>
<span id="el_gaji_karyawan_sma_value_kehadiran">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_value_kehadiran" name="x_value_kehadiran" id="x_value_kehadiran" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_edit->value_kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_edit->value_kehadiran->EditValue ?>"<?php echo $gaji_karyawan_sma_edit->value_kehadiran->editAttributes() ?>>
</span>
<?php echo $gaji_karyawan_sma_edit->value_kehadiran->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_sma_edit->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_gaji_karyawan_sma_status" for="x_status" class="<?php echo $gaji_karyawan_sma_edit->LeftColumnClass ?>"><?php echo $gaji_karyawan_sma_edit->status->caption() ?><?php echo $gaji_karyawan_sma_edit->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_karyawan_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_karyawan_sma_edit->status->cellAttributes() ?>>
<span id="el_gaji_karyawan_sma_status">
<input type="text" data-table="gaji_karyawan_sma" data-field="x_status" name="x_status" id="x_status" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sma_edit->status->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sma_edit->status->EditValue ?>"<?php echo $gaji_karyawan_sma_edit->status->editAttributes() ?>>
</span>
<?php echo $gaji_karyawan_sma_edit->status->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
