...
<?php } ?>
<?php if ($m_tidakhadir_delete->sertif->Visible) { // sertif ?>
		<th class="<?php echo $m_tidakhadir_delete->sertif->headerCellClass() ?>"><span id="elh_m_tidakhadir_sertif" class="m_tidakhadir_sertif"><?php echo $m_tidakhadir_delete->sertif->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($m_tidakhadir_delete->type->Visible) { // type ?>
		<th class="<?php echo $m_tidakhadir_delete->type->headerCellClass() ?>"><span id="elh_m_tidakhadir_type" class="m_tidakhadir_type"><?php echo $m_tidakhadir_delete->type->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($m_tidakhadir_delete->sertif->Visible) { // sertif ?>
		<td <?php echo $m_tidakhadir_delete->sertif->cellAttributes() ?>>
<span id="el<?php echo $m_tidakhadir_delete->RowCount ?>_m_tidakhadir_sertif" class="m_tidakhadir_sertif">
<span<?php echo $m_tidakhadir_delete->sertif->viewAttributes() ?>><?php echo $m_tidakhadir_delete->sertif->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($m_tidakhadir_delete->value->Visible) { // value ?>
...
<?php } ?>
<?php if ($m_tidakhadir_delete->type->Visible) { // type ?>
		<td <?php echo $m_tidakhadir_delete->type->cellAttributes() ?>>
<span id="el<?php echo $m_tidakhadir_delete->RowCount ?>_m_tidakhadir_type" class="m_tidakhadir_type">
<span<?php echo $m_tidakhadir_delete->type->viewAttributes() ?>><?php echo $m_tidakhadir_delete->type->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
