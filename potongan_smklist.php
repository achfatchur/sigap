...
<?php } ?>
<?php if (!$potongan_smk_list->isExport() || Config("EXPORT_MASTER_RECORD") && $potongan_smk_list->isExport("print")) { ?>
<?php
if ($potongan_smk_list->DbMasterFilter != "" && $potongan_smk->getCurrentMasterTable() == "m_potongan_smk") {
	if ($potongan_smk_list->MasterRecordExists) {
		include_once "m_potongan_smkmaster.php";
	}
}
?>
<?php } ?>
...
<?php } ?>
<input type="hidden" name="t" value="potongan_smk">
<?php if ($potongan_smk->getCurrentMasterTable() == "m_potongan_smk" && $potongan_smk->CurrentAction) { ?>
<input type="hidden" name="<?php echo Config("TABLE_SHOW_MASTER") ?>" value="m_potongan_smk">
<input type="hidden" name="fk_id" value="<?php echo HtmlEncode($potongan_smk_list->pid->getSessionValue()) ?>">
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($potongan_smk_list->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($potongan_smk_list->bulan->getSessionValue()) ?>">
<?php } ?>
...
?>
<?php if ($potongan_smk_list->tahun->Visible) { // tahun ?>
	<?php if ($potongan_smk_list->SortUrl($potongan_smk_list->tahun) == "") { ?>
		<th data-name="tahun" class="<?php echo $potongan_smk_list->tahun->headerCellClass() ?>"><div id="elh_potongan_smk_tahun" class="potongan_smk_tahun"><div class="ew-table-header-caption"><?php echo $potongan_smk_list->tahun->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tahun" class="<?php echo $potongan_smk_list->tahun->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_smk_list->SortUrl($potongan_smk_list->tahun) ?>', 1);"><div id="elh_potongan_smk_tahun" class="potongan_smk_tahun">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_smk_list->tahun->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_smk_list->tahun->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_smk_list->tahun->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($potongan_smk_list->bulan->Visible) { // bulan ?>
	<?php if ($potongan_smk_list->SortUrl($potongan_smk_list->bulan) == "") { ?>
		<th data-name="bulan" class="<?php echo $potongan_smk_list->bulan->headerCellClass() ?>"><div id="elh_potongan_smk_bulan" class="potongan_smk_bulan"><div class="ew-table-header-caption"><?php echo $potongan_smk_list->bulan->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="bulan" class="<?php echo $potongan_smk_list->bulan->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_smk_list->SortUrl($potongan_smk_list->bulan) ?>', 1);"><div id="elh_potongan_smk_bulan" class="potongan_smk_bulan">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_smk_list->bulan->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_smk_list->bulan->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_smk_list->bulan->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($potongan_smk_list->jabatan_id->Visible) { // jabatan_id ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_smk_list->sertif->Visible) { // sertif ?>
	<?php if ($potongan_smk_list->SortUrl($potongan_smk_list->sertif) == "") { ?>
		<th data-name="sertif" class="<?php echo $potongan_smk_list->sertif->headerCellClass() ?>"><div id="elh_potongan_smk_sertif" class="potongan_smk_sertif"><div class="ew-table-header-caption"><?php echo $potongan_smk_list->sertif->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sertif" class="<?php echo $potongan_smk_list->sertif->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_smk_list->SortUrl($potongan_smk_list->sertif) ?>', 1);"><div id="elh_potongan_smk_sertif" class="potongan_smk_sertif">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_smk_list->sertif->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_smk_list->sertif->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_smk_list->sertif->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($potongan_smk_list->tahun->Visible) { // tahun ?>
		<td data-name="tahun" <?php echo $potongan_smk_list->tahun->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_list->RowCount ?>_potongan_smk_tahun">
<span<?php echo $potongan_smk_list->tahun->viewAttributes() ?>><?php echo $potongan_smk_list->tahun->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_smk_list->bulan->Visible) { // bulan ?>
		<td data-name="bulan" <?php echo $potongan_smk_list->bulan->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_list->RowCount ?>_potongan_smk_bulan">
<span<?php echo $potongan_smk_list->bulan->viewAttributes() ?>><?php echo $potongan_smk_list->bulan->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_smk_list->nama->Visible) { // nama ?>
...
<span<?php echo $potongan_smk_list->jabatan_id->viewAttributes() ?>><?php echo $potongan_smk_list->jabatan_id->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_smk_list->sertif->Visible) { // sertif ?>
		<td data-name="sertif" <?php echo $potongan_smk_list->sertif->cellAttributes() ?>>
<span id="el<?php echo $potongan_smk_list->RowCount ?>_potongan_smk_sertif">
<span<?php echo $potongan_smk_list->sertif->viewAttributes() ?>><?php echo $potongan_smk_list->sertif->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_smk_list->terlambat->Visible) { // terlambat ?>
