...
<?php if ($gajismk_detil_list->jumlahterima->Visible) { // jumlahterima ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gajismk_detil_list->jp->Visible) { // jp ?>
	<?php if ($gajismk_detil_list->SortUrl($gajismk_detil_list->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gajismk_detil_list->jp->headerCellClass() ?>"><div id="elh_gajismk_detil_jp" class="gajismk_detil_jp"><div class="ew-table-header-caption"><?php echo $gajismk_detil_list->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gajismk_detil_list->jp->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gajismk_detil_list->SortUrl($gajismk_detil_list->jp) ?>', 1);"><div id="elh_gajismk_detil_jp" class="gajismk_detil_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gajismk_detil_list->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gajismk_detil_list->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gajismk_detil_list->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gajismk_detil_list->jumlahterima->viewAttributes() ?>><?php echo $gajismk_detil_list->jumlahterima->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gajismk_detil_list->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gajismk_detil_list->jp->cellAttributes() ?>>
<span id="el<?php echo $gajismk_detil_list->RowCount ?>_gajismk_detil_jp">
<span<?php echo $gajismk_detil_list->jp->viewAttributes() ?>><?php echo $gajismk_detil_list->jp->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
