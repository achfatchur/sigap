...
// EMPLOYEE
	// TK
		...
		foreach($employee_tk as $data){
			...
			$sql = ExecuteRow("SELECT * FROM pegawai WHERE jenjang_id = '1' AND nip = '".$nip."'");
			...
			if (empty($sql)) {
				$sql_tk = Execute("INSERT INTO pegawai VALUES (NULL, NULL, '".$data->nama."', '".$data->address."', '".$data->email."', '".$data->phone."', '".$data->phone."', '".$tgl_lahir."', '".$nip."', '".$data->no_rek."', NULL, NULL, '".$data->religion."', '".$data->gender."', ".$status_peg.", NULL, NULL, ".$jenis_ptk.", '".$data->mulai_kerja."', NULL, '".$data->email."', 123456, 1, 1, 1, ".$jabatan.", ".$sertifikasi.", NULL, NULL, NULL, ".$status_peg.", NULL, NULL, NULL, NULL, NULL)");
			}else{
				$id_pegawai = $sql['id'];
				$sql_tk = Execute("UPDATE pegawai SET nama = '".$data->nama."', alamat = '".$data->address."', email = '".$data->email."', wa = '".$data->phone."', hp = '".$data->phone."', tgllahir = '".$tgl_lahir."', rekbank = '".$data->no_rek."', jenkel = '".$data->gender."', status_peg = ".$status_peg.", mulai_bekerja = ".$data->mulai_kerja.", jabatan = ".$jenis_ptk.", type = ".$jabatan.", sertif = ".$sertifikasi.", level = '1' WHERE id = '".$id_pegawai."'");
			}
		}
	// TK END
	...
	// SD
		...
		foreach($employee_sd as $data){
			...
			$sql = ExecuteRow("SELECT * FROM pegawai WHERE jenjang_id = '2' AND nip= '".$nip."'");
			$status_peg = ExecuteScalar("SELECT id FROM status_kepeg WHERE name = '%".$data->status_pegawai."%'");
			if(empty($status_peg)){
				$status_peg = 'NULL';
			}
			...
			if (empty($sql)) {
				$sql_sd = Execute("INSERT INTO pegawai VALUES (NULL, NULL, '".$data->nama."', '".$data->address."', '".$data->email."', '".$data->phone."', '".$data->phone."', '".$tgl_lahir."', '".$nip."', '".$data->no_rek."', NULL, NULL, '".$data->religion."', '".$data->gender."', ".$status_peg.", NULL, NULL, ".$jenis_ptk.", '".$data->mulai_kerja."', NULL, '".$data->email."', 123456, 1, 1, 2, ".$jabatan.", ".$sertifikasi.", NULL, NULL, NULL, ".$status_peg.", NULL, NULL, NULL, NULL, NULL)");
			}else{
				$id_pegawai = $sql['id'];
				$sql_sd = Execute("UPDATE pegawai SET nama = '".$data->nama."', alamat = '".$data->address."', email = '".$data->email."', wa = '".$data->phone."', hp = '".$data->phone."', tgllahir = '".$tgl_lahir."', rekbank = '".$data->no_rek."', jenkel = '".$data->gender."', status_peg = ".$status_peg.", mulai_bekerja = ".$data->mulai_kerja.", jabatan = ".$jenis_ptk.", type = ".$jabatan.", sertif = ".$sertifikasi.", level = '1' WHERE id = '".$id_pegawai."'");
			}
		}
	// SD END
	...
	// SMP
		...
		foreach($employee_smp as $data){
			...
			$sql = ExecuteRow("SELECT * FROM pegawai WHERE jenjang_id = '3' AND nip= '".$nip."'");
			$status_peg = ExecuteScalar("SELECT id FROM status_kepeg WHERE name = '%".$data->status_pegawai."%'");
			if(empty($status_peg)){
				$status_peg = 'NULL';
			}
			...
			if (empty($sql)) {
				$sql_smp = Execute("INSERT INTO pegawai VALUES (NULL, NULL, '".$data->nama."', '".$data->address."', '".$data->email."', '".$data->phone."', '".$data->phone."', '".$tgl_lahir."', '".$nip."', '".$data->no_rek."', NULL, NULL, '".$data->religion."', '".$data->gender."', ".$status_peg.", NULL, NULL, ".$jenis_ptk.", '".$data->mulai_kerja."', NULL, '".$data->email."', 123456, 1, 1, 3, ".$jabatan.", ".$sertifikasi.", NULL, NULL, NULL, ".$status_peg.", NULL, NULL, NULL, NULL, NULL)");
			}else{
				$id_pegawai = $sql['id'];
				$sql_smp = Execute("UPDATE pegawai SET nama = '".$data->nama."', alamat = '".$data->address."', email = '".$data->email."', wa = '".$data->phone."', hp = '".$data->phone."', tgllahir = '".$tgl_lahir."', rekbank = '".$data->no_rek."', jenkel = '".$data->gender."', status_peg = ".$status_peg.", mulai_bekerja = ".$data->mulai_kerja.", jabatan = ".$jenis_ptk.", type = ".$jabatan.", sertif = ".$sertifikasi.", level = '1' WHERE id = '".$id_pegawai."'");
			}
		}
	// SMP END
	...
	// SMA
		...
		foreach($employee_sma as $data){
			...
			$sql = ExecuteRow("SELECT * FROM pegawai WHERE jenjang_id = '4' AND nip= '".$nip."'");
			$status_peg = ExecuteScalar("SELECT id FROM status_kepeg WHERE name = '%".$data->status_pegawai."%'");
			if(empty($status_peg)){
				$status_peg = 'NULL';
			}
			...
			if (empty($sql)) {
				$sql_sma = Execute("INSERT INTO pegawai VALUES (NULL, NULL, '".$data->nama."', '".$data->address."', '".$data->email."', '".$data->phone."', '".$data->phone."', '".$tgl_lahir."', '".$nip."', '".$data->no_rek."', NULL, NULL, '".$data->religion."', '".$data->gender."', ".$status_peg.", NULL, NULL, ".$jenis_ptk.", '".$data->mulai_kerja."', NULL, '".$data->email."', 123456, 1, 1, 4, ".$jabatan.", ".$sertifikasi.", NULL, NULL, NULL, ".$status_peg.", NULL, NULL, NULL, NULL, NULL)");
			}else{
				$id_pegawai = $sql['id'];
				$sql_sma = Execute("UPDATE pegawai SET nama = '".$data->nama."', alamat = '".$data->address."', email = '".$data->email."', wa = '".$data->phone."', hp = '".$data->phone."', tgllahir = '".$tgl_lahir."', rekbank = '".$data->no_rek."', jenkel = '".$data->gender."', status_peg = ".$status_peg.", mulai_bekerja = ".$data->mulai_kerja.", jabatan = ".$jenis_ptk.", type = ".$jabatan.", sertif = ".$sertifikasi.", level = '1' WHERE id = '".$id_pegawai."'");
			}
		}
	// SMA END
	...
	// SMK
		...
		foreach($employee_smk as $data){
			...
			$sql = ExecuteRow("SELECT * FROM pegawai WHERE jenjang_id = '5' AND nip= '".$nip."'");
			$status_peg = ExecuteScalar("SELECT id FROM status_kepeg WHERE name = '%".$data->status_pegawai."%'");
			if(empty($status_peg)){
				$status_peg = 'NULL';
			}
			...
			if (empty($sql)) {
				$sql_smk = Execute("INSERT INTO pegawai VALUES (NULL, NULL, '".$data->nama."', '".$data->address."', '".$data->email."', '".$data->phone."', '".$data->phone."', '".$tgl_lahir."', '".$nip."', '".$data->no_rek."', NULL, NULL, '".$data->religion."', '".$data->gender."', ".$status_peg.", NULL, NULL, ".$jenis_ptk.", '".$data->mulai_kerja."', NULL, '".$data->email."', 123456, 1, 1, 5, ".$jabatan.", ".$sertifikasi.", NULL, NULL, NULL, ".$status_peg.", NULL, NULL, NULL, NULL, NULL)");
			}else{
				$id_pegawai = $sql['id'];
				$sql_smk = Execute("UPDATE pegawai SET nama = '".$data->nama."', alamat = '".$data->address."', email = '".$data->email."', wa = '".$data->phone."', hp = '".$data->phone."', tgllahir = '".$tgl_lahir."', rekbank = '".$data->no_rek."', jenkel = '".$data->gender."', status_peg = ".$status_peg.", mulai_bekerja = ".$data->mulai_kerja.", jabatan = ".$jenis_ptk.", type = ".$jabatan.", sertif = ".$sertifikasi.", level = '1' WHERE id = '".$id_pegawai."'");
			}
		}
	// SMK END
// ENDEMPLLOYEE
