...
<?php if ($m_smk_edit->bulan->Visible) { // bulan ?>
	<div id="r_bulan" class="form-group row">
		<label id="elh_m_smk_bulan" for="x_bulan" class="<?php echo $m_smk_edit->LeftColumnClass ?>"><?php echo $m_smk_edit->bulan->caption() ?><?php echo $m_smk_edit->bulan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $m_smk_edit->RightColumnClass ?>"><div <?php echo $m_smk_edit->bulan->cellAttributes() ?>>
<span id="el_m_smk_bulan">
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_smk" data-field="x_bulan" data-value-separator="<?php echo $m_smk_edit->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_smk_edit->bulan->editAttributes() ?>>
			<?php echo $m_smk_edit->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
