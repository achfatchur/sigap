...
<?php } ?>
<?php if (!$potongan_sma_list->isExport() || Config("EXPORT_MASTER_RECORD") && $potongan_sma_list->isExport("print")) { ?>
<?php
if ($potongan_sma_list->DbMasterFilter != "" && $potongan_sma->getCurrentMasterTable() == "m_potongan_sma") {
	if ($potongan_sma_list->MasterRecordExists) {
		include_once "m_potongan_smamaster.php";
	}
}
?>
<?php } ?>
...
<?php } ?>
<input type="hidden" name="t" value="potongan_sma">
<?php if ($potongan_sma->getCurrentMasterTable() == "m_potongan_sma" && $potongan_sma->CurrentAction) { ?>
<input type="hidden" name="<?php echo Config("TABLE_SHOW_MASTER") ?>" value="m_potongan_sma">
<input type="hidden" name="fk_id" value="<?php echo HtmlEncode($potongan_sma_list->pid->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($potongan_sma_list->bulan->getSessionValue()) ?>">
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($potongan_sma_list->tahun->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($potongan_sma_list->datetime->Visible) { // datetime ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_sma_list->tahun->Visible) { // tahun ?>
	<?php if ($potongan_sma_list->SortUrl($potongan_sma_list->tahun) == "") { ?>
		<th data-name="tahun" class="<?php echo $potongan_sma_list->tahun->headerCellClass() ?>"><div id="elh_potongan_sma_tahun" class="potongan_sma_tahun"><div class="ew-table-header-caption"><?php echo $potongan_sma_list->tahun->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tahun" class="<?php echo $potongan_sma_list->tahun->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_sma_list->SortUrl($potongan_sma_list->tahun) ?>', 1);"><div id="elh_potongan_sma_tahun" class="potongan_sma_tahun">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_sma_list->tahun->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_sma_list->tahun->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_sma_list->tahun->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($potongan_sma_list->bulan->Visible) { // bulan ?>
	<?php if ($potongan_sma_list->SortUrl($potongan_sma_list->bulan) == "") { ?>
		<th data-name="bulan" class="<?php echo $potongan_sma_list->bulan->headerCellClass() ?>"><div id="elh_potongan_sma_bulan" class="potongan_sma_bulan"><div class="ew-table-header-caption"><?php echo $potongan_sma_list->bulan->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="bulan" class="<?php echo $potongan_sma_list->bulan->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_sma_list->SortUrl($potongan_sma_list->bulan) ?>', 1);"><div id="elh_potongan_sma_bulan" class="potongan_sma_bulan">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_sma_list->bulan->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_sma_list->bulan->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_sma_list->bulan->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($potongan_sma_list->jabatan_id->Visible) { // jabatan_id ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_sma_list->sertif->Visible) { // sertif ?>
	<?php if ($potongan_sma_list->SortUrl($potongan_sma_list->sertif) == "") { ?>
		<th data-name="sertif" class="<?php echo $potongan_sma_list->sertif->headerCellClass() ?>"><div id="elh_potongan_sma_sertif" class="potongan_sma_sertif"><div class="ew-table-header-caption"><?php echo $potongan_sma_list->sertif->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sertif" class="<?php echo $potongan_sma_list->sertif->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_sma_list->SortUrl($potongan_sma_list->sertif) ?>', 1);"><div id="elh_potongan_sma_sertif" class="potongan_sma_sertif">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_sma_list->sertif->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_sma_list->sertif->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_sma_list->sertif->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<span<?php echo $potongan_sma_list->datetime->viewAttributes() ?>><?php echo $potongan_sma_list->datetime->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_sma_list->tahun->Visible) { // tahun ?>
		<td data-name="tahun" <?php echo $potongan_sma_list->tahun->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_list->RowCount ?>_potongan_sma_tahun">
<span<?php echo $potongan_sma_list->tahun->viewAttributes() ?>><?php echo $potongan_sma_list->tahun->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_sma_list->bulan->Visible) { // bulan ?>
		<td data-name="bulan" <?php echo $potongan_sma_list->bulan->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_list->RowCount ?>_potongan_sma_bulan">
<span<?php echo $potongan_sma_list->bulan->viewAttributes() ?>><?php echo $potongan_sma_list->bulan->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_sma_list->nama->Visible) { // nama ?>
...
<span<?php echo $potongan_sma_list->jabatan_id->viewAttributes() ?>><?php echo $potongan_sma_list->jabatan_id->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_sma_list->sertif->Visible) { // sertif ?>
		<td data-name="sertif" <?php echo $potongan_sma_list->sertif->cellAttributes() ?>>
<span id="el<?php echo $potongan_sma_list->RowCount ?>_potongan_sma_sertif">
<span<?php echo $potongan_sma_list->sertif->viewAttributes() ?>><?php echo $potongan_sma_list->sertif->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_sma_list->terlambat->Visible) { // terlambat ?>
