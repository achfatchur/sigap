...
<?php if ($m_tidakhadir_list->jabatan_id->Visible) { // jabatan_id ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($m_tidakhadir_list->sertif->Visible) { // sertif ?>
	<?php if ($m_tidakhadir_list->SortUrl($m_tidakhadir_list->sertif) == "") { ?>
		<th data-name="sertif" class="<?php echo $m_tidakhadir_list->sertif->headerCellClass() ?>"><div id="elh_m_tidakhadir_sertif" class="m_tidakhadir_sertif"><div class="ew-table-header-caption"><?php echo $m_tidakhadir_list->sertif->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sertif" class="<?php echo $m_tidakhadir_list->sertif->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $m_tidakhadir_list->SortUrl($m_tidakhadir_list->sertif) ?>', 1);"><div id="elh_m_tidakhadir_sertif" class="m_tidakhadir_sertif">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $m_tidakhadir_list->sertif->caption() ?></span><span class="ew-table-header-sort"><?php if ($m_tidakhadir_list->sertif->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($m_tidakhadir_list->sertif->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($m_tidakhadir_list->perjam_value->Visible) { // perjam_value ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($m_tidakhadir_list->type->Visible) { // type ?>
	<?php if ($m_tidakhadir_list->SortUrl($m_tidakhadir_list->type) == "") { ?>
		<th data-name="type" class="<?php echo $m_tidakhadir_list->type->headerCellClass() ?>"><div id="elh_m_tidakhadir_type" class="m_tidakhadir_type"><div class="ew-table-header-caption"><?php echo $m_tidakhadir_list->type->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="type" class="<?php echo $m_tidakhadir_list->type->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $m_tidakhadir_list->SortUrl($m_tidakhadir_list->type) ?>', 1);"><div id="elh_m_tidakhadir_type" class="m_tidakhadir_type">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $m_tidakhadir_list->type->caption() ?></span><span class="ew-table-header-sort"><?php if ($m_tidakhadir_list->type->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($m_tidakhadir_list->type->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $m_tidakhadir_list->jabatan_id->viewAttributes() ?>><?php echo $m_tidakhadir_list->jabatan_id->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($m_tidakhadir_list->sertif->Visible) { // sertif ?>
		<td data-name="sertif" <?php echo $m_tidakhadir_list->sertif->cellAttributes() ?>>
<span id="el<?php echo $m_tidakhadir_list->RowCount ?>_m_tidakhadir_sertif">
<span<?php echo $m_tidakhadir_list->sertif->viewAttributes() ?>><?php echo $m_tidakhadir_list->sertif->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($m_tidakhadir_list->value->Visible) { // value ?>
...
<span<?php echo $m_tidakhadir_list->perjam_value->viewAttributes() ?>><?php echo $m_tidakhadir_list->perjam_value->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($m_tidakhadir_list->type->Visible) { // type ?>
		<td data-name="type" <?php echo $m_tidakhadir_list->type->cellAttributes() ?>>
<span id="el<?php echo $m_tidakhadir_list->RowCount ?>_m_tidakhadir_type">
<span<?php echo $m_tidakhadir_list->type->viewAttributes() ?>><?php echo $m_tidakhadir_list->type->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
