...
<input type="hidden" name="fk_tahun" value="<?php echo HtmlEncode($gaji_karyawan_sd_list->tahun->getSessionValue()) ?>">
<input type="hidden" name="fk_bulan" value="<?php echo HtmlEncode($gaji_karyawan_sd_list->bulan->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($gaji_karyawan_sd_list->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_list->voucher->Visible) { // voucher ?>
	<?php if ($gaji_karyawan_sd_list->SortUrl($gaji_karyawan_sd_list->voucher) == "") { ?>
		<th data-name="voucher" class="<?php echo $gaji_karyawan_sd_list->voucher->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_voucher" class="gaji_karyawan_sd_voucher"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_list->voucher->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="voucher" class="<?php echo $gaji_karyawan_sd_list->voucher->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_sd_list->SortUrl($gaji_karyawan_sd_list->voucher) ?>', 1);"><div id="elh_gaji_karyawan_sd_voucher" class="gaji_karyawan_sd_voucher">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_list->voucher->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_list->voucher->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_list->voucher->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
	<?php if ($gaji_karyawan_sd_list->SortUrl($gaji_karyawan_sd_list->potongan_bendahara) == "") { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_karyawan_sd_list->potongan_bendahara->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_potongan_bendahara" class="gaji_karyawan_sd_potongan_bendahara"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_list->potongan_bendahara->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="potongan_bendahara" class="<?php echo $gaji_karyawan_sd_list->potongan_bendahara->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_sd_list->SortUrl($gaji_karyawan_sd_list->potongan_bendahara) ?>', 1);"><div id="elh_gaji_karyawan_sd_potongan_bendahara" class="gaji_karyawan_sd_potongan_bendahara">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_list->potongan_bendahara->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_list->potongan_bendahara->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_list->potongan_bendahara->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gaji_karyawan_sd_list->total->viewAttributes() ?>><?php echo $gaji_karyawan_sd_list->total->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_karyawan_sd_list->voucher->Visible) { // voucher ?>
		<td data-name="voucher" <?php echo $gaji_karyawan_sd_list->voucher->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_sd_list->RowCount ?>_gaji_karyawan_sd_voucher">
<span<?php echo $gaji_karyawan_sd_list->voucher->viewAttributes() ?>><?php echo $gaji_karyawan_sd_list->voucher->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_sd_list->potongan_bendahara->Visible) { // potongan_bendahara ?>
		<td data-name="potongan_bendahara" <?php echo $gaji_karyawan_sd_list->potongan_bendahara->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_sd_list->RowCount ?>_gaji_karyawan_sd_potongan_bendahara">
<span<?php echo $gaji_karyawan_sd_list->potongan_bendahara->viewAttributes() ?>><?php echo $gaji_karyawan_sd_list->potongan_bendahara->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
