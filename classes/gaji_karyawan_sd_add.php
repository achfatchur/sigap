 ...
 * Page class
 */
class gaji_karyawan_sd_add extends gaji_karyawan_sd
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_sd_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "gaji_karyawan_sdview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'gaji_karyawan_sd'
