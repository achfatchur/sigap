 ...
 * Page class
 */
class m_tidakhadir_edit extends m_tidakhadir
{
	...
	// Page object name
	public $PageObjName = "m_tidakhadir_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// perjam_value
			$this->perjam_value->setDbValueDef($rsnew, $this->perjam_value->CurrentValue, NULL, $this->perjam_value->ReadOnly);
