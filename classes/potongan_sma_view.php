 ...
 * Page class
 */
class potongan_sma_view extends potongan_sma
{
	...
	// Page object name
	public $PageObjName = "potongan_sma_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potongan_smalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potongan_smalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potongan_smalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
