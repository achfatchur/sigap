...
/**
 * Table class for gajismk_detil
 */
class gajismk_detil extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gajismk_detil';
		$this->TableName = 'gajismk_detil';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gajismk_detil`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gajismk_detil', 'gajismk_detil', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('gajismk_detil', 'gajismk_detil', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai_id
		$this->pegawai_id = new DbField('gajismk_detil', 'gajismk_detil', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 200, 50, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gajismk_detil', 'gajismk_detil', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// masakerja
		$this->masakerja = new DbField('gajismk_detil', 'gajismk_detil', 'x_masakerja', 'masakerja', '`masakerja`', '`masakerja`', 2, 6, -1, FALSE, '`masakerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumngajar
		$this->jumngajar = new DbField('gajismk_detil', 'gajismk_detil', 'x_jumngajar', 'jumngajar', '`jumngajar`', '`jumngajar`', 2, 6, -1, FALSE, '`jumngajar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ijin
		$this->ijin = new DbField('gajismk_detil', 'gajismk_detil', 'x_ijin', 'ijin', '`ijin`', '`ijin`', 2, 6, -1, FALSE, '`ijin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tunjangan_wkosis
		$this->tunjangan_wkosis = new DbField('gajismk_detil', 'gajismk_detil', 'x_tunjangan_wkosis', 'tunjangan_wkosis', '`tunjangan_wkosis`', '`tunjangan_wkosis`', 3, 11, -1, FALSE, '`tunjangan_wkosis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nominal_baku
		$this->nominal_baku = new DbField('gajismk_detil', 'gajismk_detil', 'x_nominal_baku', 'nominal_baku', '`nominal_baku`', '`nominal_baku`', 3, 11, -1, FALSE, '`nominal_baku`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// baku
		$this->baku = new DbField('gajismk_detil', 'gajismk_detil', 'x_baku', 'baku', '`baku`', '`baku`', 3, 11, -1, FALSE, '`baku`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('gajismk_detil', 'gajismk_detil', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// prestasi
		$this->prestasi = new DbField('gajismk_detil', 'gajismk_detil', 'x_prestasi', 'prestasi', '`prestasi`', '`prestasi`', 3, 11, -1, FALSE, '`prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlahgaji
		$this->jumlahgaji = new DbField('gajismk_detil', 'gajismk_detil', 'x_jumlahgaji', 'jumlahgaji', '`jumlahgaji`', '`jumlahgaji`', 3, 11, -1, FALSE, '`jumlahgaji`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumgajitotal
		$this->jumgajitotal = new DbField('gajismk_detil', 'gajismk_detil', 'x_jumgajitotal', 'jumgajitotal', '`jumgajitotal`', '`jumgajitotal`', 3, 11, -1, FALSE, '`jumgajitotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan1
		$this->potongan1 = new DbField('gajismk_detil', 'gajismk_detil', 'x_potongan1', 'potongan1', '`potongan1`', '`potongan1`', 3, 11, -1, FALSE, '`potongan1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan2
		$this->potongan2 = new DbField('gajismk_detil', 'gajismk_detil', 'x_potongan2', 'potongan2', '`potongan2`', '`potongan2`', 3, 11, -1, FALSE, '`potongan2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlahterima
		$this->jumlahterima = new DbField('gajismk_detil', 'gajismk_detil', 'x_jumlahterima', 'jumlahterima', '`jumlahterima`', '`jumlahterima`', 3, 11, -1, FALSE, '`jumlahterima`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gajismk_detil', 'gajismk_detil', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	public function sqlMasterFilter_gajismk()
	{
		return "`id`=@id@";
	}

	// Detail filter
	public function sqlDetailFilter_gajismk()
	{
		return "`pid`=@pid@";
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gajismk_detil`";
	}
	...
	{
		global $Language;
		if ($pageName == "gajismk_detilview.php")
			return $Language->phrase("View");
		elseif ($pageName == "gajismk_detiledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gajismk_detiladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gajismk_detilview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gajismk_detilview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gajismk_detiladd.php?" . $this->getUrlParm($parm);
		else
			$url = "gajismk_detiladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gajismk_detiledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gajismk_detiladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gajismk_detildelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "gajismk" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
