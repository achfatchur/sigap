 ...
 * Page class
 */
class m_penyesuaian_view extends m_penyesuaian
{
	...
	// Page object name
	public $PageObjName = "m_penyesuaian_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_penyesuaianlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_penyesuaianlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_penyesuaianlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupOtherOptions()
	{
		...
		// "detail_penyesuaian"
		$item = &$option->add("detail_penyesuaian");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("penyesuaian", "TblCaption");
		...
		if ($GLOBALS["penyesuaian_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'm_penyesuaian')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=penyesuaian")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
			$detailViewTblVar .= "penyesuaian";
		}
		if ($GLOBALS["penyesuaian_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_penyesuaian')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=penyesuaian")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
			$detailEditTblVar .= "penyesuaian";
		}
		if ($GLOBALS["penyesuaian_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_penyesuaian')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=penyesuaian")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
			$detailCopyTblVar .= "penyesuaian";
		}
		if ($links != "") {
		...
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'penyesuaian');
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("penyesuaian", $detailTblVar)) {
				if (!isset($GLOBALS["penyesuaian_grid"]))
					$GLOBALS["penyesuaian_grid"] = new penyesuaian_grid();
				if ($GLOBALS["penyesuaian_grid"]->DetailView) {
					$GLOBALS["penyesuaian_grid"]->CurrentMode = "view";
