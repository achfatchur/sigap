 ...
 * Page class
 */
class m_karyawan_sma_edit extends m_karyawan_sma
{
	...
	// Page object name
	public $PageObjName = "m_karyawan_sma_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_karyawan_sma", $detailTblVar) && $GLOBALS["gaji_karyawan_sma"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_karyawan_sma", $detailTblVar) && $GLOBALS["gaji_karyawan_sma"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_karyawan_sma_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_karyawan_sma", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_karyawan_sma_grid"]->DetailEdit) {
					$GLOBALS["gaji_karyawan_sma_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_karyawan_sma_grid"]->CurrentAction = "gridedit";
