 ...
 * Page class
 */
class potongan_smk_delete extends potongan_smk
{
	...
	// Page object name
	public $PageObjName = "potongan_smk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("potongan_smklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("potongan_smklist.php"); // Return to list
			}
		}
	}
