 ...
 * Page class
 */
class potongan_smk_view extends potongan_smk
{
	...
	// Page object name
	public $PageObjName = "potongan_smk_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potongan_smklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potongan_smklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potongan_smklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
