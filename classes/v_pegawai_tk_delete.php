 ...
 * Page class
 */
class v_pegawai_tk_delete extends v_pegawai_tk
{
	...
	// Page object name
	public $PageObjName = "v_pegawai_tk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pegawai_tklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pegawai_tklist.php"); // Return to list
			}
		}
	}
