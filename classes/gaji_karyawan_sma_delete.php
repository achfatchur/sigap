 ...
 * Page class
 */
class gaji_karyawan_sma_delete extends gaji_karyawan_sma
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_sma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_karyawan_smalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_karyawan_smalist.php"); // Return to list
			}
		}
	}
