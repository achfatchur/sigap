 ...
 * Page class
 */
class gaji_pokok_kayawan_view extends gaji_pokok_kayawan
{
	...
	// Page object name
	public $PageObjName = "gaji_pokok_kayawan_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("gaji_pokok_kayawanlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gaji_pokok_kayawanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gaji_pokok_kayawanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gaji_pokok_kayawanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("gaji_pokok_kayawanlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
