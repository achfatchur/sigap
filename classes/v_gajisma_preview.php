 ...
 * Page class
 */
class v_gajisma_preview extends v_gajisma
{
	...
	// Page object name
	public $PageObjName = "v_gajisma_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gajisma');
			if ($Security->isLoggedIn())
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gajismalist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
