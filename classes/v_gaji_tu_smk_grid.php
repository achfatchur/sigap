 ...
 * Page class
 */
class v_gaji_tu_smk_grid extends v_gaji_tu_smk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_smk_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_tu_smkgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_tu_smk'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_tu_smk();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_tu_smk"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_tu_smk", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_tu_smk'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_tu_smk();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_tu_smk") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_tu_smk"]->EventCancelled)
