 ...
 * Page class
 */
class m_sakit_view extends m_sakit
{
	...
	// Page object name
	public $PageObjName = "m_sakit_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_sakitlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_sakitlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_sakitlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
