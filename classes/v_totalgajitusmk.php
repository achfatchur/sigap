...
/**
 * Table class for v_totalgajitusmk
 */
class v_totalgajitusmk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_totalgajitusmk';
		$this->TableName = 'v_totalgajitusmk';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_totalgajitusmk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// bulan
		$this->bulan = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 18, 4, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// total
		$this->total = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_total', 'total', '`total`', '`total`', 20, 19, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// id1
		$this->id1 = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_id1', 'id1', '`id1`', '`id1`', 3, 10, -1, FALSE, '`id1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// status
		$this->status = new DbField('v_totalgajitusmk', 'v_totalgajitusmk', 'x_status', 'status', '`status`', '`status`', 3, 10, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_totalgajitusmk`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_totalgajitusmklist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_totalgajitusmkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_totalgajitusmkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_totalgajitusmkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_totalgajitusmkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_totalgajitusmkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_totalgajitusmkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_totalgajitusmkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajitusmkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajitusmkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_totalgajitusmkdelete.php", $this->getUrlParm());
	}
