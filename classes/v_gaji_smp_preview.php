 ...
 * Page class
 */
class v_gaji_smp_preview extends v_gaji_smp
{
	...
	// Page object name
	public $PageObjName = "v_gaji_smp_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gaji_smp');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_m_smp") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_m_smp&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gaji_smplist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
