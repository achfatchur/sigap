...
class test_pdf
{
	...
	// Table name
	public $TableName = 'test_pdf.php';

	// Page object name
	public $PageObjName = "test_pdf";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'test_pdf.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "test_pdf", $url, "", "test_pdf", TRUE);
		$this->Heading = $Language->TablePhrase("test_pdf", "TblCaption"); 
	}
} // End class
?>