 ...
 * Page class
 */
class absen_detil_delete extends absen_detil
{
	...
	// Page object name
	public $PageObjName = "absen_detil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("absen_detillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("absen_detillist.php"); // Return to list
			}
		}
	}
