 ...
 * Page class
 */
class gajisma_detil_grid extends gajisma_detil
{
	...
	// Page object name
	public $PageObjName = "gajisma_detil_grid";

	// Grid form hidden field names
	public $FormName = "fgajisma_detilgrid";
...
// Render list options (extended codes)
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'gajisma_detil'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_gajisma();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "gajisma") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["gajisma"]->EventCancelled)
