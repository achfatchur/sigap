 ...
 * Page class
 */
class m_iuran_hari_tua_delete extends m_iuran_hari_tua
{
	...
	// Page object name
	public $PageObjName = "m_iuran_hari_tua_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_iuran_hari_tualist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_iuran_hari_tualist.php"); // Return to list
			}
		}
	}
