 ...
 */
class peg_skill extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('peg_skill', 'peg_skill', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('peg_skill', 'peg_skill', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pid->Sortable = TRUE; // Allow sort
		$this->pid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pid'] = &$this->pid;

		// keahlian
		$this->keahlian = new DbField('peg_skill', 'peg_skill', 'x_keahlian', 'keahlian', '`keahlian`', '`keahlian`', 200, 255, -1, FALSE, '`keahlian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keahlian->Sortable = TRUE; // Allow sort
		$this->fields['keahlian'] = &$this->keahlian;

		// tingkat
		$this->tingkat = new DbField('peg_skill', 'peg_skill', 'x_tingkat', 'tingkat', '`tingkat`', '`tingkat`', 200, 255, -1, FALSE, '`tingkat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tingkat->Sortable = TRUE; // Allow sort
		$this->fields['tingkat'] = &$this->tingkat;

		// bukti
		$this->bukti = new DbField('peg_skill', 'peg_skill', 'x_bukti', 'bukti', '`bukti`', '`bukti`', 200, 255, -1, FALSE, '`bukti`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bukti->Sortable = TRUE; // Allow sort
		$this->fields['bukti'] = &$this->bukti;

		// keterangan
		$this->keterangan = new DbField('peg_skill', 'peg_skill', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// c_date
		$this->c_date = new DbField('peg_skill', 'peg_skill', 'x_c_date', 'c_date', '`c_date`', CastDateFieldForLike("`c_date`", 0, "DB"), 135, 19, 0, FALSE, '`c_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// u_date
		$this->u_date = new DbField('peg_skill', 'peg_skill', 'x_u_date', 'u_date', '`u_date`', CastDateFieldForLike("`u_date`", 0, "DB"), 135, 19, 0, FALSE, '`u_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// c_by
		$this->c_by = new DbField('peg_skill', 'peg_skill', 'x_c_by', 'c_by', '`c_by`', '`c_by`', 3, 11, -1, FALSE, '`c_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// u_by
		$this->u_by = new DbField('peg_skill', 'peg_skill', 'x_u_by', 'u_by', '`u_by`', '`u_by`', 3, 11, -1, FALSE, '`u_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "peg_skillview.php")
			return $Language->phrase("View");
		elseif ($pageName == "peg_skilledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "peg_skilladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("peg_skillview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("peg_skillview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "peg_skilladd.php?" . $this->getUrlParm($parm);
		else
			$url = "peg_skilladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("peg_skilledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("peg_skilladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("peg_skilldelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->keahlian->setDbValue($rs->fields('keahlian'));
		$this->tingkat->setDbValue($rs->fields('tingkat'));
		$this->bukti->setDbValue($rs->fields('bukti'));
	...
	public function renderEditRow()
	{
		...
		$this->bukti->EditValue = $this->bukti->CurrentValue;
