 ...
 * Page class
 */
class m_jaminan_pensiun_delete extends m_jaminan_pensiun
{
	...
	// Page object name
	public $PageObjName = "m_jaminan_pensiun_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_jaminan_pensiunlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_jaminan_pensiunlist.php"); // Return to list
			}
		}
	}
