...
class pegawai extends DbTable
{
	...
	public function __construct()
	{
		...
		// status_peg
		$this->status_peg = new DbField('pegawai', 'pegawai', 'x_status_peg', 'status_peg', '`status_peg`', '`status_peg`', 3, 11, -1, FALSE, '`status_peg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mulai_bekerja
		$this->mulai_bekerja = new DbField('pegawai', 'pegawai', 'x_mulai_bekerja', 'mulai_bekerja', '`mulai_bekerja`', '`mulai_bekerja`', 18, 4, -1, FALSE, '`mulai_bekerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('pegawai', 'pegawai', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
