 ...
 * Page class
 */
class m_lembur_delete extends m_lembur
{
	...
	// Page object name
	public $PageObjName = "m_lembur_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_lemburlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_lemburlist.php"); // Return to list
			}
		}
	}
