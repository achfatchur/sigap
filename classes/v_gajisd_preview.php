 ...
 * Page class
 */
class v_gajisd_preview extends v_gajisd
{
	...
	// Page object name
	public $PageObjName = "v_gajisd_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gajisd');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_m_sd") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_m_sd&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gajisdlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
