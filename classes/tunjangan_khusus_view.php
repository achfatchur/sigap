 ...
 * Page class
 */
class tunjangan_khusus_view extends tunjangan_khusus
{
	...
	// Page object name
	public $PageObjName = "tunjangan_khusus_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tunjangan_khususlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tunjangan_khususlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tunjangan_khususlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
