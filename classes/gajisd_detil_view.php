 ...
 * Page class
 */
class gajisd_detil_view extends gajisd_detil
{
	...
	// Page object name
	public $PageObjName = "gajisd_detil_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gajisd_detillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gajisd_detillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gajisd_detillist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
