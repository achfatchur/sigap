 ...
 * Page class
 */
class m_tu_smp_edit extends m_tu_smp
{
	...
	// Page object name
	public $PageObjName = "m_tu_smp_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tu_smp", $detailTblVar) && $GLOBALS["gaji_tu_smp"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tu_smp", $detailTblVar) && $GLOBALS["gaji_tu_smp"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tu_smp_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tu_smp", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tu_smp_grid"]->DetailEdit) {
					$GLOBALS["gaji_tu_smp_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tu_smp_grid"]->CurrentAction = "gridedit";
