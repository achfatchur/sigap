 ...
 * Page class
 */
class gaji_karyawan_sma_view extends gaji_karyawan_sma
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_sma_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gaji_karyawan_smalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gaji_karyawan_smalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gaji_karyawan_smalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
