 ...
 * Page class
 */
class m_penyesuaian_edit extends m_penyesuaian
{
	...
	// Page object name
	public $PageObjName = "m_penyesuaian_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("penyesuaian", $detailTblVar) && $GLOBALS["penyesuaian"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("penyesuaian", $detailTblVar) && $GLOBALS["penyesuaian"]->DetailEdit) {
						...
						$editRow = $GLOBALS["penyesuaian_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("penyesuaian", $detailTblVar)) {
				...
				if ($GLOBALS["penyesuaian_grid"]->DetailEdit) {
					$GLOBALS["penyesuaian_grid"]->CurrentMode = "edit";
					$GLOBALS["penyesuaian_grid"]->CurrentAction = "gridedit";
