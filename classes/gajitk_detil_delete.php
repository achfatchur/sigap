 ...
 * Page class
 */
class gajitk_detil_delete extends gajitk_detil
{
	...
	// Page object name
	public $PageObjName = "gajitk_detil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajitk_detillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajitk_detillist.php"); // Return to list
			}
		}
	}
