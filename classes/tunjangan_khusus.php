...
/**
 * Table class for tunjangan_khusus
 */
class tunjangan_khusus extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tunjangan_khusus';
		$this->TableName = 'tunjangan_khusus';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tunjangan_khusus`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('tunjangan_khusus', 'tunjangan_khusus', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// unit
		$this->unit = new DbField('tunjangan_khusus', 'tunjangan_khusus', 'x_unit', 'unit', '`unit`', '`unit`', 3, 11, -1, FALSE, '`unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan
		$this->jabatan = new DbField('tunjangan_khusus', 'tunjangan_khusus', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->jabatan->Lookup = new Lookup('jabatan', 'jenis_jabatan', FALSE, 'id', ["name","","",""], [], [], [], [], [], [], '', '');
		$this->jabatan->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jabatan'] = &$this->jabatan;

		// value
		$this->value = new DbField('tunjangan_khusus', 'tunjangan_khusus', 'x_value', 'value', '`value`', '`value`', 20, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`tunjangan_khusus`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "tunjangan_khususlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "tunjangan_khususview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tunjangan_khususedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tunjangan_khususadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("tunjangan_khususview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tunjangan_khususview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "tunjangan_khususadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tunjangan_khususadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tunjangan_khususedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tunjangan_khususadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tunjangan_khususdelete.php", $this->getUrlParm());
	}
