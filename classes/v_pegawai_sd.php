...
/**
 * Table class for v_pegawai_sd
 */
class v_pegawai_sd extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_pegawai_sd';
		$this->TableName = 'v_pegawai_sd';
		$this->TableType = 'VIEW';
		...
		// id
		$this->id = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pid->Sortable = TRUE; // Allow sort
		$this->pid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pid'] = &$this->pid;

		// nip
		$this->nip = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_nip', 'nip', '`nip`', '`nip`', 200, 50, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_password', 'password', '`password`', '`password`', 200, 255, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// jenjang_id
		$this->jenjang_id = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan
		$this->jabatan = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// periode_jabatan
		$this->periode_jabatan = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_periode_jabatan', 'periode_jabatan', '`periode_jabatan`', '`periode_jabatan`', 3, 11, -1, FALSE, '`periode_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status_peg
		$this->status_peg = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_status_peg', 'status_peg', '`status_peg`', '`status_peg`', 3, 11, -1, FALSE, '`status_peg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// type
		$this->type = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_type', 'type', '`type`', '`type`', 3, 11, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sertif
		$this->sertif = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_sertif', 'sertif', '`sertif`', '`sertif`', 3, 11, -1, FALSE, '`sertif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tambahan
		$this->tambahan = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// alamat
		$this->alamat = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 255, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// email
		$this->_email = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// wa
		$this->wa = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_wa', 'wa', '`wa`', '`wa`', 200, 255, -1, FALSE, '`wa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->wa->Sortable = TRUE; // Allow sort
		$this->fields['wa'] = &$this->wa;

		// hp
		$this->hp = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_hp', 'hp', '`hp`', '`hp`', 200, 255, -1, FALSE, '`hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hp->Sortable = TRUE; // Allow sort
		$this->fields['hp'] = &$this->hp;

		// tgllahir
		$this->tgllahir = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_tgllahir', 'tgllahir', '`tgllahir`', CastDateFieldForLike("`tgllahir`", 0, "DB"), 133, 10, 0, FALSE, '`tgllahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rekbank
		$this->rekbank = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_rekbank', 'rekbank', '`rekbank`', '`rekbank`', 200, 255, -1, FALSE, '`rekbank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekbank->Sortable = TRUE; // Allow sort
		$this->fields['rekbank'] = &$this->rekbank;

		// pendidikan
		$this->pendidikan = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_pendidikan', 'pendidikan', '`pendidikan`', '`pendidikan`', 3, 11, -1, FALSE, '`pendidikan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jurusan
		$this->jurusan = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_jurusan', 'jurusan', '`jurusan`', '`jurusan`', 200, 50, -1, FALSE, '`jurusan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jurusan->Sortable = TRUE; // Allow sort
		$this->fields['jurusan'] = &$this->jurusan;

		// agama
		$this->agama = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_agama', 'agama', '`agama`', '`agama`', 200, 20, -1, FALSE, '`agama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenkel
		$this->jenkel = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_jenkel', 'jenkel', '`jenkel`', '`jenkel`', 200, 20, -1, FALSE, '`jenkel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// mulai_bekerja
		$this->mulai_bekerja = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_mulai_bekerja', 'mulai_bekerja', '`mulai_bekerja`', '`mulai_bekerja`', 18, 4, -1, FALSE, '`mulai_bekerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// level
		$this->level = new DbField('v_pegawai_sd', 'v_pegawai_sd', 'x_level', 'level', '`level`', '`level`', 3, 11, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_pegawai_sd`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_pegawai_sdview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_pegawai_sdedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_pegawai_sdadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_pegawai_sdview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_pegawai_sdview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_pegawai_sdadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_pegawai_sdadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pegawai_sdedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pegawai_sdadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_pegawai_sddelete.php", $this->getUrlParm());
	}
