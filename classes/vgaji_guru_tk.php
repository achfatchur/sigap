...
/**
 * Table class for vgaji_guru_tk
 */
class vgaji_guru_tk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vgaji_guru_tk';
		$this->TableName = 'vgaji_guru_tk';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vgaji_guru_tk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pid->Sortable = TRUE; // Allow sort
		$this->pid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pid'] = &$this->pid;

		// tahun
		$this->tahun = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 18, 4, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// pegawai
		$this->pegawai = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rekbank
		$this->rekbank = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_rekbank', 'rekbank', '`rekbank`', '`rekbank`', 200, 255, -1, FALSE, '`rekbank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekbank->Sortable = TRUE; // Allow sort
		$this->fields['rekbank'] = &$this->rekbank;

		// jenjang_id
		$this->jenjang_id = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 10, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_type', 'type', '`type`', '`type`', 3, 11, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_guru
		$this->jenis_guru = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_jenis_guru', 'jenis_guru', '`jenis_guru`', '`jenis_guru`', 3, 11, -1, FALSE, '`jenis_guru`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tambahan
		$this->tambahan = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// periode
		$this->periode = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_periode', 'periode', '`periode`', '`periode`', 3, 11, -1, FALSE, '`periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->periode->Sortable = TRUE; // Allow sort
		$this->periode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['periode'] = &$this->periode;

		// tunjangan_periode
		$this->tunjangan_periode = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_tunjangan_periode', 'tunjangan_periode', '`tunjangan_periode`', '`tunjangan_periode`', 20, 20, -1, FALSE, '`tunjangan_periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 10, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 20, 20, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lembur
		$this->lembur = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_lembur', 'lembur', '`lembur`', '`lembur`', 3, 10, -1, FALSE, '`lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_lembur
		$this->value_lembur = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_value_lembur', 'value_lembur', '`value_lembur`', '`value_lembur`', 20, 19, -1, FALSE, '`value_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jp->Sortable = TRUE; // Allow sort
		$this->jp->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jp'] = &$this->jp;

		// gapok
		$this->gapok = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 19, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_gapok
		$this->total_gapok = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_total_gapok', 'total_gapok', '`total_gapok`', '`total_gapok`', 20, 20, -1, FALSE, '`total_gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 19, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 19, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// piket_count
		$this->piket_count = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_piket_count', 'piket_count', '`piket_count`', '`piket_count`', 3, 10, -1, FALSE, '`piket_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_piket
		$this->value_piket = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_value_piket', 'value_piket', '`value_piket`', '`value_piket`', 20, 19, -1, FALSE, '`value_piket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tugastambahan
		$this->tugastambahan = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_tugastambahan', 'tugastambahan', '`tugastambahan`', '`tugastambahan`', 20, 19, -1, FALSE, '`tugastambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tj_jabatan
		$this->tj_jabatan = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_tj_jabatan', 'tj_jabatan', '`tj_jabatan`', '`tj_jabatan`', 20, 19, -1, FALSE, '`tj_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 19, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan
		$this->potongan = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_potongan', 'potongan', '`potongan`', '`potongan`', 20, 19, -1, FALSE, '`potongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// penyesuaian
		$this->penyesuaian = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_penyesuaian', 'penyesuaian', '`penyesuaian`', '`penyesuaian`', 20, 19, -1, FALSE, '`penyesuaian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 20, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_total', 'total', '`total`', '`total`', 20, 19, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// voucher
		$this->voucher = new DbField('vgaji_guru_tk', 'vgaji_guru_tk', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 20, 20, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vgaji_guru_tk`";
	}
	...
	{
		global $Language;
		if ($pageName == "vgaji_guru_tkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vgaji_guru_tkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vgaji_guru_tkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vgaji_guru_tkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vgaji_guru_tkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vgaji_guru_tkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vgaji_guru_tkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_guru_tkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_guru_tkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vgaji_guru_tkdelete.php", $this->getUrlParm());
	}
