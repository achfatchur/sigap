...
class custom_file
{
	...
	// Table name
	public $TableName = 'custom_file.php';

	// Page object name
	public $PageObjName = "custom_file";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'custom_file.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "custom_file", $url, "", "custom_file", TRUE);
		$this->Heading = $Language->TablePhrase("custom_file", "TblCaption"); 
	}
} // End class
?>