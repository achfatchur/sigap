 ...
 * Page class
 */
class absen_detil_grid extends absen_detil
{
	...
	// Page object name
	public $PageObjName = "absen_detil_grid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_pegawai") && $CurrentForm->hasValue("o_pegawai") && $this->pegawai->CurrentValue != $this->pegawai->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_jenjang") && $CurrentForm->hasValue("o_jenjang") && $this->jenjang->CurrentValue != $this->jenjang->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_jenjang"))
			$this->jenjang->setOldValue($CurrentForm->getValue("o_jenjang"));
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "absen") {
			...
			if ($GLOBALS["absen"]->EventCancelled)
