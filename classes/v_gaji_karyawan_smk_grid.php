 ...
 * Page class
 */
class v_gaji_karyawan_smk_grid extends v_gaji_karyawan_smk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_karyawan_smk_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_karyawan_smkgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_pegawai") && $CurrentForm->hasValue("o_pegawai") && $this->pegawai->CurrentValue != $this->pegawai->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_rekbank") && $CurrentForm->hasValue("o_rekbank") && $this->rekbank->CurrentValue != $this->rekbank->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_rekbank"))
			$this->rekbank->setOldValue($CurrentForm->getValue("o_rekbank"));
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_karyawan_smk'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_karyawan_smk();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_karyawan_smk"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_karyawan_smk", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_karyawan_smk'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_karyawan_smk();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_karyawan_smk") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_karyawan_smk"]->EventCancelled)
