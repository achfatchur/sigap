 ...
 * Page class
 */
class m_pulangcepat_edit extends m_pulangcepat
{
	...
	// Page object name
	public $PageObjName = "m_pulangcepat_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// perjam
			$this->perjam->setDbValueDef($rsnew, $this->perjam->CurrentValue, NULL, $this->perjam->ReadOnly);

			// perhari
			$this->perhari->setDbValueDef($rsnew, $this->perhari->CurrentValue, NULL, $this->perhari->ReadOnly);
