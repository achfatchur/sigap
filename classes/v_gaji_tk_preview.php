 ...
 * Page class
 */
class v_gaji_tk_preview extends v_gaji_tk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tk_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gaji_tk');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_m_tk") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_m_tk&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gaji_tklist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
