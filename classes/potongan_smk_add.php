 ...
 * Page class
 */
class potongan_smk_add extends potongan_smk
{
	...
	// Page object name
	public $PageObjName = "potongan_smk_add";
	...
	public function run()
	{
		...
		$this->terlambat->Visible = FALSE;
		$this->value_terlambat->Visible = FALSE;
		$this->izin->Visible = FALSE;
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "potongan_smkview.php")
