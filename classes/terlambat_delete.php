 ...
 * Page class
 */
class terlambat_delete extends terlambat
{
	...
	// Page object name
	public $PageObjName = "terlambat_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("terlambatlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("terlambatlist.php"); // Return to list
			}
		}
	}
