 ...
 * Page class
 */
class gajismk_detil_preview extends gajismk_detil
{
	...
	// Page object name
	public $PageObjName = "gajismk_detil_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'gajismk_detil');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "gajismk") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=gajismk&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
