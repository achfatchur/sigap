 ...
 * Page class
 */
class v_pegawai_sma_delete extends v_pegawai_sma
{
	...
	// Page object name
	public $PageObjName = "v_pegawai_sma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pegawai_smalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pegawai_smalist.php"); // Return to list
			}
		}
	}
