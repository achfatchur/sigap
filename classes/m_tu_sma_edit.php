 ...
 * Page class
 */
class m_tu_sma_edit extends m_tu_sma
{
	...
	// Page object name
	public $PageObjName = "m_tu_sma_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tu_sma", $detailTblVar) && $GLOBALS["gaji_tu_sma"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tu_sma", $detailTblVar) && $GLOBALS["gaji_tu_sma"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tu_sma_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tu_sma", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tu_sma_grid"]->DetailEdit) {
					$GLOBALS["gaji_tu_sma_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tu_sma_grid"]->CurrentAction = "gridedit";
