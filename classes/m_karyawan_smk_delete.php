 ...
 * Page class
 */
class m_karyawan_smk_delete extends m_karyawan_smk
{
	...
	// Page object name
	public $PageObjName = "m_karyawan_smk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_karyawan_smklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_karyawan_smklist.php"); // Return to list
			}
		}
	}
