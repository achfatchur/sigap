 ...
 * Page class
 */
class gaji_karyawan_smp_grid extends gaji_karyawan_smp
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_smp_grid";

	// Grid form hidden field names
	public $FormName = "fgaji_karyawan_smpgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_karyawan_smp") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["m_karyawan_smp"]->EventCancelled)
