 ...
 * Page class
 */
class potongan_sma_delete extends potongan_sma
{
	...
	// Page object name
	public $PageObjName = "potongan_sma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("potongan_smalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("potongan_smalist.php"); // Return to list
			}
		}
	}
