 ...
 * Page class
 */
class gaji_sma_grid extends gaji_sma
{
	...
	// Page object name
	public $PageObjName = "gaji_sma_grid";

	// Grid form hidden field names
	public $FormName = "fgaji_smagrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'm_sma'
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_sma") {
			$this->bulan->Visible = FALSE;
			if ($GLOBALS["m_sma"]->EventCancelled)
