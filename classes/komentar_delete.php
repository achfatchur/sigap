 ...
 * Page class
 */
class komentar_delete extends komentar
{
	...
	// Page object name
	public $PageObjName = "komentar_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("komentarlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("komentarlist.php"); // Return to list
			}
		}
	}
