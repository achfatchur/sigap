 ...
 * Page class
 */
class tunjangan_khusus_delete extends tunjangan_khusus
{
	...
	// Page object name
	public $PageObjName = "tunjangan_khusus_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tunjangan_khususlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tunjangan_khususlist.php"); // Return to list
			}
		}
	}
