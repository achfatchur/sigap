...
/**
 * Table class for gajitk_detil
 */
class gajitk_detil extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gajitk_detil';
		$this->TableName = 'gajitk_detil';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gajitk_detil`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gajitk_detil', 'gajitk_detil', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('gajitk_detil', 'gajitk_detil', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai_id
		$this->pegawai_id = new DbField('gajitk_detil', 'gajitk_detil', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 3, 11, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->pegawai_id->Lookup = new Lookup('pegawai_id', 'pegawai', FALSE, 'id', ["nama","","",""], [], [], [], [], ["jabatan"], ["x_jabatan_id"], '', '');
		$this->pegawai_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pegawai_id'] = &$this->pegawai_id;

		// jabatan_id
		$this->jabatan_id = new DbField('gajitk_detil', 'gajitk_detil', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->jabatan_id->Sortable = TRUE; // Allow sort
		$this->jabatan_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->jabatan_id->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		...
		// masakerja
		$this->masakerja = new DbField('gajitk_detil', 'gajitk_detil', 'x_masakerja', 'masakerja', '`masakerja`', '`masakerja`', 2, 6, -1, FALSE, '`masakerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumngajar
		$this->jumngajar = new DbField('gajitk_detil', 'gajitk_detil', 'x_jumngajar', 'jumngajar', '`jumngajar`', '`jumngajar`', 2, 6, -1, FALSE, '`jumngajar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ijin
		$this->ijin = new DbField('gajitk_detil', 'gajitk_detil', 'x_ijin', 'ijin', '`ijin`', '`ijin`', 2, 6, -1, FALSE, '`ijin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// voucher
		$this->voucher = new DbField('gajitk_detil', 'gajitk_detil', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 3, 11, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tunjangan_khusus
		$this->tunjangan_khusus = new DbField('gajitk_detil', 'gajitk_detil', 'x_tunjangan_khusus', 'tunjangan_khusus', '`tunjangan_khusus`', '`tunjangan_khusus`', 3, 11, -1, FALSE, '`tunjangan_khusus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tunjangan_jabatan
		$this->tunjangan_jabatan = new DbField('gajitk_detil', 'gajitk_detil', 'x_tunjangan_jabatan', 'tunjangan_jabatan', '`tunjangan_jabatan`', '`tunjangan_jabatan`', 3, 11, -1, FALSE, '`tunjangan_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// baku
		$this->baku = new DbField('gajitk_detil', 'gajitk_detil', 'x_baku', 'baku', '`baku`', '`baku`', 3, 11, -1, FALSE, '`baku`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('gajitk_detil', 'gajitk_detil', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// prestasi
		$this->prestasi = new DbField('gajitk_detil', 'gajitk_detil', 'x_prestasi', 'prestasi', '`prestasi`', '`prestasi`', 3, 11, -1, FALSE, '`prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlahgaji
		$this->jumlahgaji = new DbField('gajitk_detil', 'gajitk_detil', 'x_jumlahgaji', 'jumlahgaji', '`jumlahgaji`', '`jumlahgaji`', 3, 11, -1, FALSE, '`jumlahgaji`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumgajitotal
		$this->jumgajitotal = new DbField('gajitk_detil', 'gajitk_detil', 'x_jumgajitotal', 'jumgajitotal', '`jumgajitotal`', '`jumgajitotal`', 3, 11, -1, FALSE, '`jumgajitotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan1
		$this->potongan1 = new DbField('gajitk_detil', 'gajitk_detil', 'x_potongan1', 'potongan1', '`potongan1`', '`potongan1`', 3, 11, -1, FALSE, '`potongan1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan2
		$this->potongan2 = new DbField('gajitk_detil', 'gajitk_detil', 'x_potongan2', 'potongan2', '`potongan2`', '`potongan2`', 3, 11, -1, FALSE, '`potongan2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlahterima
		$this->jumlahterima = new DbField('gajitk_detil', 'gajitk_detil', 'x_jumlahterima', 'jumlahterima', '`jumlahterima`', '`jumlahterima`', 3, 11, -1, FALSE, '`jumlahterima`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gajitk_detil', 'gajitk_detil', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	public function sqlMasterFilter_gajitk()
	{
		return "`id`=@id@";
	}

	// Detail filter
	public function sqlDetailFilter_gajitk()
	{
		return "`pid`=@pid@";
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gajitk_detil`";
	}
	...
	{
		global $Language;
		if ($pageName == "gajitk_detilview.php")
			return $Language->phrase("View");
		elseif ($pageName == "gajitk_detiledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gajitk_detiladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gajitk_detilview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gajitk_detilview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gajitk_detiladd.php?" . $this->getUrlParm($parm);
		else
			$url = "gajitk_detiladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gajitk_detiledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gajitk_detiladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gajitk_detildelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "gajitk" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
