 ...
 * Page class
 */
class m_reward_view extends m_reward
{
	...
	// Page object name
	public $PageObjName = "m_reward_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_rewardlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_rewardlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_rewardlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
