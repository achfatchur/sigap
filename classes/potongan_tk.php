...
class potongan_tk extends DbTable
{
	...
	public function __construct()
	{
		...
		// tahun
		$this->tahun = new DbField('potongan_tk', 'potongan_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('potongan_tk', 'potongan_tk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 11, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('potongan_tk', 'potongan_tk', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->nama->Lookup = new Lookup('nama', 'pegawai', FALSE, 'nip', ["nama","","",""], [], [], [], [], ["jabatan","jenjang_id","sertif"], ["x_jenjang_id","x_jabatan_id","x_sertif"], '', '');
		...
		// sertif
		$this->sertif = new DbField('potongan_tk', 'potongan_tk', 'x_sertif', 'sertif', '`sertif`', '`sertif`', 3, 11, -1, FALSE, '`sertif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_tidakhadir
		$this->value_tidakhadir = new DbField('potongan_tk', 'potongan_tk', 'x_value_tidakhadir', 'value_tidakhadir', '`value_tidakhadir`', '`value_tidakhadir`', 20, 19, -1, FALSE, '`value_tidakhadir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		...
		// pid
		$this->pid = new DbField('potongan_tk', 'potongan_tk', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	public function sqlMasterFilter_m_potongan()
	{
		return "`id`=@id@ AND `bulan`=@bulan@ AND `tahun`=@tahun@";
	}

	// Detail filter
	public function sqlDetailFilter_m_potongan()
	{
	...
	{
		if ($this->getCurrentMasterTable() == "m_potongan" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
	...
	public function renderListRow()
	{
		...
		// value_tidakhadir
		$this->value_tidakhadir->ViewValue = $Language->phrase("PasswordMask");
