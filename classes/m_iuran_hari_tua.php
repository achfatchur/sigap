...
/**
 * Table class for m_iuran_hari_tua
 */
class m_iuran_hari_tua extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'm_iuran_hari_tua';
		$this->TableName = 'm_iuran_hari_tua';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_iuran_hari_tua`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('m_iuran_hari_tua', 'm_iuran_hari_tua', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// unit
		$this->unit = new DbField('m_iuran_hari_tua', 'm_iuran_hari_tua', 'x_unit', 'unit', '`unit`', '`unit`', 3, 11, -1, FALSE, '`unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// value
		$this->value = new DbField('m_iuran_hari_tua', 'm_iuran_hari_tua', 'x_value', 'value', '`value`', '`value`', 131, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_iuran_hari_tua`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "m_iuran_hari_tualist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "m_iuran_hari_tuaview.php")
			return $Language->phrase("View");
		elseif ($pageName == "m_iuran_hari_tuaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "m_iuran_hari_tuaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("m_iuran_hari_tuaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("m_iuran_hari_tuaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "m_iuran_hari_tuaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "m_iuran_hari_tuaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_iuran_hari_tuaedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_iuran_hari_tuaadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("m_iuran_hari_tuadelete.php", $this->getUrlParm());
	}
