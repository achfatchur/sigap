 ...
 * Page class
 */
class v_pengurus_yayasan_delete extends v_pengurus_yayasan
{
	...
	// Page object name
	public $PageObjName = "v_pengurus_yayasan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pengurus_yayasanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pengurus_yayasanlist.php"); // Return to list
			}
		}
	}
