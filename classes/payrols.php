...
class payrols
{
	...
	// Table name
	public $TableName = 'payrols.php';

	// Page object name
	public $PageObjName = "payrols";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'payrols.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "payrols", $url, "", "payrols", TRUE);
		$this->Heading = $Language->TablePhrase("payrols", "TblCaption"); 
	}
} // End class
?>