 ...
 * Page class
 */
class m_reward_edit extends m_reward
{
	...
	// Page object name
	public $PageObjName = "m_reward_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// min_jmlh_masuk
			$this->min_jmlh_masuk->setDbValueDef($rsnew, $this->min_jmlh_masuk->CurrentValue, NULL, $this->min_jmlh_masuk->ReadOnly);
