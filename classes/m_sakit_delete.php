 ...
 * Page class
 */
class m_sakit_delete extends m_sakit
{
	...
	// Page object name
	public $PageObjName = "m_sakit_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_sakitlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_sakitlist.php"); // Return to list
			}
		}
	}
