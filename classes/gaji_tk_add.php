 ...
 * Page class
 */
class gaji_tk_add extends gaji_tk
{
	...
	// Page object name
	public $PageObjName = "gaji_tk_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "gaji_tkview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'gaji_tk'
