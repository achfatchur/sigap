 ...
 * Page class
 */
class m_semeter_view extends m_semeter
{
	...
	// Page object name
	public $PageObjName = "m_semeter_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_semeterlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_semeterlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_semeterlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
