 ...
 * Page class
 */
class v_gaji_tu_sma_preview extends v_gaji_tu_sma
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_sma_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gaji_tu_sma');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_tu_sma") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_tu_sma&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gaji_tu_smalist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
