 ...
 * Page class
 */
class m_tu_sd_edit extends m_tu_sd
{
	...
	// Page object name
	public $PageObjName = "m_tu_sd_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tu_sd", $detailTblVar) && $GLOBALS["gaji_tu_sd"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tu_sd", $detailTblVar) && $GLOBALS["gaji_tu_sd"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tu_sd_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tu_sd", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tu_sd_grid"]->DetailEdit) {
					$GLOBALS["gaji_tu_sd_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tu_sd_grid"]->CurrentAction = "gridedit";
