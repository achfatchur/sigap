...
/**
 * Table class for gaji_pokok_tu
 */
class gaji_pokok_tu extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_pokok_tu';
		$this->TableName = 'gaji_pokok_tu';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_pokok_tu`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_pokok_tu', 'gaji_pokok_tu', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('gaji_pokok_tu', 'gaji_pokok_tu', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ijazah
		$this->ijazah = new DbField('gaji_pokok_tu', 'gaji_pokok_tu', 'x_ijazah', 'ijazah', '`ijazah`', '`ijazah`', 3, 10, -1, FALSE, '`ijazah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ijazah->Sortable = TRUE; // Allow sort
		$this->ijazah->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ijazah->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->ijazah->Lookup = new Lookup('ijazah', 'mpendidikan', FALSE, 'id', ["name","","",""], [], [], [], [], [], [], '', '');
		$this->ijazah->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ijazah'] = &$this->ijazah;

		// lama_kerja
		$this->lama_kerja = new DbField('gaji_pokok_tu', 'gaji_pokok_tu', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 10, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value
		$this->value = new DbField('gaji_pokok_tu', 'gaji_pokok_tu', 'x_value', 'value', '`value`', '`value`', 20, 19, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_pokok_tu`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "gaji_pokok_tuedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_pokok_tuadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_pokok_tuview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_pokok_tuview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_pokok_tuadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_pokok_tuadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokok_tuedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokok_tuadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_pokok_tudelete.php", $this->getUrlParm());
	}
