 ...
 * Page class
 */
class m_tu_smk_edit extends m_tu_smk
{
	...
	// Page object name
	public $PageObjName = "m_tu_smk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tu_smk", $detailTblVar) && $GLOBALS["gaji_tu_smk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tu_smk", $detailTblVar) && $GLOBALS["gaji_tu_smk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tu_smk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tu_smk", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tu_smk_grid"]->DetailEdit) {
					$GLOBALS["gaji_tu_smk_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tu_smk_grid"]->CurrentAction = "gridedit";
