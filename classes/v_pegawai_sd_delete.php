 ...
 * Page class
 */
class v_pegawai_sd_delete extends v_pegawai_sd
{
	...
	// Page object name
	public $PageObjName = "v_pegawai_sd_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pegawai_sdlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pegawai_sdlist.php"); // Return to list
			}
		}
	}
