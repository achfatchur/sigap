 ...
 * Page class
 */
class m_penyesuaian_delete extends m_penyesuaian
{
	...
	// Page object name
	public $PageObjName = "m_penyesuaian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_penyesuaianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_penyesuaianlist.php"); // Return to list
			}
		}
	}
