 ...
 * Page class
 */
class potongan_smp_delete extends potongan_smp
{
	...
	// Page object name
	public $PageObjName = "potongan_smp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("potongan_smplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("potongan_smplist.php"); // Return to list
			}
		}
	}
