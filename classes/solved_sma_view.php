 ...
 * Page class
 */
class solved_sma_view extends solved_sma
{
	...
	// Page object name
	public $PageObjName = "solved_sma_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_smalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_smalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_smalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
