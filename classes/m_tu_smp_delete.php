 ...
 * Page class
 */
class m_tu_smp_delete extends m_tu_smp
{
	...
	// Page object name
	public $PageObjName = "m_tu_smp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_tu_smplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_tu_smplist.php"); // Return to list
			}
		}
	}
