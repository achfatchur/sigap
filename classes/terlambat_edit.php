 ...
 * Page class
 */
class terlambat_edit extends terlambat
{
	...
	// Page object name
	public $PageObjName = "terlambat_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// valuejam
			$this->valuejam->setDbValueDef($rsnew, $this->valuejam->CurrentValue, NULL, $this->valuejam->ReadOnly);

			// jenis_jabatan
			$this->jenis_jabatan->setDbValueDef($rsnew, $this->jenis_jabatan->CurrentValue, NULL, $this->jenis_jabatan->ReadOnly);
