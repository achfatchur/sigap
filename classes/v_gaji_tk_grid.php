 ...
 * Page class
 */
class v_gaji_tk_grid extends v_gaji_tk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tk_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_tkgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_m_tk'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_m_tk();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_m_tk"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_m_tk", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_tk'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_tk();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_m_tk") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_m_tk"]->EventCancelled)
