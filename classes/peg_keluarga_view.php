 ...
 * Page class
 */
class peg_keluarga_view extends peg_keluarga
{
	...
	// Page object name
	public $PageObjName = "peg_keluarga_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "peg_keluargalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "peg_keluargalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "peg_keluargalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
