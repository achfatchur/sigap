 ...
 * Page class
 */
class gaji_tk_delete extends gaji_tk
{
	...
	// Page object name
	public $PageObjName = "gaji_tk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_tklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_tklist.php"); // Return to list
			}
		}
	}
