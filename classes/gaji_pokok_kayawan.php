...
/**
 * Table class for gaji_pokok_kayawan
 */
class gaji_pokok_kayawan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_pokok_kayawan';
		$this->TableName = 'gaji_pokok_kayawan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_pokok_kayawan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_pokok_kayawan', 'gaji_pokok_kayawan', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('gaji_pokok_kayawan', 'gaji_pokok_kayawan', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gaji_pokok_kayawan', 'gaji_pokok_kayawan', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 20, 19, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// value
		$this->value = new DbField('gaji_pokok_kayawan', 'gaji_pokok_kayawan', 'x_value', 'value', '`value`', '`value`', 20, 19, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_pokok_kayawan`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "gaji_pokok_kayawanlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "gaji_pokok_kayawanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "gaji_pokok_kayawanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_pokok_kayawanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_pokok_kayawanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_pokok_kayawanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_pokok_kayawanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_pokok_kayawanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokok_kayawanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokok_kayawanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_pokok_kayawandelete.php", $this->getUrlParm());
	}
