 ...
 * Page class
 */
class potongan_smp_view extends potongan_smp
{
	...
	// Page object name
	public $PageObjName = "potongan_smp_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potongan_smplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potongan_smplist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potongan_smplist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
