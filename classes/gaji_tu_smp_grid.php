 ...
 * Page class
 */
class gaji_tu_smp_grid extends gaji_tu_smp
{
	...
	// Page object name
	public $PageObjName = "gaji_tu_smp_grid";

	// Grid form hidden field names
	public $FormName = "fgaji_tu_smpgrid";
...
// Render list options (extended codes)
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'gaji_tu_smp'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_m_tu_smp();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_tu_smp") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["m_tu_smp"]->EventCancelled)
