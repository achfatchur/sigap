 ...
 * Page class
 */
class m_lembur_edit extends m_lembur
{
	...
	// Page object name
	public $PageObjName = "m_lembur_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// value_perjam
			$this->value_perjam->setDbValueDef($rsnew, $this->value_perjam->CurrentValue, NULL, $this->value_perjam->ReadOnly);
