 ...
 * Page class
 */
class peg_skill_delete extends peg_skill
{
	...
	// Page object name
	public $PageObjName = "peg_skill_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("peg_skilllist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("peg_skilllist.php"); // Return to list
			}
		}
	}
