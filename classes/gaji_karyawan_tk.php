...
/**
 * Table class for gaji_karyawan_tk
 */
class gaji_karyawan_tk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_karyawan_tk';
		$this->TableName = 'gaji_karyawan_tk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_karyawan_tk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 11, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// gapok
		$this->gapok = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 20, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 20, 20, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 20, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 20, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 20, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan
		$this->potongan = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_potongan', 'potongan', '`potongan`', '`potongan`', 20, 20, -1, FALSE, '`potongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// penyesuaian
		$this->penyesuaian = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_penyesuaian', 'penyesuaian', '`penyesuaian`', '`penyesuaian`', 20, 20, -1, FALSE, '`penyesuaian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 20, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_total', 'total', '`total`', '`total`', 20, 20, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// voucher
		$this->voucher = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 3, 11, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// jaminan_pensiun
		$this->jaminan_pensiun = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_jaminan_pensiun', 'jaminan_pensiun', '`jaminan_pensiun`', '`jaminan_pensiun`', 20, 19, -1, FALSE, '`jaminan_pensiun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jaminan_hari_tua
		$this->jaminan_hari_tua = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_jaminan_hari_tua', 'jaminan_hari_tua', '`jaminan_hari_tua`', '`jaminan_hari_tua`', 20, 19, -1, FALSE, '`jaminan_hari_tua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_pph21
		$this->total_pph21 = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_total_pph21', 'total_pph21', '`total_pph21`', '`total_pph21`', 20, 19, -1, FALSE, '`total_pph21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bpjs_kesehatan
		$this->bpjs_kesehatan = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_bpjs_kesehatan', 'bpjs_kesehatan', '`bpjs_kesehatan`', '`bpjs_kesehatan`', 20, 19, -1, FALSE, '`bpjs_kesehatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status_npwp
		$this->status_npwp = new DbField('gaji_karyawan_tk', 'gaji_karyawan_tk', 'x_status_npwp', 'status_npwp', '`status_npwp`', '`status_npwp`', 3, 11, -1, FALSE, '`status_npwp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	public function sqlMasterFilter_m_karyawan_tk()
	{
		return "`id`=@id@ AND `tahun`=@tahun@ AND `bulan`=@bulan@";
	}

	// Detail filter
	public function sqlDetailFilter_m_karyawan_tk()
	{
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_karyawan_tk`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "gaji_karyawan_tklist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "gaji_karyawan_tkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "gaji_karyawan_tkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_karyawan_tkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_karyawan_tkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_karyawan_tkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_karyawan_tkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_karyawan_tkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_karyawan_tkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_karyawan_tkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_karyawan_tkdelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "m_karyawan_tk" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
	...
	if(isset($this->RowIndex)) {
		...
		if(($grid_count >= $grid_num) && is_int($grid_num) && ($grid_num >= 1)){
			$offseter = $grid_num - 1;
			$id_user = ExecuteRow("SELECT * FROM pegawai where jenjang_id ='1' AND `type`= '3' limit 1 OFFSET $offseter");
