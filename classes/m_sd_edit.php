...
class m_sd_edit extends m_sd
{
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji", $detailTblVar) && $GLOBALS["gaji"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji", $detailTblVar) && $GLOBALS["gaji"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_grid"]->DetailEdit) {
					$GLOBALS["gaji_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_grid"]->CurrentAction = "gridedit";
