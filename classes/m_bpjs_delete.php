 ...
 * Page class
 */
class m_bpjs_delete extends m_bpjs
{
	...
	// Page object name
	public $PageObjName = "m_bpjs_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_bpjslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_bpjslist.php"); // Return to list
			}
		}
	}
