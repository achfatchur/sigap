 ...
 * Page class
 */
class m_tk_delete extends m_tk
{
	...
	// Page object name
	public $PageObjName = "m_tk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_tklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_tklist.php"); // Return to list
			}
		}
	}
