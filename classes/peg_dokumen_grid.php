 ...
 * Page class
 */
class peg_dokumen_grid extends peg_dokumen
{
	...
	// Page object name
	public $PageObjName = "peg_dokumen_grid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_pid") && $CurrentForm->hasValue("o_pid") && $this->pid->CurrentValue != $this->pid->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_nama_dokumen") && $CurrentForm->hasValue("o_nama_dokumen") && $this->nama_dokumen->CurrentValue != $this->nama_dokumen->OldValue)
			return FALSE;
