 ...
 * Page class
 */
class potongan_tk_view extends potongan_tk
{
	...
	// Page object name
	public $PageObjName = "potongan_tk_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potongan_tklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potongan_tklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potongan_tklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
