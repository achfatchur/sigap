 ...
 * Page class
 */
class m_tidakhadir_view extends m_tidakhadir
{
	...
	// Page object name
	public $PageObjName = "m_tidakhadir_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_tidakhadirlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_tidakhadirlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_tidakhadirlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
