 ...
 * Page class
 */
class komentar_grid extends komentar
{
	...
	// Page object name
	public $PageObjName = "komentar_grid";

	// Grid form hidden field names
	public $FormName = "fkomentargrid";
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_pid") && $CurrentForm->hasValue("o_pid") && $this->pid->CurrentValue != $this->pid->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_gambar") && $CurrentForm->hasValue("o_gambar") && $this->gambar->CurrentValue != $this->gambar->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_video") && $CurrentForm->hasValue("o_video") && $this->video->CurrentValue != $this->video->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_gambar"))
			$this->gambar->setOldValue($CurrentForm->getValue("o_gambar"));
		...
		if ($CurrentForm->hasValue("o_video"))
			$this->video->setOldValue($CurrentForm->getValue("o_video"));
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// gambar
			$this->gambar->setDbValueDef($rsnew, $this->gambar->CurrentValue, NULL, $this->gambar->ReadOnly);
