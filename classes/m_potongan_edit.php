 ...
 * Page class
 */
class m_potongan_edit extends m_potongan
{
	...
	// Page object name
	public $PageObjName = "m_potongan_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("potongan_tk", $detailTblVar) && $GLOBALS["potongan_tk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("potongan_tk", $detailTblVar) && $GLOBALS["potongan_tk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["potongan_tk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("potongan_tk", $detailTblVar)) {
				...
				if ($GLOBALS["potongan_tk_grid"]->DetailEdit) {
					$GLOBALS["potongan_tk_grid"]->CurrentMode = "edit";
					$GLOBALS["potongan_tk_grid"]->CurrentAction = "gridedit";
