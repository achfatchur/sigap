 ...
 * Page class
 */
class semester_view extends semester
{
	...
	// Page object name
	public $PageObjName = "semester_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("semesterlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "semesterlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "semesterlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "semesterlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("semesterlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
