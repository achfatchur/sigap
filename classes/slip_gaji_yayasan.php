...
/**
 * Table class for slip_gaji_yayasan
 */
class slip_gaji_yayasan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'slip_gaji_yayasan';
		$this->TableName = 'slip_gaji_yayasan';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`slip_gaji_yayasan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('slip_gaji_yayasan', 'slip_gaji_yayasan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tahun
		$this->tahun = new DbField('slip_gaji_yayasan', 'slip_gaji_yayasan', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`slip_gaji_yayasan`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "slip_gaji_yayasanlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "slip_gaji_yayasanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "slip_gaji_yayasanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "slip_gaji_yayasanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("slip_gaji_yayasanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("slip_gaji_yayasanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "slip_gaji_yayasanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "slip_gaji_yayasanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("slip_gaji_yayasanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("slip_gaji_yayasanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("slip_gaji_yayasandelete.php", $this->getUrlParm());
	}
