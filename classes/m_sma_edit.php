 ...
 * Page class
 */
class m_sma_edit extends m_sma
{
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_sma", $detailTblVar) && $GLOBALS["gaji_sma"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_sma", $detailTblVar) && $GLOBALS["gaji_sma"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_sma_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_sma", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_sma_grid"]->DetailEdit) {
					$GLOBALS["gaji_sma_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_sma_grid"]->CurrentAction = "gridedit";
