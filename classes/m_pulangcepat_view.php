 ...
 * Page class
 */
class m_pulangcepat_view extends m_pulangcepat
{
	...
	// Page object name
	public $PageObjName = "m_pulangcepat_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_pulangcepatlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_pulangcepatlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_pulangcepatlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
