 ...
 * Page class
 */
class gaji_pokok_tu_edit extends gaji_pokok_tu
{
	...
	// Page object name
	public $PageObjName = "gaji_pokok_tu_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ijazah
			$this->ijazah->setDbValueDef($rsnew, $this->ijazah->CurrentValue, NULL, $this->ijazah->ReadOnly);
