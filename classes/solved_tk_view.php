 ...
 * Page class
 */
class solved_tk_view extends solved_tk
{
	...
	// Page object name
	public $PageObjName = "solved_tk_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_tklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_tklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_tklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
