 ...
 * Page class
 */
class gaji_pokok_kayawan_delete extends gaji_pokok_kayawan
{
	...
	// Page object name
	public $PageObjName = "gaji_pokok_kayawan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_pokok_kayawanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_pokok_kayawanlist.php"); // Return to list
			}
		}
	}
