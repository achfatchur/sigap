 ...
 * Page class
 */
class v_gaji_karyawan_smp_grid extends v_gaji_karyawan_smp
{
	...
	// Page object name
	public $PageObjName = "v_gaji_karyawan_smp_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_karyawan_smpgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_karyawan_smp") {
			...
			if ($GLOBALS["v_karyawan_smp"]->EventCancelled)
