 ...
 * Page class
 */
class v_gaji_tu_sma_grid extends v_gaji_tu_sma
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_sma_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_tu_smagrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_tu_sma") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_tu_sma"]->EventCancelled)
