...
/**
 * Table class for v_pegawai_sma
 */
class v_pegawai_sma extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_pegawai_sma';
		$this->TableName = 'v_pegawai_sma';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_pegawai_sma`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pid->Sortable = TRUE; // Allow sort
		$this->pid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pid'] = &$this->pid;

		// nip
		$this->nip = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_nip', 'nip', '`nip`', '`nip`', 200, 50, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// username
		$this->username = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_username', 'username', '`username`', '`username`', 200, 255, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->username->Sortable = FALSE; // Allow sort
		$this->fields['username'] = &$this->username;

		// password
		$this->password = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_password', 'password', '`password`', '`password`', 200, 255, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// jenjang_id
		$this->jenjang_id = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan
		$this->jabatan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// periode_jabatan
		$this->periode_jabatan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_periode_jabatan', 'periode_jabatan', '`periode_jabatan`', '`periode_jabatan`', 3, 11, -1, FALSE, '`periode_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jjm
		$this->jjm = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_jjm', 'jjm', '`jjm`', '`jjm`', 3, 10, -1, FALSE, '`jjm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jjm->Sortable = FALSE; // Allow sort
		$this->jjm->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jjm'] = &$this->jjm;

		// status_peg
		$this->status_peg = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_status_peg', 'status_peg', '`status_peg`', '`status_peg`', 3, 11, -1, FALSE, '`status_peg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->status_peg->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status_peg'] = &$this->status_peg;

		// type
		$this->type = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_type', 'type', '`type`', '`type`', 3, 11, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sertif
		$this->sertif = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_sertif', 'sertif', '`sertif`', '`sertif`', 3, 11, -1, FALSE, '`sertif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tambahan
		$this->tambahan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// alamat
		$this->alamat = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 255, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// wa
		$this->wa = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_wa', 'wa', '`wa`', '`wa`', 200, 255, -1, FALSE, '`wa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->wa->Sortable = TRUE; // Allow sort
		$this->fields['wa'] = &$this->wa;

		// email
		$this->_email = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// hp
		$this->hp = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_hp', 'hp', '`hp`', '`hp`', 200, 255, -1, FALSE, '`hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hp->Sortable = TRUE; // Allow sort
		$this->fields['hp'] = &$this->hp;

		// tgllahir
		$this->tgllahir = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_tgllahir', 'tgllahir', '`tgllahir`', CastDateFieldForLike("`tgllahir`", 0, "DB"), 133, 10, 0, FALSE, '`tgllahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rekbank
		$this->rekbank = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_rekbank', 'rekbank', '`rekbank`', '`rekbank`', 200, 255, -1, FALSE, '`rekbank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekbank->Sortable = TRUE; // Allow sort
		$this->fields['rekbank'] = &$this->rekbank;

		// pendidikan
		$this->pendidikan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_pendidikan', 'pendidikan', '`pendidikan`', '`pendidikan`', 3, 11, -1, FALSE, '`pendidikan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jurusan
		$this->jurusan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_jurusan', 'jurusan', '`jurusan`', '`jurusan`', 200, 50, -1, FALSE, '`jurusan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jurusan->Sortable = TRUE; // Allow sort
		$this->fields['jurusan'] = &$this->jurusan;

		// agama
		$this->agama = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_agama', 'agama', '`agama`', '`agama`', 200, 20, -1, FALSE, '`agama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenkel
		$this->jenkel = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_jenkel', 'jenkel', '`jenkel`', '`jenkel`', 200, 20, -1, FALSE, '`jenkel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// status
		$this->status = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_status', 'status', '`status`', '`status`', 200, 20, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = FALSE; // Allow sort
		$this->fields['status'] = &$this->status;

		// foto
		$this->foto = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_foto', 'foto', '`foto`', '`foto`', 200, 255, -1, TRUE, '`foto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->foto->Sortable = FALSE; // Allow sort
		$this->fields['foto'] = &$this->foto;

		// file_cv
		$this->file_cv = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_file_cv', 'file_cv', '`file_cv`', '`file_cv`', 200, 255, -1, TRUE, '`file_cv`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->file_cv->Sortable = FALSE; // Allow sort
		$this->fields['file_cv'] = &$this->file_cv;

		// mulai_bekerja
		$this->mulai_bekerja = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_mulai_bekerja', 'mulai_bekerja', '`mulai_bekerja`', '`mulai_bekerja`', 18, 4, -1, FALSE, '`mulai_bekerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// level
		$this->level = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_level', 'level', '`level`', '`level`', 3, 11, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// aktif
		$this->aktif = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_aktif', 'aktif', '`aktif`', '`aktif`', 16, 4, -1, FALSE, '`aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('v_pegawai_sma', 'v_pegawai_sma', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_pegawai_sma`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->status_peg->DbValue = $row['status_peg'];
	...
	{
		global $Language;
		if ($pageName == "v_pegawai_smaview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_pegawai_smaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_pegawai_smaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_pegawai_smaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_pegawai_smaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_pegawai_smaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_pegawai_smaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pegawai_smaedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pegawai_smaadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_pegawai_smadelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->status_peg->setDbValue($rs->fields('status_peg'));
	...
	public function renderEditRow()
	{
		...
		$this->jjm->EditValue = $this->jjm->CurrentValue;
		...
		$this->mulai_bekerja->EditValue = $this->mulai_bekerja->CurrentValue;
	...
	function Row_Rendering() {
		...
		$this->type->ReadOnly = TRUE;
			...
			$this->jenjang_id->CurrentValue = '4';
