 ...
 * Page class
 */
class m_smk_edit extends m_smk
{
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_smk", $detailTblVar) && $GLOBALS["gaji_smk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_smk", $detailTblVar) && $GLOBALS["gaji_smk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_smk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_smk", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_smk_grid"]->DetailEdit) {
					$GLOBALS["gaji_smk_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_smk_grid"]->CurrentAction = "gridedit";
