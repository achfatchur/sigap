 ...
 * Page class
 */
class generate_pertahun_smp_view extends generate_pertahun_smp
{
	...
	// Page object name
	public $PageObjName = "generate_pertahun_smp_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "generate_pertahun_smplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "generate_pertahun_smplist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "generate_pertahun_smplist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
