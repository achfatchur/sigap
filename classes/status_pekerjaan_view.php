 ...
 * Page class
 */
class status_pekerjaan_view extends status_pekerjaan
{
	...
	// Page object name
	public $PageObjName = "status_pekerjaan_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("status_pekerjaanlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "status_pekerjaanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "status_pekerjaanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "status_pekerjaanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("status_pekerjaanlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
