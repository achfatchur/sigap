 ...
 * Page class
 */
class reimbursh_edit extends reimbursh
{
	...
	// Page object name
	public $PageObjName = "reimbursh_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tgl_pengajuan
			$this->tgl_pengajuan->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_pengajuan->CurrentValue, 0), NULL, $this->tgl_pengajuan->ReadOnly);
			...
			// bukti1
			$this->bukti1->setDbValueDef($rsnew, $this->bukti1->CurrentValue, NULL, $this->bukti1->ReadOnly);

			// bukti2
			$this->bukti2->setDbValueDef($rsnew, $this->bukti2->CurrentValue, NULL, $this->bukti2->ReadOnly);

			// bukti3
			$this->bukti3->setDbValueDef($rsnew, $this->bukti3->CurrentValue, NULL, $this->bukti3->ReadOnly);

			// bukti4
			$this->bukti4->setDbValueDef($rsnew, $this->bukti4->CurrentValue, NULL, $this->bukti4->ReadOnly);
			...
			// tgl_pembayaran
			$this->tgl_pembayaran->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_pembayaran->CurrentValue, 0), NULL, $this->tgl_pembayaran->ReadOnly);
