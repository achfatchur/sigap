 ...
 * Page class
 */
class absen_detil_view extends absen_detil
{
	...
	// Page object name
	public $PageObjName = "absen_detil_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "absen_detillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "absen_detillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "absen_detillist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
