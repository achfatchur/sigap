 ...
 * Page class
 */
class gajismp_detil_preview extends gajismp_detil
{
	...
	// Page object name
	public $PageObjName = "gajismp_detil_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'gajismp_detil');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "gajismp") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=gajismp&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
