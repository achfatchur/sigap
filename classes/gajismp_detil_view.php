 ...
 * Page class
 */
class gajismp_detil_view extends gajismp_detil
{
	...
	// Page object name
	public $PageObjName = "gajismp_detil_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gajismp_detillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gajismp_detillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gajismp_detillist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
