...
class export_tu_sma
{
	...
	// Table name
	public $TableName = 'export_tu_sma.php';

	// Page object name
	public $PageObjName = "export_tu_sma";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'export_tu_sma.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "export_tu_sma", $url, "", "export_tu_sma", TRUE);
		$this->Heading = $Language->TablePhrase("export_tu_sma", "TblCaption"); 
	}
} // End class
?>