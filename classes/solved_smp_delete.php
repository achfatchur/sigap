 ...
 * Page class
 */
class solved_smp_delete extends solved_smp
{
	...
	// Page object name
	public $PageObjName = "solved_smp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("solved_smplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("solved_smplist.php"); // Return to list
			}
		}
	}
