 ...
 * Page class
 */
class v_pegawai_smk_delete extends v_pegawai_smk
{
	...
	// Page object name
	public $PageObjName = "v_pegawai_smk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pegawai_smklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pegawai_smklist.php"); // Return to list
			}
		}
	}
