 ...
 * Page class
 */
class tunjangan_jabatan_view extends tunjangan_jabatan
{
	...
	// Page object name
	public $PageObjName = "tunjangan_jabatan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tunjangan_jabatanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tunjangan_jabatanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tunjangan_jabatanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
