 ...
 * Page class
 */
class solved_sd_view extends solved_sd
{
	...
	// Page object name
	public $PageObjName = "solved_sd_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_sdlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_sdlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_sdlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
