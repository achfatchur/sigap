 ...
 * Page class
 */
class v_gaji_guru_smk_grid extends v_gaji_guru_smk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_guru_smk_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_guru_smkgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_m_smk'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_m_smk();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_m_smk"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_m_smk", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_guru_smk'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_smk();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_m_smk") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_m_smk"]->EventCancelled)
