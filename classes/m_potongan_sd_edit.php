 ...
 * Page class
 */
class m_potongan_sd_edit extends m_potongan_sd
{
	...
	// Page object name
	public $PageObjName = "m_potongan_sd_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("potongan_sd", $detailTblVar) && $GLOBALS["potongan_sd"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("potongan_sd", $detailTblVar) && $GLOBALS["potongan_sd"]->DetailEdit) {
						...
						$editRow = $GLOBALS["potongan_sd_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("potongan_sd", $detailTblVar)) {
				...
				if ($GLOBALS["potongan_sd_grid"]->DetailEdit) {
					$GLOBALS["potongan_sd_grid"]->CurrentMode = "edit";
					$GLOBALS["potongan_sd_grid"]->CurrentAction = "gridedit";
