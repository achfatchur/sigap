 ...
 * Page class
 */
class generate_pertahun_sd_view extends generate_pertahun_sd
{
	...
	// Page object name
	public $PageObjName = "generate_pertahun_sd_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "generate_pertahun_sdlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "generate_pertahun_sdlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "generate_pertahun_sdlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
