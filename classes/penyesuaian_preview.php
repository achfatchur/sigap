 ...
 * Page class
 */
class penyesuaian_preview extends penyesuaian
{
	...
	// Page object name
	public $PageObjName = "penyesuaian_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'penyesuaian');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "m_penyesuaian") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=m_penyesuaian&fk_id=" . urlencode(strval($this->m_id->QueryStringValue)) . "";
		}
		return $url;
	}
