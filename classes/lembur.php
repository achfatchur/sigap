...
class lembur extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('lembur', 'lembur', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pegawai
		$this->pegawai = new DbField('lembur', 'lembur', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 3, 11, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pm
		$this->pm = new DbField('lembur', 'lembur', 'x_pm', 'pm', '`pm`', '`pm`', 3, 255, -1, FALSE, '`pm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pm->Sortable = TRUE; // Allow sort
		$this->pm->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pm'] = &$this->pm;

		// proyek
		$this->proyek = new DbField('lembur', 'lembur', 'x_proyek', 'proyek', '`proyek`', '`proyek`', 200, 255, -1, FALSE, '`proyek`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->proyek->Sortable = TRUE; // Allow sort
		$this->fields['proyek'] = &$this->proyek;

		// tgl
		$this->tgl = new DbField('lembur', 'lembur', 'x_tgl', 'tgl', '`tgl`', CastDateFieldForLike("`tgl`", 0, "DB"), 135, 19, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_awal_lembur
		$this->tgl_awal_lembur = new DbField('lembur', 'lembur', 'x_tgl_awal_lembur', 'tgl_awal_lembur', '`tgl_awal_lembur`', CastDateFieldForLike("`tgl_awal_lembur`", 0, "DB"), 135, 19, 0, FALSE, '`tgl_awal_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tgl_awal_lembur->Sortable = TRUE; // Allow sort
		...
		// tgl_akhir_lembur
		$this->tgl_akhir_lembur = new DbField('lembur', 'lembur', 'x_tgl_akhir_lembur', 'tgl_akhir_lembur', '`tgl_akhir_lembur`', CastDateFieldForLike("`tgl_akhir_lembur`", 0, "DB"), 135, 19, 0, FALSE, '`tgl_akhir_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tgl_akhir_lembur->Sortable = TRUE; // Allow sort
		...
		// total_jam
		$this->total_jam = new DbField('lembur', 'lembur', 'x_total_jam', 'total_jam', '`total_jam`', '`total_jam`', 2, 6, -1, FALSE, '`total_jam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_jam->Sortable = TRUE; // Allow sort
		$this->total_jam->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total_jam'] = &$this->total_jam;

		// jenis
		$this->jenis = new DbField('lembur', 'lembur', 'x_jenis', 'jenis', '`jenis`', '`jenis`', 200, 255, -1, FALSE, '`jenis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jenis->Sortable = TRUE; // Allow sort
		$this->fields['jenis'] = &$this->jenis;

		// keterangan
		$this->keterangan = new DbField('lembur', 'lembur', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// disetujui
		$this->disetujui = new DbField('lembur', 'lembur', 'x_disetujui', 'disetujui', '`disetujui`', '`disetujui`', 200, 5, -1, FALSE, '`disetujui`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// dokumen
		$this->dokumen = new DbField('lembur', 'lembur', 'x_dokumen', 'dokumen', '`dokumen`', '`dokumen`', 200, 255, -1, TRUE, '`dokumen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "lemburedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "lemburadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("lemburview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("lemburview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "lemburadd.php?" . $this->getUrlParm($parm);
		else
			$url = "lemburadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("lemburedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("lemburadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("lemburdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->tgl_awal_lembur->setDbValue($rs->fields('tgl_awal_lembur'));
		$this->tgl_akhir_lembur->setDbValue($rs->fields('tgl_akhir_lembur'));
		$this->total_jam->setDbValue($rs->fields('total_jam'));
	...
	public function renderEditRow()
	{
		...
		$this->tgl_awal_lembur->EditValue = FormatDateTime($this->tgl_awal_lembur->CurrentValue, 8);
		...
		$this->tgl_akhir_lembur->EditValue = FormatDateTime($this->tgl_akhir_lembur->CurrentValue, 8);
