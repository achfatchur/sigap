 ...
 * Page class
 */
class gaji_tu_sd_delete extends gaji_tu_sd
{
	...
	// Page object name
	public $PageObjName = "gaji_tu_sd_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_tu_sdlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_tu_sdlist.php"); // Return to list
			}
		}
	}
