 ...
 * Page class
 */
class potongan_tk_delete extends potongan_tk
{
	...
	// Page object name
	public $PageObjName = "potongan_tk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("potongan_tklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("potongan_tklist.php"); // Return to list
			}
		}
	}
