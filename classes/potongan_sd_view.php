 ...
 * Page class
 */
class potongan_sd_view extends potongan_sd
{
	...
	// Page object name
	public $PageObjName = "potongan_sd_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potongan_sdlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potongan_sdlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potongan_sdlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
