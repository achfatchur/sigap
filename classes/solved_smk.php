...
/**
 * Table class for solved_smk
 */
class solved_smk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'solved_smk';
		$this->TableName = 'solved_smk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`solved_smk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('solved_smk', 'solved_smk', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nip
		$this->nip = new DbField('solved_smk', 'solved_smk', 'x_nip', 'nip', '`nip`', '`nip`', 200, 50, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// total_gaji
		$this->total_gaji = new DbField('solved_smk', 'solved_smk', 'x_total_gaji', 'total_gaji', '`total_gaji`', '`total_gaji`', 20, 19, -1, FALSE, '`total_gaji`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// j_pensiun
		$this->j_pensiun = new DbField('solved_smk', 'solved_smk', 'x_j_pensiun', 'j_pensiun', '`j_pensiun`', '`j_pensiun`', 20, 19, -1, FALSE, '`j_pensiun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// hari_tua
		$this->hari_tua = new DbField('solved_smk', 'solved_smk', 'x_hari_tua', 'hari_tua', '`hari_tua`', '`hari_tua`', 20, 19, -1, FALSE, '`hari_tua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pph21
		$this->pph21 = new DbField('solved_smk', 'solved_smk', 'x_pph21', 'pph21', '`pph21`', '`pph21`', 20, 19, -1, FALSE, '`pph21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// golongan_bpjs
		$this->golongan_bpjs = new DbField('solved_smk', 'solved_smk', 'x_golongan_bpjs', 'golongan_bpjs', '`golongan_bpjs`', '`golongan_bpjs`', 3, 10, -1, FALSE, '`golongan_bpjs`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// iuran_bpjs
		$this->iuran_bpjs = new DbField('solved_smk', 'solved_smk', 'x_iuran_bpjs', 'iuran_bpjs', '`iuran_bpjs`', '`iuran_bpjs`', 20, 19, -1, FALSE, '`iuran_bpjs`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('solved_smk', 'solved_smk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('solved_smk', 'solved_smk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 10, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type_peg
		$this->type_peg = new DbField('solved_smk', 'solved_smk', 'x_type_peg', 'type_peg', '`type_peg`', '`type_peg`', 3, 10, -1, FALSE, '`type_peg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit
		$this->unit = new DbField('solved_smk', 'solved_smk', 'x_unit', 'unit', '`unit`', '`unit`', 3, 10, -1, FALSE, '`unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tanggal
		$this->tanggal = new DbField('solved_smk', 'solved_smk', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 133, 10, 0, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`solved_smk`";
	}
	...
	{
		global $Language;
		if ($pageName == "solved_smkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "solved_smkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "solved_smkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("solved_smkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("solved_smkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "solved_smkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "solved_smkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("solved_smkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("solved_smkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("solved_smkdelete.php", $this->getUrlParm());
	}
