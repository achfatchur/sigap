 ...
 * Page class
 */
class solved_tk_delete extends solved_tk
{
	...
	// Page object name
	public $PageObjName = "solved_tk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("solved_tklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("solved_tklist.php"); // Return to list
			}
		}
	}
