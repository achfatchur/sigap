 ...
 * Page class
 */
class solved_smk_view extends solved_smk
{
	...
	// Page object name
	public $PageObjName = "solved_smk_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_smklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_smklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_smklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
