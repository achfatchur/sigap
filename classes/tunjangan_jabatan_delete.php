 ...
 * Page class
 */
class tunjangan_jabatan_delete extends tunjangan_jabatan
{
	...
	// Page object name
	public $PageObjName = "tunjangan_jabatan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tunjangan_jabatanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tunjangan_jabatanlist.php"); // Return to list
			}
		}
	}
