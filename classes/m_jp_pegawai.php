...
/**
 * Table class for m_jp_pegawai
 */
class m_jp_pegawai extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'm_jp_pegawai';
		$this->TableName = 'm_jp_pegawai';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`m_jp_pegawai`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('m_jp_pegawai', 'm_jp_pegawai', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('m_jp_pegawai', 'm_jp_pegawai', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kehadiran
		$this->kehadiran = new DbField('m_jp_pegawai', 'm_jp_pegawai', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jjm
		$this->jjm = new DbField('m_jp_pegawai', 'm_jp_pegawai', 'x_jjm', 'jjm', '`jjm`', '`jjm`', 3, 10, -1, FALSE, '`jjm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_jp_pegawai`";
	}
	...
	{
		global $Language;
		if ($pageName == "m_jp_pegawaiview.php")
			return $Language->phrase("View");
		elseif ($pageName == "m_jp_pegawaiedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "m_jp_pegawaiadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("m_jp_pegawaiview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("m_jp_pegawaiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "m_jp_pegawaiadd.php?" . $this->getUrlParm($parm);
		else
			$url = "m_jp_pegawaiadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_jp_pegawaiedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_jp_pegawaiadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("m_jp_pegawaidelete.php", $this->getUrlParm());
	}
