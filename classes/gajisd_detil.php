...
class gajisd_detil extends DbTable
{
	...
	public function __construct()
	{
		...
		// pegawai_id
		$this->pegawai_id = new DbField('gajisd_detil', 'gajisd_detil', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 200, 50, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gajisd_detil', 'gajisd_detil', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jp
		$this->jp = new DbField('gajisd_detil', 'gajisd_detil', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "add") {
				...
				$test = ExecuteRows("SELECT nip FROM pegawai");
				$this->pegawai->EditValue = $test;
			}
	}
