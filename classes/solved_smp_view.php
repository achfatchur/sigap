 ...
 * Page class
 */
class solved_smp_view extends solved_smp
{
	...
	// Page object name
	public $PageObjName = "solved_smp_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_smplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_smplist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_smplist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
