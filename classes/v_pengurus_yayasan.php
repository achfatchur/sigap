...
/**
 * Table class for v_pengurus_yayasan
 */
class v_pengurus_yayasan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_pengurus_yayasan';
		$this->TableName = 'v_pengurus_yayasan';
		$this->TableType = 'VIEW';
		...
		// id
		$this->id = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nip
		$this->nip = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_nip', 'nip', '`nip`', '`nip`', 200, 50, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_password', 'password', '`password`', '`password`', 200, 255, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// periode_jabatan
		$this->periode_jabatan = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_periode_jabatan', 'periode_jabatan', '`periode_jabatan`', '`periode_jabatan`', 3, 11, -1, FALSE, '`periode_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// alamat
		$this->alamat = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 255, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// email
		$this->_email = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// wa
		$this->wa = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_wa', 'wa', '`wa`', '`wa`', 200, 255, -1, FALSE, '`wa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->wa->Sortable = TRUE; // Allow sort
		$this->fields['wa'] = &$this->wa;

		// hp
		$this->hp = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_hp', 'hp', '`hp`', '`hp`', 200, 255, -1, FALSE, '`hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rekbank
		$this->rekbank = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_rekbank', 'rekbank', '`rekbank`', '`rekbank`', 200, 255, -1, FALSE, '`rekbank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenkel
		$this->jenkel = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_jenkel', 'jenkel', '`jenkel`', '`jenkel`', 200, 20, -1, FALSE, '`jenkel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// kehadiran
		$this->kehadiran = new DbField('v_pengurus_yayasan', 'v_pengurus_yayasan', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_pengurus_yayasan`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_pengurus_yayasanlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_pengurus_yayasanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_pengurus_yayasanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_pengurus_yayasanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_pengurus_yayasanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_pengurus_yayasanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_pengurus_yayasanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_pengurus_yayasanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pengurus_yayasanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_pengurus_yayasanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_pengurus_yayasandelete.php", $this->getUrlParm());
	}
