 ...
 * Page class
 */
class m_potongan_smp_edit extends m_potongan_smp
{
	...
	// Page object name
	public $PageObjName = "m_potongan_smp_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("potongan_smp", $detailTblVar) && $GLOBALS["potongan_smp"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("potongan_smp", $detailTblVar) && $GLOBALS["potongan_smp"]->DetailEdit) {
						...
						$editRow = $GLOBALS["potongan_smp_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("potongan_smp", $detailTblVar)) {
				...
				if ($GLOBALS["potongan_smp_grid"]->DetailEdit) {
					$GLOBALS["potongan_smp_grid"]->CurrentMode = "edit";
					$GLOBALS["potongan_smp_grid"]->CurrentAction = "gridedit";
