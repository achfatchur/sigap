 ...
 * Page class
 */
class solved_sma_delete extends solved_sma
{
	...
	// Page object name
	public $PageObjName = "solved_sma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("solved_smalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("solved_smalist.php"); // Return to list
			}
		}
	}
