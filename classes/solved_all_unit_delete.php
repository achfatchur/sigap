 ...
 * Page class
 */
class solved_all_unit_delete extends solved_all_unit
{
	...
	// Page object name
	public $PageObjName = "solved_all_unit_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("solved_all_unitlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("solved_all_unitlist.php"); // Return to list
			}
		}
	}
