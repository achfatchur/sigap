 ...
 * Page class
 */
class solved_all_unit_view extends solved_all_unit
{
	...
	// Page object name
	public $PageObjName = "solved_all_unit_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "solved_all_unitlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "solved_all_unitlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "solved_all_unitlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
