 ...
 * Page class
 */
class jabatan_delete extends jabatan
{
	...
	// Page object name
	public $PageObjName = "jabatan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("jabatanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("jabatanlist.php"); // Return to list
			}
		}
	}
