...
class slipgaji
{
	...
	// Table name
	public $TableName = 'slipgaji.php';

	// Page object name
	public $PageObjName = "slipgaji";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'slipgaji.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "slipgaji", $url, "", "slipgaji", TRUE);
		$this->Heading = $Language->TablePhrase("slipgaji", "TblCaption"); 
	}
} // End class
?>