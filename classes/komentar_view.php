 ...
 * Page class
 */
class komentar_view extends komentar
{
	...
	// Page object name
	public $PageObjName = "komentar_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "komentarlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "komentarlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "komentarlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
