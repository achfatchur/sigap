 ...
 * Page class
 */
class gajismk_detil_delete extends gajismk_detil
{
	...
	// Page object name
	public $PageObjName = "gajismk_detil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajismk_detillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajismk_detillist.php"); // Return to list
			}
		}
	}
