 ...
 * Page class
 */
class solved_smp_add extends solved_smp
{
	...
	// Page object name
	public $PageObjName = "solved_smp_add";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("solved_smplist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("solved_smplist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "solved_smplist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "solved_smpview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->j_pensiun->CurrentValue = NULL;
		$this->j_pensiun->OldValue = $this->j_pensiun->CurrentValue;
		$this->hari_tua->CurrentValue = NULL;
		$this->hari_tua->OldValue = $this->hari_tua->CurrentValue;
		$this->pph21->CurrentValue = NULL;
		$this->pph21->OldValue = $this->pph21->CurrentValue;
		$this->golongan_bpjs->CurrentValue = NULL;
		$this->golongan_bpjs->OldValue = $this->golongan_bpjs->CurrentValue;
		$this->iuran_bpjs->CurrentValue = NULL;
		$this->iuran_bpjs->OldValue = $this->iuran_bpjs->CurrentValue;
		...
		$this->type_peg->CurrentValue = NULL;
		$this->type_peg->OldValue = $this->type_peg->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['total_gaji'] = $this->total_gaji->CurrentValue;
		$row['j_pensiun'] = $this->j_pensiun->CurrentValue;
		$row['hari_tua'] = $this->hari_tua->CurrentValue;
		$row['pph21'] = $this->pph21->CurrentValue;
		$row['golongan_bpjs'] = $this->golongan_bpjs->CurrentValue;
		$row['iuran_bpjs'] = $this->iuran_bpjs->CurrentValue;
		$row['bulan'] = $this->bulan->CurrentValue;
		$row['tahun'] = $this->tahun->CurrentValue;
		$row['type_peg'] = $this->type_peg->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// j_pensiun
		$this->j_pensiun->setDbValueDef($rsnew, $this->j_pensiun->CurrentValue, NULL, FALSE);

		// hari_tua
		$this->hari_tua->setDbValueDef($rsnew, $this->hari_tua->CurrentValue, NULL, FALSE);

		// pph21
		$this->pph21->setDbValueDef($rsnew, $this->pph21->CurrentValue, NULL, FALSE);

		// golongan_bpjs
		$this->golongan_bpjs->setDbValueDef($rsnew, $this->golongan_bpjs->CurrentValue, NULL, FALSE);

		// iuran_bpjs
		$this->iuran_bpjs->setDbValueDef($rsnew, $this->iuran_bpjs->CurrentValue, NULL, FALSE);
		...
		// type_peg
		$this->type_peg->setDbValueDef($rsnew, $this->type_peg->CurrentValue, NULL, FALSE);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("solved_smplist.php"), "", $this->TableVar, TRUE);
