...
/**
 * Table class for v_tu_sma
 */
class v_tu_sma extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_tu_sma';
		$this->TableName = 'v_tu_sma';
		$this->TableType = 'VIEW';
		...
		// id
		$this->id = new DbField('v_tu_sma', 'v_tu_sma', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('v_tu_sma', 'v_tu_sma', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// createby
		$this->createby = new DbField('v_tu_sma', 'v_tu_sma', 'x_createby', 'createby', '`createby`', '`createby`', 3, 10, -1, FALSE, '`createby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('v_tu_sma', 'v_tu_sma', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('v_tu_sma', 'v_tu_sma', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "v_gaji_tu_sma") {
			$detailUrl = $GLOBALS["v_gaji_tu_sma"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "v_tu_smalist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_tu_sma`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_tu_smaview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_tu_smaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_tu_smaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_tu_smaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_tu_smaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_tu_smaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_tu_smaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_tu_smaedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_tu_smaedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_tu_smaadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_tu_smaadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_tu_smadelete.php", $this->getUrlParm());
	}
