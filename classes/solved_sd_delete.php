 ...
 * Page class
 */
class solved_sd_delete extends solved_sd
{
	...
	// Page object name
	public $PageObjName = "solved_sd_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("solved_sdlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("solved_sdlist.php"); // Return to list
			}
		}
	}
