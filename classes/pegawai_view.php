 ...
 * Page class
 */
class pegawai_view extends pegawai
{
	...
	// Page object name
	public $PageObjName = "pegawai_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "pegawailist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "pegawailist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "pegawailist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
