 ...
 * Page class
 */
class m_tidakhadir_delete extends m_tidakhadir
{
	...
	// Page object name
	public $PageObjName = "m_tidakhadir_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_tidakhadirlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_tidakhadirlist.php"); // Return to list
			}
		}
	}
