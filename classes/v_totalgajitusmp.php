...
/**
 * Table class for v_totalgajitusmp
 */
class v_totalgajitusmp extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_totalgajitusmp';
		$this->TableName = 'v_totalgajitusmp';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_totalgajitusmp`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// bulan
		$this->bulan = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tahun
		$this->tahun = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 18, 4, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// total
		$this->total = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_total', 'total', '`total`', '`total`', 20, 19, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// status
		$this->status = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_status', 'status', '`status`', '`status`', 3, 10, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// id1
		$this->id1 = new DbField('v_totalgajitusmp', 'v_totalgajitusmp', 'x_id1', 'id1', '`id1`', '`id1`', 3, 10, -1, FALSE, '`id1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_totalgajitusmp`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_totalgajitusmplist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_totalgajitusmpview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_totalgajitusmpedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_totalgajitusmpadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_totalgajitusmpview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_totalgajitusmpview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_totalgajitusmpadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_totalgajitusmpadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajitusmpedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajitusmpadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_totalgajitusmpdelete.php", $this->getUrlParm());
	}
