 ...
 * Page class
 */
class peg_skill_view extends peg_skill
{
	...
	// Page object name
	public $PageObjName = "peg_skill_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "peg_skilllist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "peg_skilllist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "peg_skilllist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
