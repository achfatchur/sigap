 ...
 * Page class
 */
class m_karyawan_smp_edit extends m_karyawan_smp
{
	...
	// Page object name
	public $PageObjName = "m_karyawan_smp_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_karyawan_smp", $detailTblVar) && $GLOBALS["gaji_karyawan_smp"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_karyawan_smp", $detailTblVar) && $GLOBALS["gaji_karyawan_smp"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_karyawan_smp_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_karyawan_smp", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_karyawan_smp_grid"]->DetailEdit) {
					$GLOBALS["gaji_karyawan_smp_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_karyawan_smp_grid"]->CurrentAction = "gridedit";
