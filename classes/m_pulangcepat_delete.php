 ...
 * Page class
 */
class m_pulangcepat_delete extends m_pulangcepat
{
	...
	// Page object name
	public $PageObjName = "m_pulangcepat_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_pulangcepatlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_pulangcepatlist.php"); // Return to list
			}
		}
	}
