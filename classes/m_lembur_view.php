 ...
 * Page class
 */
class m_lembur_view extends m_lembur
{
	...
	// Page object name
	public $PageObjName = "m_lembur_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_lemburlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_lemburlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_lemburlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
