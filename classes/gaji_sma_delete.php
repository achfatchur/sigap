 ...
 * Page class
 */
class gaji_sma_delete extends gaji_sma
{
	...
	// Page object name
	public $PageObjName = "gaji_sma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_smalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_smalist.php"); // Return to list
			}
		}
	}
