 ...
 * Page class
 */
class m_reward_delete extends m_reward
{
	...
	// Page object name
	public $PageObjName = "m_reward_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_rewardlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_rewardlist.php"); // Return to list
			}
		}
	}
