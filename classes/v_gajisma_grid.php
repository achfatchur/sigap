 ...
 * Page class
 */
class v_gajisma_grid extends v_gajisma
{
	...
	// Page object name
	public $PageObjName = "v_gajisma_grid";

	// Grid form hidden field names
	public $FormName = "fv_gajismagrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_m_sma'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_m_sma();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_m_sma"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_m_sma", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gajisma'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_sma();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_m_sma") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_m_sma"]->EventCancelled)
