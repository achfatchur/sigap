 ...
 * Page class
 */
class peg_keluarga_delete extends peg_keluarga
{
	...
	// Page object name
	public $PageObjName = "peg_keluarga_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("peg_keluargalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("peg_keluargalist.php"); // Return to list
			}
		}
	}
