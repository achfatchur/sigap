 ...
 * Page class
 */
class gaji_karyawan_sma_grid extends gaji_karyawan_sma
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_sma_grid";

	// Grid form hidden field names
	public $FormName = "fgaji_karyawan_smagrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_karyawan_sma") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["m_karyawan_sma"]->EventCancelled)
