...
/**
 * Table class for tunjangan_jabatan
 */
class tunjangan_jabatan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tunjangan_jabatan';
		$this->TableName = 'tunjangan_jabatan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tunjangan_jabatan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('tunjangan_jabatan', 'tunjangan_jabatan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// unit
		$this->unit = new DbField('tunjangan_jabatan', 'tunjangan_jabatan', 'x_unit', 'unit', '`unit`', '`unit`', 3, 11, -1, FALSE, '`unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan
		$this->jabatan = new DbField('tunjangan_jabatan', 'tunjangan_jabatan', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// value
		$this->value = new DbField('tunjangan_jabatan', 'tunjangan_jabatan', 'x_value', 'value', '`value`', '`value`', 20, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`tunjangan_jabatan`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "tunjangan_jabatanlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "tunjangan_jabatanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tunjangan_jabatanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tunjangan_jabatanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("tunjangan_jabatanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tunjangan_jabatanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "tunjangan_jabatanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tunjangan_jabatanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tunjangan_jabatanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tunjangan_jabatanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tunjangan_jabatandelete.php", $this->getUrlParm());
	}
