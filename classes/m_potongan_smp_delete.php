 ...
 * Page class
 */
class m_potongan_smp_delete extends m_potongan_smp
{
	...
	// Page object name
	public $PageObjName = "m_potongan_smp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_potongan_smplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_potongan_smplist.php"); // Return to list
			}
		}
	}
