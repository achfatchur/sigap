...
/**
 * Table class for gaji_tk
 */
class gaji_tk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_tk';
		$this->TableName = 'gaji_tk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_tk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_tk', 'gaji_tk', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('gaji_tk', 'gaji_tk', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// datetime
		$this->datetime = new DbField('gaji_tk', 'gaji_tk', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// month
		$this->month = new DbField('gaji_tk', 'gaji_tk', 'x_month', 'month', '`month`', CastDateFieldForLike("`month`", 0, "DB"), 133, 10, 0, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('gaji_tk', 'gaji_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('gaji_tk', 'gaji_tk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 11, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('gaji_tk', 'gaji_tk', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('gaji_tk', 'gaji_tk', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gaji_tk', 'gaji_tk', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new DbField('gaji_tk', 'gaji_tk', 'x_type', 'type', '`type`', '`type`', 3, 11, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('gaji_tk', 'gaji_tk', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_guru
		$this->jenis_guru = new DbField('gaji_tk', 'gaji_tk', 'x_jenis_guru', 'jenis_guru', '`jenis_guru`', '`jenis_guru`', 3, 11, -1, FALSE, '`jenis_guru`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tambahan
		$this->tambahan = new DbField('gaji_tk', 'gaji_tk', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// periode
		$this->periode = new DbField('gaji_tk', 'gaji_tk', 'x_periode', 'periode', '`periode`', '`periode`', 3, 11, -1, FALSE, '`periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->periode->Sortable = TRUE; // Allow sort
		$this->periode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['periode'] = &$this->periode;

		// tunjangan_periode
		$this->tunjangan_periode = new DbField('gaji_tk', 'gaji_tk', 'x_tunjangan_periode', 'tunjangan_periode', '`tunjangan_periode`', '`tunjangan_periode`', 20, 20, -1, FALSE, '`tunjangan_periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('gaji_tk', 'gaji_tk', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 11, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('gaji_tk', 'gaji_tk', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 20, 20, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lembur
		$this->lembur = new DbField('gaji_tk', 'gaji_tk', 'x_lembur', 'lembur', '`lembur`', '`lembur`', 3, 11, -1, FALSE, '`lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_lembur
		$this->value_lembur = new DbField('gaji_tk', 'gaji_tk', 'x_value_lembur', 'value_lembur', '`value_lembur`', '`value_lembur`', 20, 20, -1, FALSE, '`value_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gaji_tk', 'gaji_tk', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jp->Sortable = TRUE; // Allow sort
		$this->jp->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jp'] = &$this->jp;

		// gapok
		$this->gapok = new DbField('gaji_tk', 'gaji_tk', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 20, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_gapok
		$this->total_gapok = new DbField('gaji_tk', 'gaji_tk', 'x_total_gapok', 'total_gapok', '`total_gapok`', '`total_gapok`', 20, 20, -1, FALSE, '`total_gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('gaji_tk', 'gaji_tk', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 20, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('gaji_tk', 'gaji_tk', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 20, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// piket_count
		$this->piket_count = new DbField('gaji_tk', 'gaji_tk', 'x_piket_count', 'piket_count', '`piket_count`', '`piket_count`', 3, 11, -1, FALSE, '`piket_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_piket
		$this->value_piket = new DbField('gaji_tk', 'gaji_tk', 'x_value_piket', 'value_piket', '`value_piket`', '`value_piket`', 20, 20, -1, FALSE, '`value_piket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tugastambahan
		$this->tugastambahan = new DbField('gaji_tk', 'gaji_tk', 'x_tugastambahan', 'tugastambahan', '`tugastambahan`', '`tugastambahan`', 20, 20, -1, FALSE, '`tugastambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tj_jabatan
		$this->tj_jabatan = new DbField('gaji_tk', 'gaji_tk', 'x_tj_jabatan', 'tj_jabatan', '`tj_jabatan`', '`tj_jabatan`', 20, 20, -1, FALSE, '`tj_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('gaji_tk', 'gaji_tk', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 20, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jaminan_pensiun
		$this->jaminan_pensiun = new DbField('gaji_tk', 'gaji_tk', 'x_jaminan_pensiun', 'jaminan_pensiun', '`jaminan_pensiun`', '`jaminan_pensiun`', 20, 19, -1, FALSE, '`jaminan_pensiun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jaminan_hari_tua
		$this->jaminan_hari_tua = new DbField('gaji_tk', 'gaji_tk', 'x_jaminan_hari_tua', 'jaminan_hari_tua', '`jaminan_hari_tua`', '`jaminan_hari_tua`', 20, 19, -1, FALSE, '`jaminan_hari_tua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_pph21
		$this->total_pph21 = new DbField('gaji_tk', 'gaji_tk', 'x_total_pph21', 'total_pph21', '`total_pph21`', '`total_pph21`', 20, 19, -1, FALSE, '`total_pph21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bpjs_kesehatan
		$this->bpjs_kesehatan = new DbField('gaji_tk', 'gaji_tk', 'x_bpjs_kesehatan', 'bpjs_kesehatan', '`bpjs_kesehatan`', '`bpjs_kesehatan`', 20, 19, -1, FALSE, '`bpjs_kesehatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan
		$this->potongan = new DbField('gaji_tk', 'gaji_tk', 'x_potongan', 'potongan', '`potongan`', '`potongan`', 20, 20, -1, FALSE, '`potongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// penyesuaian
		$this->penyesuaian = new DbField('gaji_tk', 'gaji_tk', 'x_penyesuaian', 'penyesuaian', '`penyesuaian`', '`penyesuaian`', 20, 20, -1, FALSE, '`penyesuaian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('gaji_tk', 'gaji_tk', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 20, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new DbField('gaji_tk', 'gaji_tk', 'x_total', 'total', '`total`', '`total`', 20, 20, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// voucher
		$this->voucher = new DbField('gaji_tk', 'gaji_tk', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 20, 20, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('gaji_tk', 'gaji_tk', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// status_npwp
		$this->status_npwp = new DbField('gaji_tk', 'gaji_tk', 'x_status_npwp', 'status_npwp', '`status_npwp`', '`status_npwp`', 3, 11, -1, FALSE, '`status_npwp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		// Master filter
		$masterFilter = "";
		if ($this->getCurrentMasterTable() == "m_tk") {
	...
	// Master filter
	public function sqlMasterFilter_m_tk()
	{
		return "`id`=@id@ AND `tahun`=@tahun@ AND `bulan`=@bulan@";
	}

	// Detail filter
	public function sqlDetailFilter_m_tk()
	{
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_tk`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "gaji_tkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_tkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_tkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_tkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_tkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_tkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_tkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_tkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_tkdelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "m_tk" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
	...
	/*
												...
												$sertif = $rsnew["jenis_guru"];
												$type = $rsnew["type"];
												$periode = $rsnew["periode"];
												$tahun = $rsnew["tahun"];
												$bulan = $rsnew["bulan"];
												$absen =ExecuteRow("SELECT * FROM absen INNER JOIN absen_detil ON absen.id = absen_detil.pid WHERE absen_detil.pegawai='$nip' AND absen.bulan='$bulan' AND absen.tahun='$tahun' order by absen.datetime,absen_detil.id DESC");
												//POTONGAN
												$querypotongan = ExecuteRow("SELECT * FROM potongan_tk WHERE nama='$nip' ORDER BY datetime DESC");
												   // 1 untuk jabatan HRD
												...
												$piket= ExecuteRow("select * from m_piket where jenjang='4' AND jenis_sertif ='$sertif' AND type_jabatan='$type'");
												//
												$kehadiran= ExecuteRow("Select * from m_kehadiran where jenjang='4' AND jenis_jabatan='1' AND sertif='$sertif'");	
												//GAJI POKOK
												...
												// QUERY Tunjangan Tambahan									
												$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='$jenjang' AND kualifikasi='$tambahan_tj'");
												// Tunjangan Berkala
												if($this->jabatan_id->CurrentValue == '5'){
													$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='$jenjang' AND kualifikasi ='5' AND lama='$periode'");
												}else if($this->jabatan_id->CurrentValue == '15'){
													$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='$jenjang' AND kualifikasi ='15' AND lama='$periode'");
												}  
												// Gaji Pokok	
												$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='$jenjang' AND lama_kerja='$lama_kerja'");
												$rsnew["kehadiran"] = $absen["masuk"];
												...
												$rsnew["sub_total"] = $rsnew["tunjangan_periode"] + $rsnew["total_gapok"] + $rsnew["tugastambahan"]+($rsnew["kehadiran"] * $rsnew["value_kehadiran"])+($rsnew["lembur"] * $query2["lembur"]) + ($rsnew["piket_count"] * $piket["value"]) + $query2["inval"] + $query2["tunjangan_jabatan"] + $query2["jam_lebih"] + $query2["reward"] ;
	...
	*/	return TRUE;
	...
	if (CurrentPageID() == "add") {
									...
									//$id_user = ExecuteRows("SELECT * FROM pegawai where jenjang_id ='4' AND `type`= '1' AND id='6'");
						...
						if(isset($this->RowIndex)) {
							...
							if(($grid_count >= $grid_num) && is_int($grid_num) && ($grid_num >= 1)){
								$offseter = $grid_num - 1;
								$row = ExecuteRow("SELECT * FROM pegawai where jenjang_id ='1' AND `type`= '1' limit 1 OFFSET $offseter");
