 ...
 * Page class
 */
class m_bpjs_view extends m_bpjs
{
	...
	// Page object name
	public $PageObjName = "m_bpjs_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_bpjslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_bpjslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_bpjslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
