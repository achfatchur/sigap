 ...
 * Page class
 */
class gaji_pokok_tu_view extends gaji_pokok_tu
{
	...
	// Page object name
	public $PageObjName = "gaji_pokok_tu_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gaji_pokok_tulist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gaji_pokok_tulist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gaji_pokok_tulist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
