...
class generate_pertahun extends DbTable
{
	...
	$querymy2 = "INSERT INTO generate_pertahun VALUES(NULL,'".$tahun."',NULL,'".$profesi."','".$bulan."')";
	...
	$delete_clone ="DELETE FROM generate_pertahun WHERE id < '".$id."' AND tahun ='".$tahun."' AND bulan2='".$bulan."' AND profesi ='".$profesi."'";	
...
$clone_delete = execute($delete_m_sd);
	...
	foreach($row2 as $query){
		...
		$myquery2 = "INSERT INTO gaji_karyawan_sma VALUES (NULL, '".$query["nip"]."','".$query["jabatan"]."','4','".$komponen_gapok."',NULL,'".$inval2."','".$c_jjm."','".$sub_total."','".$penyesuaian."','".$tambahan."','".$total."','".$pid."','".$v_kehadiran."',NULL,'".$tahun."', '".$bulan."','".$v_voucher."',NULL)";
		//print_r($myquery2);
		//die;
