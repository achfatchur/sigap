 ...
 * Page class
 */
class generate_pertahun_delete extends generate_pertahun
{
	...
	// Page object name
	public $PageObjName = "generate_pertahun_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("generate_pertahunlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("generate_pertahunlist.php"); // Return to list
			}
		}
	}
