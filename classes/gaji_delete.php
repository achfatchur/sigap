 ...
 * Page class
 */
class gaji_delete extends gaji
{
	...
	// Page object name
	public $PageObjName = "gaji_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajilist.php"); // Return to list
			}
		}
	}
