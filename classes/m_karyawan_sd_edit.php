 ...
 * Page class
 */
class m_karyawan_sd_edit extends m_karyawan_sd
{
	...
	// Page object name
	public $PageObjName = "m_karyawan_sd_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_karyawan_sd", $detailTblVar) && $GLOBALS["gaji_karyawan_sd"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_karyawan_sd", $detailTblVar) && $GLOBALS["gaji_karyawan_sd"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_karyawan_sd_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_karyawan_sd", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_karyawan_sd_grid"]->DetailEdit) {
					$GLOBALS["gaji_karyawan_sd_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_karyawan_sd_grid"]->CurrentAction = "gridedit";
