...
/**
 * Table class for m_inval
 */
class m_inval extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'm_inval';
		$this->TableName = 'm_inval';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_inval`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('m_inval', 'm_inval', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('m_inval', 'm_inval', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('m_inval', 'm_inval', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->jabatan_id->Lookup = new Lookup('jabatan_id', 'jenis_jabatan', FALSE, 'id', ["name","","",""], [], [], [], [], [], [], '', '');
		$this->jabatan_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jabatan_id'] = &$this->jabatan_id;

		// value
		$this->value = new DbField('m_inval', 'm_inval', 'x_value', 'value', '`value`', '`value`', 20, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_inval`";
	}
	...
	{
		global $Language;
		if ($pageName == "m_invalview.php")
			return $Language->phrase("View");
		elseif ($pageName == "m_invaledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "m_invaladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("m_invalview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("m_invalview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "m_invaladd.php?" . $this->getUrlParm($parm);
		else
			$url = "m_invaladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_invaledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_invaladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("m_invaldelete.php", $this->getUrlParm());
	}
