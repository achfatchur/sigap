...
/**
 * Table class for vgaji_tu_sma
 */
class vgaji_tu_sma extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vgaji_tu_sma';
		$this->TableName = 'vgaji_tu_sma';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vgaji_tu_sma`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// pid
		$this->pid = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pid->Sortable = TRUE; // Allow sort
		$this->pid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pid'] = &$this->pid;

		// tahun
		$this->tahun = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 18, 4, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// pegawai
		$this->pegawai = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rekbank
		$this->rekbank = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_rekbank', 'rekbank', '`rekbank`', '`rekbank`', 200, 255, -1, FALSE, '`rekbank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekbank->Sortable = TRUE; // Allow sort
		$this->fields['rekbank'] = &$this->rekbank;

		// jenjang_id
		$this->jenjang_id = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 10, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type_jabatan
		$this->type_jabatan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_type_jabatan', 'type_jabatan', '`type_jabatan`', '`type_jabatan`', 3, 11, -1, FALSE, '`type_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tambahan
		$this->tambahan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ijasah
		$this->ijasah = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_ijasah', 'ijasah', '`ijasah`', '`ijasah`', 3, 11, -1, FALSE, '`ijasah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sertif
		$this->sertif = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_sertif', 'sertif', '`sertif`', '`sertif`', 3, 11, -1, FALSE, '`sertif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// gapok
		$this->gapok = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 19, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 10, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 20, 20, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lembur
		$this->lembur = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_lembur', 'lembur', '`lembur`', '`lembur`', 3, 10, -1, FALSE, '`lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_lembur
		$this->value_lembur = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_value_lembur', 'value_lembur', '`value_lembur`', '`value_lembur`', 20, 19, -1, FALSE, '`value_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 19, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 19, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// piket_count
		$this->piket_count = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_piket_count', 'piket_count', '`piket_count`', '`piket_count`', 3, 10, -1, FALSE, '`piket_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_piket
		$this->value_piket = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_value_piket', 'value_piket', '`value_piket`', '`value_piket`', 20, 19, -1, FALSE, '`value_piket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tugastambahan
		$this->tugastambahan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_tugastambahan', 'tugastambahan', '`tugastambahan`', '`tugastambahan`', 20, 19, -1, FALSE, '`tugastambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tj_jabatan
		$this->tj_jabatan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_tj_jabatan', 'tj_jabatan', '`tj_jabatan`', '`tj_jabatan`', 20, 19, -1, FALSE, '`tj_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tunjangan2
		$this->tunjangan2 = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_tunjangan2', 'tunjangan2', '`tunjangan2`', '`tunjangan2`', 20, 20, -1, FALSE, '`tunjangan2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan
		$this->potongan = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_potongan', 'potongan', '`potongan`', '`potongan`', 20, 19, -1, FALSE, '`potongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 19, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// penyesuaian
		$this->penyesuaian = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_penyesuaian', 'penyesuaian', '`penyesuaian`', '`penyesuaian`', 20, 19, -1, FALSE, '`penyesuaian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 100, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_total', 'total', '`total`', '`total`', 20, 19, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['total'] = &$this->total;

		// voucher
		$this->voucher = new DbField('vgaji_tu_sma', 'vgaji_tu_sma', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 20, 20, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vgaji_tu_sma`";
	}
	...
	{
		global $Language;
		if ($pageName == "vgaji_tu_smaview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vgaji_tu_smaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vgaji_tu_smaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vgaji_tu_smaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vgaji_tu_smaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vgaji_tu_smaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vgaji_tu_smaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_tu_smaedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_tu_smaadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vgaji_tu_smadelete.php", $this->getUrlParm());
	}
