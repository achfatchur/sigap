 ...
 * Page class
 */
class m_smp_edit extends m_smp
{
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_smp", $detailTblVar) && $GLOBALS["gaji_smp"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_smp", $detailTblVar) && $GLOBALS["gaji_smp"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_smp_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_smp", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_smp_grid"]->DetailEdit) {
					$GLOBALS["gaji_smp_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_smp_grid"]->CurrentAction = "gridedit";
