...
class backup_restore
{
	...
	// Table name
	public $TableName = 'backup_restore.php';

	// Page object name
	public $PageObjName = "backup_restore";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'backup_restore.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "backup_restore", $url, "", "backup_restore", TRUE);
		$this->Heading = $Language->TablePhrase("backup_restore", "TblCaption"); 
	}
} // End class
?>