 ...
 * Page class
 */
class vgaji_guru_sma_grid extends vgaji_guru_sma
{
	...
	// Page object name
	public $PageObjName = "vgaji_guru_sma_grid";

	// Grid form hidden field names
	public $FormName = "fvgaji_guru_smagrid";
...
// Render list options (extended codes)
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'vgaji_guru_sma'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_sma();
