 ...
 * Page class
 */
class m_yayasan_edit extends m_yayasan
{
	...
	// Page object name
	public $PageObjName = "m_yayasan_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("yayasan", $detailTblVar) && $GLOBALS["yayasan"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("yayasan", $detailTblVar) && $GLOBALS["yayasan"]->DetailEdit) {
						...
						$editRow = $GLOBALS["yayasan_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("yayasan", $detailTblVar)) {
				...
				if ($GLOBALS["yayasan_grid"]->DetailEdit) {
					$GLOBALS["yayasan_grid"]->CurrentMode = "edit";
					$GLOBALS["yayasan_grid"]->CurrentAction = "gridedit";
