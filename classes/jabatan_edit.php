 ...
 * Page class
 */
class jabatan_edit extends jabatan
{
	...
	// Page object name
	public $PageObjName = "jabatan_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gajitunjangan", $detailTblVar) && $GLOBALS["gajitunjangan"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gajitunjangan", $detailTblVar) && $GLOBALS["gajitunjangan"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gajitunjangan_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajitunjangan", $detailTblVar)) {
				...
				if ($GLOBALS["gajitunjangan_grid"]->DetailEdit) {
					$GLOBALS["gajitunjangan_grid"]->CurrentMode = "edit";
					$GLOBALS["gajitunjangan_grid"]->CurrentAction = "gridedit";
