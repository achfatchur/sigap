...
/**
 * Table class for gaji_pokok
 */
class gaji_pokok extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_pokok';
		$this->TableName = 'gaji_pokok';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_pokok`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_pokok', 'gaji_pokok', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('gaji_pokok', 'gaji_pokok', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('gaji_pokok', 'gaji_pokok', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value
		$this->value = new DbField('gaji_pokok', 'gaji_pokok', 'x_value', 'value', '`value`', '`value`', 20, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_pokok`";
	}
	...
	{
		global $Language;
		if ($pageName == "gaji_pokokview.php")
			return $Language->phrase("View");
		elseif ($pageName == "gaji_pokokedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_pokokadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_pokokview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_pokokview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_pokokadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_pokokadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokokedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_pokokadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_pokokdelete.php", $this->getUrlParm());
	}
