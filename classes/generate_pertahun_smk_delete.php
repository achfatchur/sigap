 ...
 * Page class
 */
class generate_pertahun_smk_delete extends generate_pertahun_smk
{
	...
	// Page object name
	public $PageObjName = "generate_pertahun_smk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("generate_pertahun_smklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("generate_pertahun_smklist.php"); // Return to list
			}
		}
	}
