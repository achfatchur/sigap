...
class generate_pertahun_smk extends DbTable
{
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		//echo "Row Inserted"
				...
				$querymy2 = "INSERT INTO generate_pertahun_smk VALUES(NULL,'".$tahun."',NULL,'".$profesi."','".$bulan."')";
				...
				$delete_clone ="DELETE FROM generate_pertahun_smk WHERE id < '".$id."' AND tahun ='".$tahun."' AND bulan2='".$bulan."' AND profesi ='".$profesi."'";	
			...
			if($query['jabatan'] == '5'){
				...
				$myquery2 = "INSERT INTO gaji_karyawan_smk VALUES (NULL, '".$query["nip"]."','".$query["jabatan"]."','4','".$komponen_gapok."',NULL,'".$inval2."','".$c_jjm."','".$sub_total."','".$penyesuaian."','".$tambahan."','".$total."','".$pid."','".$v_kehadiran."',NULL,'".$tahun."', '".$bulan."','".$v_voucher."',NULL)";
