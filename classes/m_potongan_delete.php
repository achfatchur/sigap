 ...
 * Page class
 */
class m_potongan_delete extends m_potongan
{
	...
	// Page object name
	public $PageObjName = "m_potongan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_potonganlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_potonganlist.php"); // Return to list
			}
		}
	}
