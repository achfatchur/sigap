 ...
 * Page class
 */
class peg_dokumen_delete extends peg_dokumen
{
	...
	// Page object name
	public $PageObjName = "peg_dokumen_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("peg_dokumenlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("peg_dokumenlist.php"); // Return to list
			}
		}
	}
