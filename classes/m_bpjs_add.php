 ...
 * Page class
 */
class m_bpjs_add extends m_bpjs
{
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_bpjsview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->golongan->CurrentValue = NULL;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// golongan
		$this->golongan->setDbValueDef($rsnew, $this->golongan->CurrentValue, NULL, FALSE);
