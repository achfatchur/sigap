...
/**
 * Table class for komentar
 */
class komentar extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'komentar';
		$this->TableName = 'komentar';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`komentar`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('komentar', 'komentar', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('komentar', 'komentar', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// komentar
		$this->komentar = new DbField('komentar', 'komentar', 'x_komentar', 'komentar', '`komentar`', '`komentar`', 201, 500, -1, FALSE, '`komentar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->komentar->Sortable = TRUE; // Allow sort
		$this->fields['komentar'] = &$this->komentar;

		// gambar
		$this->gambar = new DbField('komentar', 'komentar', 'x_gambar', 'gambar', '`gambar`', '`gambar`', 200, 255, -1, FALSE, '`gambar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gambar->Sortable = TRUE; // Allow sort
		$this->fields['gambar'] = &$this->gambar;

		// video
		$this->video = new DbField('komentar', 'komentar', 'x_video', 'video', '`video`', '`video`', 200, 255, -1, FALSE, '`video`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->video->Sortable = TRUE; // Allow sort
		$this->fields['video'] = &$this->video;

		// pegawai
		$this->pegawai = new DbField('komentar', 'komentar', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 3, 255, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`komentar`";
	}
	...
	{
		global $Language;
		if ($pageName == "komentarview.php")
			return $Language->phrase("View");
		elseif ($pageName == "komentaredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "komentaradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("komentarview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("komentarview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "komentaradd.php?" . $this->getUrlParm($parm);
		else
			$url = "komentaradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("komentaredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("komentaradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("komentardelete.php", $this->getUrlParm());
	}
