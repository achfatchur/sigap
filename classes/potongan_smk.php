...
/**
 * Table class for potongan_smk
 */
class potongan_smk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'potongan_smk';
		$this->TableName = 'potongan_smk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`potongan_smk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('potongan_smk', 'potongan_smk', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('potongan_smk', 'potongan_smk', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// u_by
		$this->u_by = new DbField('potongan_smk', 'potongan_smk', 'x_u_by', 'u_by', '`u_by`', '`u_by`', 3, 10, -1, FALSE, '`u_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// month
		$this->month = new DbField('potongan_smk', 'potongan_smk', 'x_month', 'month', '`month`', CastDateFieldForLike("`month`", 0, "DB"), 133, 10, 0, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('potongan_smk', 'potongan_smk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('potongan_smk', 'potongan_smk', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 11, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('potongan_smk', 'potongan_smk', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('potongan_smk', 'potongan_smk', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('potongan_smk', 'potongan_smk', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 10, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sertif
		$this->sertif = new DbField('potongan_smk', 'potongan_smk', 'x_sertif', 'sertif', '`sertif`', '`sertif`', 3, 11, -1, FALSE, '`sertif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// terlambat
		$this->terlambat = new DbField('potongan_smk', 'potongan_smk', 'x_terlambat', 'terlambat', '`terlambat`', '`terlambat`', 3, 10, -1, FALSE, '`terlambat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_terlambat
		$this->value_terlambat = new DbField('potongan_smk', 'potongan_smk', 'x_value_terlambat', 'value_terlambat', '`value_terlambat`', '`value_terlambat`', 20, 19, -1, FALSE, '`value_terlambat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izin
		$this->izin = new DbField('potongan_smk', 'potongan_smk', 'x_izin', 'izin', '`izin`', '`izin`', 3, 10, -1, FALSE, '`izin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_izin
		$this->value_izin = new DbField('potongan_smk', 'potongan_smk', 'x_value_izin', 'value_izin', '`value_izin`', '`value_izin`', 20, 19, -1, FALSE, '`value_izin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakit
		$this->sakit = new DbField('potongan_smk', 'potongan_smk', 'x_sakit', 'sakit', '`sakit`', '`sakit`', 3, 10, -1, FALSE, '`sakit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_sakit
		$this->value_sakit = new DbField('potongan_smk', 'potongan_smk', 'x_value_sakit', 'value_sakit', '`value_sakit`', '`value_sakit`', 20, 19, -1, FALSE, '`value_sakit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadir
		$this->tidakhadir = new DbField('potongan_smk', 'potongan_smk', 'x_tidakhadir', 'tidakhadir', '`tidakhadir`', '`tidakhadir`', 3, 10, -1, FALSE, '`tidakhadir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_tidakhadir
		$this->value_tidakhadir = new DbField('potongan_smk', 'potongan_smk', 'x_value_tidakhadir', 'value_tidakhadir', '`value_tidakhadir`', '`value_tidakhadir`', 20, 19, -1, FALSE, '`value_tidakhadir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pulcep
		$this->pulcep = new DbField('potongan_smk', 'potongan_smk', 'x_pulcep', 'pulcep', '`pulcep`', '`pulcep`', 3, 10, -1, FALSE, '`pulcep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_pulcep
		$this->value_pulcep = new DbField('potongan_smk', 'potongan_smk', 'x_value_pulcep', 'value_pulcep', '`value_pulcep`', '`value_pulcep`', 20, 19, -1, FALSE, '`value_pulcep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadirjam
		$this->tidakhadirjam = new DbField('potongan_smk', 'potongan_smk', 'x_tidakhadirjam', 'tidakhadirjam', '`tidakhadirjam`', '`tidakhadirjam`', 3, 10, -1, FALSE, '`tidakhadirjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadirjamvalue
		$this->tidakhadirjamvalue = new DbField('potongan_smk', 'potongan_smk', 'x_tidakhadirjamvalue', 'tidakhadirjamvalue', '`tidakhadirjamvalue`', '`tidakhadirjamvalue`', 20, 19, -1, FALSE, '`tidakhadirjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakitperjam
		$this->sakitperjam = new DbField('potongan_smk', 'potongan_smk', 'x_sakitperjam', 'sakitperjam', '`sakitperjam`', '`sakitperjam`', 3, 10, -1, FALSE, '`sakitperjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakitperjamvalue
		$this->sakitperjamvalue = new DbField('potongan_smk', 'potongan_smk', 'x_sakitperjamvalue', 'sakitperjamvalue', '`sakitperjamvalue`', '`sakitperjamvalue`', 20, 19, -1, FALSE, '`sakitperjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izinperjam
		$this->izinperjam = new DbField('potongan_smk', 'potongan_smk', 'x_izinperjam', 'izinperjam', '`izinperjam`', '`izinperjam`', 3, 10, -1, FALSE, '`izinperjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izinperjamvalue
		$this->izinperjamvalue = new DbField('potongan_smk', 'potongan_smk', 'x_izinperjamvalue', 'izinperjamvalue', '`izinperjamvalue`', '`izinperjamvalue`', 20, 19, -1, FALSE, '`izinperjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// totalpotongan
		$this->totalpotongan = new DbField('potongan_smk', 'potongan_smk', 'x_totalpotongan', 'totalpotongan', '`totalpotongan`', '`totalpotongan`', 20, 19, -1, FALSE, '`totalpotongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pid
		$this->pid = new DbField('potongan_smk', 'potongan_smk', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		// Master filter
		$masterFilter = "";
		if ($this->getCurrentMasterTable() == "m_potongan_smk") {
	...
	// Master filter
	public function sqlMasterFilter_m_potongan_smk()
	{
		return "`id`=@id@ AND `tahun`=@tahun@ AND `bulan`=@bulan@";
	}

	// Detail filter
	public function sqlDetailFilter_m_potongan_smk()
	{
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`potongan_smk`";
	}
	...
	{
		global $Language;
		if ($pageName == "potongan_smkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "potongan_smkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "potongan_smkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("potongan_smkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("potongan_smkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "potongan_smkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "potongan_smkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("potongan_smkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("potongan_smkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("potongan_smkdelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "m_potongan_smk" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
