 ...
 * Page class
 */
class lembur_view extends lembur
{
	...
	// Page object name
	public $PageObjName = "lembur_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "lemburlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "lemburlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "lemburlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
