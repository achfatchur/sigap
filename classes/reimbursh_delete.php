 ...
 * Page class
 */
class reimbursh_delete extends reimbursh
{
	...
	// Page object name
	public $PageObjName = "reimbursh_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("reimburshlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("reimburshlist.php"); // Return to list
			}
		}
	}
