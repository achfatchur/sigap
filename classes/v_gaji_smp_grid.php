 ...
 * Page class
 */
class v_gaji_smp_grid extends v_gaji_smp
{
	...
	// Page object name
	public $PageObjName = "v_gaji_smp_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_smpgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_m_smp'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_m_smp();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_m_smp"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_m_smp", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_smp'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_smp();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_m_smp") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_m_smp"]->EventCancelled)
