 ...
 * Page class
 */
class m_jaminan_pensiun_view extends m_jaminan_pensiun
{
	...
	// Page object name
	public $PageObjName = "m_jaminan_pensiun_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_jaminan_pensiunlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_jaminan_pensiunlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_jaminan_pensiunlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
