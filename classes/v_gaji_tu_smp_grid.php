 ...
 * Page class
 */
class v_gaji_tu_smp_grid extends v_gaji_tu_smp
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_smp_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_tu_smpgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_tu_smp") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_tu_smp"]->EventCancelled)
