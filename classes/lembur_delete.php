 ...
 * Page class
 */
class lembur_delete extends lembur
{
	...
	// Page object name
	public $PageObjName = "lembur_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lemburlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lemburlist.php"); // Return to list
			}
		}
	}
