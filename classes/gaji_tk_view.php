 ...
 * Page class
 */
class gaji_tk_view extends gaji_tk
{
	...
	// Page object name
	public $PageObjName = "gaji_tk_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gaji_tklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gaji_tklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gaji_tklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
