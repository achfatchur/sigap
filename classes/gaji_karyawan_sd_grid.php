 ...
 * Page class
 */
class gaji_karyawan_sd_grid extends gaji_karyawan_sd
{
	...
	// Page object name
	public $PageObjName = "gaji_karyawan_sd_grid";

	// Grid form hidden field names
	public $FormName = "fgaji_karyawan_sdgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_karyawan_sd") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["m_karyawan_sd"]->EventCancelled)
