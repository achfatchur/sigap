 ...
 * Page class
 */
class m_karyawan_tk_edit extends m_karyawan_tk
{
	...
	// Page object name
	public $PageObjName = "m_karyawan_tk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_karyawan_tk", $detailTblVar) && $GLOBALS["gaji_karyawan_tk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_karyawan_tk", $detailTblVar) && $GLOBALS["gaji_karyawan_tk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_karyawan_tk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_karyawan_tk", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_karyawan_tk_grid"]->DetailEdit) {
					$GLOBALS["gaji_karyawan_tk_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_karyawan_tk_grid"]->CurrentAction = "gridedit";
