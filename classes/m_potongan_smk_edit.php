 ...
 * Page class
 */
class m_potongan_smk_edit extends m_potongan_smk
{
	...
	// Page object name
	public $PageObjName = "m_potongan_smk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("potongan_smk", $detailTblVar) && $GLOBALS["potongan_smk"]->DetailEdit) {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// import_file
			$this->import_file->setDbValueDef($rsnew, $this->import_file->CurrentValue, NULL, $this->import_file->ReadOnly);
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("potongan_smk", $detailTblVar) && $GLOBALS["potongan_smk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["potongan_smk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("potongan_smk", $detailTblVar)) {
				...
				if ($GLOBALS["potongan_smk_grid"]->DetailEdit) {
					$GLOBALS["potongan_smk_grid"]->CurrentMode = "edit";
					$GLOBALS["potongan_smk_grid"]->CurrentAction = "gridedit";
