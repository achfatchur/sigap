 ...
 * Page class
 */
class v_gaji_tu_sd_grid extends v_gaji_tu_sd
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_sd_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_tu_sdgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_tu_sd'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_tu_sd();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_tu_sd"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_tu_sd", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_tu_sd'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_tu_sd();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_tu_sd") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_tu_sd"]->EventCancelled)
