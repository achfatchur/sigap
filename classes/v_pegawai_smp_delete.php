 ...
 * Page class
 */
class v_pegawai_smp_delete extends v_pegawai_smp
{
	...
	// Page object name
	public $PageObjName = "v_pegawai_smp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_pegawai_smplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_pegawai_smplist.php"); // Return to list
			}
		}
	}
