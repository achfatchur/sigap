 ...
 * Page class
 */
class peg_dokumen_view extends peg_dokumen
{
	...
	// Page object name
	public $PageObjName = "peg_dokumen_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "peg_dokumenlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "peg_dokumenlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "peg_dokumenlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
