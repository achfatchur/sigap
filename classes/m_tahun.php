...
/**
 * Table class for m_tahun
 */
class m_tahun extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'm_tahun';
		$this->TableName = 'm_tahun';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_tahun`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('m_tahun', 'm_tahun', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// tahun
		$this->tahun = new DbField('m_tahun', 'm_tahun', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_urut
		$this->no_urut = new DbField('m_tahun', 'm_tahun', 'x_no_urut', 'no_urut', '`no_urut`', '`no_urut`', 3, 11, -1, FALSE, '`no_urut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_tahun`";
	}
	...
	{
		global $Language;
		if ($pageName == "m_tahunview.php")
			return $Language->phrase("View");
		elseif ($pageName == "m_tahunedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "m_tahunadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("m_tahunview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("m_tahunview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "m_tahunadd.php?" . $this->getUrlParm($parm);
		else
			$url = "m_tahunadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_tahunedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_tahunadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("m_tahundelete.php", $this->getUrlParm());
	}
