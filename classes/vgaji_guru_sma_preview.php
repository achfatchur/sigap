 ...
 * Page class
 */
class vgaji_guru_sma_preview extends vgaji_guru_sma
{
	...
	// Page object name
	public $PageObjName = "vgaji_guru_sma_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vgaji_guru_sma');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_m_sma") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_m_sma&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vgaji_guru_smalist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
