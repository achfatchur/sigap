 ...
 * Page class
 */
class gajismk_detil_view extends gajismk_detil
{
	...
	// Page object name
	public $PageObjName = "gajismk_detil_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gajismk_detillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gajismk_detillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gajismk_detillist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
