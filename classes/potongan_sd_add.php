 ...
 * Page class
 */
class potongan_sd_add extends potongan_sd
{
	...
	// Page object name
	public $PageObjName = "potongan_sd_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "potongan_sdview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'potongan_sd'
