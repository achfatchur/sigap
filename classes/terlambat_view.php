 ...
 * Page class
 */
class terlambat_view extends terlambat
{
	...
	// Page object name
	public $PageObjName = "terlambat_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "terlambatlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "terlambatlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "terlambatlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
