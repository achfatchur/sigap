 ...
 * Page class
 */
class yayasan_view extends yayasan
{
	...
	// Page object name
	public $PageObjName = "yayasan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "yayasanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "yayasanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "yayasanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
