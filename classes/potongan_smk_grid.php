 ...
 * Page class
 */
class potongan_smk_grid extends potongan_smk
{
	...
	// Page object name
	public $PageObjName = "potongan_smk_grid";

	// Grid form hidden field names
	public $FormName = "fpotongan_smkgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'm_potongan_smk'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_m_potongan_smk();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["m_potongan_smk"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "m_potongan_smk", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'potongan_smk'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_m_potongan_smk();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "m_potongan_smk") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["m_potongan_smk"]->EventCancelled)
