 ...
 * Page class
 */
class m_inval_delete extends m_inval
{
	...
	// Page object name
	public $PageObjName = "m_inval_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_invallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_invallist.php"); // Return to list
			}
		}
	}
