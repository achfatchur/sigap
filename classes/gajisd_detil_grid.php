 ...
 * Page class
 */
class gajisd_detil_grid extends gajisd_detil
{
	...
	// Page object name
	public $PageObjName = "gajisd_detil_grid";

	// Grid form hidden field names
	public $FormName = "fgajisd_detilgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'gajisd'
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "gajisd") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["gajisd"]->EventCancelled)
