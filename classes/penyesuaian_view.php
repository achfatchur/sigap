 ...
 * Page class
 */
class penyesuaian_view extends penyesuaian
{
	...
	// Page object name
	public $PageObjName = "penyesuaian_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "penyesuaianlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "penyesuaianlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "penyesuaianlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
