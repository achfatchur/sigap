...
class gaji_tu_sd extends DbTable
{
	...
	public function __construct()
	{
		...
		// type_jabatan
		$this->type_jabatan = new DbField('gaji_tu_sd', 'gaji_tu_sd', 'x_type_jabatan', 'type_jabatan', '`type_jabatan`', '`type_jabatan`', 3, 10, -1, FALSE, '`type_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ijasah
		$this->ijasah = new DbField('gaji_tu_sd', 'gaji_tu_sd', 'x_ijasah', 'ijasah', '`ijasah`', '`ijasah`', 3, 10, -1, FALSE, '`ijasah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('gaji_tu_sd', 'gaji_tu_sd', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 100, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('gaji_tu_sd', 'gaji_tu_sd', 'x_status', 'status', '`status`', '`status`', 3, 10, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
