 ...
 * Page class
 */
class gaji_smk_delete extends gaji_smk
{
	...
	// Page object name
	public $PageObjName = "gaji_smk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_smklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_smklist.php"); // Return to list
			}
		}
	}
