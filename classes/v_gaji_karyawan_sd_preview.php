 ...
 * Page class
 */
class v_gaji_karyawan_sd_preview extends v_gaji_karyawan_sd
{
	...
	// Page object name
	public $PageObjName = "v_gaji_karyawan_sd_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gaji_karyawan_sd');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_karyawan_sd") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_karyawan_sd&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gaji_karyawan_sdlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
