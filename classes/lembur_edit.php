 ...
 * Page class
 */
class lembur_edit extends lembur
{
	...
	// Page object name
	public $PageObjName = "lembur_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tgl_awal_lembur
			$this->tgl_awal_lembur->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_awal_lembur->CurrentValue, 0), NULL, $this->tgl_awal_lembur->ReadOnly);

			// tgl_akhir_lembur
			$this->tgl_akhir_lembur->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_akhir_lembur->CurrentValue, 0), NULL, $this->tgl_akhir_lembur->ReadOnly);

			// total_jam
			$this->total_jam->setDbValueDef($rsnew, $this->total_jam->CurrentValue, NULL, $this->total_jam->ReadOnly);
