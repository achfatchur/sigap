...
class m_tk_edit extends m_tk
{
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tk", $detailTblVar) && $GLOBALS["gaji_tk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tk", $detailTblVar) && $GLOBALS["gaji_tk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tk", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tk_grid"]->DetailEdit) {
					$GLOBALS["gaji_tk_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tk_grid"]->CurrentAction = "gridedit";
