 ...
 * Page class
 */
class gajisma_detil_delete extends gajisma_detil
{
	...
	// Page object name
	public $PageObjName = "gajisma_detil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajisma_detillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajisma_detillist.php"); // Return to list
			}
		}
	}
