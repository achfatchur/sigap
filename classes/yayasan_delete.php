 ...
 * Page class
 */
class yayasan_delete extends yayasan
{
	...
	// Page object name
	public $PageObjName = "yayasan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("yayasanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("yayasanlist.php"); // Return to list
			}
		}
	}
