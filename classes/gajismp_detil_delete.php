 ...
 * Page class
 */
class gajismp_detil_delete extends gajismp_detil
{
	...
	// Page object name
	public $PageObjName = "gajismp_detil_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajismp_detillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajismp_detillist.php"); // Return to list
			}
		}
	}
