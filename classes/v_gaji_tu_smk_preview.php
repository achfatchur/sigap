 ...
 * Page class
 */
class v_gaji_tu_smk_preview extends v_gaji_tu_smk
{
	...
	// Page object name
	public $PageObjName = "v_gaji_tu_smk_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'v_gaji_tu_smk');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "v_tu_smk") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=v_tu_smk&fk_id=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("v_gaji_tu_smklist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
