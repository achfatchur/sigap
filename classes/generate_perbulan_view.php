 ...
 * Page class
 */
class generate_perbulan_view extends generate_perbulan
{
	...
	// Page object name
	public $PageObjName = "generate_perbulan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "generate_perbulanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "generate_perbulanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "generate_perbulanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
