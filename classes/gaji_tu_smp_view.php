 ...
 * Page class
 */
class gaji_tu_smp_view extends gaji_tu_smp
{
	...
	// Page object name
	public $PageObjName = "gaji_tu_smp_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gaji_tu_smplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gaji_tu_smplist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gaji_tu_smplist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
