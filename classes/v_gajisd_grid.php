 ...
 * Page class
 */
class v_gajisd_grid extends v_gajisd
{
	...
	// Page object name
	public $PageObjName = "v_gajisd_grid";

	// Grid form hidden field names
	public $FormName = "fv_gajisdgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_m_sd'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_m_sd();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_m_sd"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_m_sd", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gajisd'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_m_sd();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_m_sd") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_m_sd"]->EventCancelled)
