...
/**
 * Table class for vgaji_karyawan_tk
 */
class vgaji_karyawan_tk extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vgaji_karyawan_tk';
		$this->TableName = 'vgaji_karyawan_tk';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vgaji_karyawan_tk`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tahun
		$this->tahun = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 10, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// gapok
		$this->gapok = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 19, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 20, 20, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 19, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 19, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 19, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan
		$this->potongan = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_potongan', 'potongan', '`potongan`', '`potongan`', 20, 19, -1, FALSE, '`potongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// penyesuaian
		$this->penyesuaian = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_penyesuaian', 'penyesuaian', '`penyesuaian`', '`penyesuaian`', 20, 19, -1, FALSE, '`penyesuaian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// voucher
		$this->voucher = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 3, 11, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('vgaji_karyawan_tk', 'vgaji_karyawan_tk', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vgaji_karyawan_tk`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vgaji_karyawan_tklist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vgaji_karyawan_tkview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vgaji_karyawan_tkedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vgaji_karyawan_tkadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vgaji_karyawan_tkview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vgaji_karyawan_tkview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vgaji_karyawan_tkadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vgaji_karyawan_tkadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_karyawan_tkedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vgaji_karyawan_tkadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vgaji_karyawan_tkdelete.php", $this->getUrlParm());
	}
