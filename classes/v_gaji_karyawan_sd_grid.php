 ...
 * Page class
 */
class v_gaji_karyawan_sd_grid extends v_gaji_karyawan_sd
{
	...
	// Page object name
	public $PageObjName = "v_gaji_karyawan_sd_grid";

	// Grid form hidden field names
	public $FormName = "fv_gaji_karyawan_sdgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'v_karyawan_sd'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_v_karyawan_sd();
			...
			if ($validMasterRecord) {
				...
				$rsmaster = $GLOBALS["v_karyawan_sd"]->loadRs($masterFilter);
				$validMasterRecord = ($rsmaster && !$rsmaster->EOF);
				$rsmaster->close();
			}
			if (!$validMasterRecord) {
				$relatedRecordMsg = str_replace("%t", "v_karyawan_sd", $Language->phrase("RelatedRecordRequired"));
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'v_gaji_karyawan_sd'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_v_karyawan_sd();
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "v_karyawan_sd") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["v_karyawan_sd"]->EventCancelled)
