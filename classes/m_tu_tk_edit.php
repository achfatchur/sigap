 ...
 * Page class
 */
class m_tu_tk_edit extends m_tu_tk
{
	...
	// Page object name
	public $PageObjName = "m_tu_tk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gaji_tu_tk", $detailTblVar) && $GLOBALS["gaji_tu_tk"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gaji_tu_tk", $detailTblVar) && $GLOBALS["gaji_tu_tk"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gaji_tu_tk_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gaji_tu_tk", $detailTblVar)) {
				...
				if ($GLOBALS["gaji_tu_tk_grid"]->DetailEdit) {
					$GLOBALS["gaji_tu_tk_grid"]->CurrentMode = "edit";
					$GLOBALS["gaji_tu_tk_grid"]->CurrentAction = "gridedit";
