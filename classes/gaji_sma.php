...
/**
 * Table class for gaji_sma
 */
class gaji_sma extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'gaji_sma';
		$this->TableName = 'gaji_sma';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`gaji_sma`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('gaji_sma', 'gaji_sma', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('gaji_sma', 'gaji_sma', 'x_pid', 'pid', '`pid`', '`pid`', 3, 10, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// datetime
		$this->datetime = new DbField('gaji_sma', 'gaji_sma', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// month
		$this->month = new DbField('gaji_sma', 'gaji_sma', 'x_month', 'month', '`month`', CastDateFieldForLike("`month`", 0, "DB"), 133, 10, 0, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('gaji_sma', 'gaji_sma', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 10, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('gaji_sma', 'gaji_sma', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 11, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('gaji_sma', 'gaji_sma', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->pegawai->Lookup = new Lookup('pegawai', 'pegawai', FALSE, 'nip', ["nama","","",""], [], [], [], [], ["jenjang_id","jabatan","lama_kerja","type","sertif","tambahan","periode_jabatan"], ["x_jenjang_id","x_jabatan_id","x_lama_kerja","x_type","x_jenis_guru","x_tambahan","x_periode"], '', '');
		$this->fields['pegawai'] = &$this->pegawai;

		// jenjang_id
		$this->jenjang_id = new DbField('gaji_sma', 'gaji_sma', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 10, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('gaji_sma', 'gaji_sma', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 10, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lama_kerja
		$this->lama_kerja = new DbField('gaji_sma', 'gaji_sma', 'x_lama_kerja', 'lama_kerja', '`lama_kerja`', '`lama_kerja`', 3, 11, -1, FALSE, '`lama_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new DbField('gaji_sma', 'gaji_sma', 'x_type', 'type', '`type`', '`type`', 3, 10, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_guru
		$this->jenis_guru = new DbField('gaji_sma', 'gaji_sma', 'x_jenis_guru', 'jenis_guru', '`jenis_guru`', '`jenis_guru`', 3, 11, -1, FALSE, '`jenis_guru`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tambahan
		$this->tambahan = new DbField('gaji_sma', 'gaji_sma', 'x_tambahan', 'tambahan', '`tambahan`', '`tambahan`', 3, 11, -1, FALSE, '`tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// periode
		$this->periode = new DbField('gaji_sma', 'gaji_sma', 'x_periode', 'periode', '`periode`', '`periode`', 3, 11, -1, FALSE, '`periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->periode->Sortable = TRUE; // Allow sort
		$this->periode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['periode'] = &$this->periode;

		// tunjangan_periode
		$this->tunjangan_periode = new DbField('gaji_sma', 'gaji_sma', 'x_tunjangan_periode', 'tunjangan_periode', '`tunjangan_periode`', '`tunjangan_periode`', 20, 20, -1, FALSE, '`tunjangan_periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kehadiran
		$this->kehadiran = new DbField('gaji_sma', 'gaji_sma', 'x_kehadiran', 'kehadiran', '`kehadiran`', '`kehadiran`', 3, 10, -1, FALSE, '`kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_kehadiran
		$this->value_kehadiran = new DbField('gaji_sma', 'gaji_sma', 'x_value_kehadiran', 'value_kehadiran', '`value_kehadiran`', '`value_kehadiran`', 3, 11, -1, FALSE, '`value_kehadiran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lembur
		$this->lembur = new DbField('gaji_sma', 'gaji_sma', 'x_lembur', 'lembur', '`lembur`', '`lembur`', 3, 10, -1, FALSE, '`lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_lembur
		$this->value_lembur = new DbField('gaji_sma', 'gaji_sma', 'x_value_lembur', 'value_lembur', '`value_lembur`', '`value_lembur`', 20, 19, -1, FALSE, '`value_lembur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gaji_sma', 'gaji_sma', 'x_jp', 'jp', '`jp`', '`jp`', 3, 10, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jp->Sortable = TRUE; // Allow sort
		$this->jp->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jp'] = &$this->jp;

		// gapok
		$this->gapok = new DbField('gaji_sma', 'gaji_sma', 'x_gapok', 'gapok', '`gapok`', '`gapok`', 20, 19, -1, FALSE, '`gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_gapok
		$this->total_gapok = new DbField('gaji_sma', 'gaji_sma', 'x_total_gapok', 'total_gapok', '`total_gapok`', '`total_gapok`', 20, 20, -1, FALSE, '`total_gapok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_reward
		$this->value_reward = new DbField('gaji_sma', 'gaji_sma', 'x_value_reward', 'value_reward', '`value_reward`', '`value_reward`', 20, 19, -1, FALSE, '`value_reward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_inval
		$this->value_inval = new DbField('gaji_sma', 'gaji_sma', 'x_value_inval', 'value_inval', '`value_inval`', '`value_inval`', 20, 19, -1, FALSE, '`value_inval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// piket_count
		$this->piket_count = new DbField('gaji_sma', 'gaji_sma', 'x_piket_count', 'piket_count', '`piket_count`', '`piket_count`', 3, 10, -1, FALSE, '`piket_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_piket
		$this->value_piket = new DbField('gaji_sma', 'gaji_sma', 'x_value_piket', 'value_piket', '`value_piket`', '`value_piket`', 20, 19, -1, FALSE, '`value_piket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tugastambahan
		$this->tugastambahan = new DbField('gaji_sma', 'gaji_sma', 'x_tugastambahan', 'tugastambahan', '`tugastambahan`', '`tugastambahan`', 20, 19, -1, FALSE, '`tugastambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tj_jabatan
		$this->tj_jabatan = new DbField('gaji_sma', 'gaji_sma', 'x_tj_jabatan', 'tj_jabatan', '`tj_jabatan`', '`tj_jabatan`', 20, 19, -1, FALSE, '`tj_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sub_total
		$this->sub_total = new DbField('gaji_sma', 'gaji_sma', 'x_sub_total', 'sub_total', '`sub_total`', '`sub_total`', 20, 19, -1, FALSE, '`sub_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// potongan_bendahara
		$this->potongan_bendahara = new DbField('gaji_sma', 'gaji_sma', 'x_potongan_bendahara', 'potongan_bendahara', '`potongan_bendahara`', '`potongan_bendahara`', 20, 20, -1, FALSE, '`potongan_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// voucher
		$this->voucher = new DbField('gaji_sma', 'gaji_sma', 'x_voucher', 'voucher', '`voucher`', '`voucher`', 20, 20, -1, FALSE, '`voucher`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('gaji_sma', 'gaji_sma', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		// Master filter
		$masterFilter = "";
		if ($this->getCurrentMasterTable() == "m_sma") {
			if ($this->bulan->getSessionValue() != "")
				$masterFilter .= "`bulan`=" . QuotedValue($this->bulan->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->pid->getSessionValue() != "")
				$masterFilter .= " AND `id`=" . QuotedValue($this->pid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "m_sma") {
			if ($this->bulan->getSessionValue() != "")
				$detailFilter .= "`bulan`=" . QuotedValue($this->bulan->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->pid->getSessionValue() != "")
	...
	// Master filter
	public function sqlMasterFilter_m_sma()
	{
		return "`bulan`=@bulan@ AND `id`=@id@ AND `tahun`=@tahun@";
	}

	// Detail filter
	public function sqlDetailFilter_m_sma()
	{
		return "`bulan`=@bulan@ AND `pid`=@pid@ AND `tahun`=@tahun@";
	}

	// Table level SQL
	public function getSqlFrom() // From
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`gaji_sma`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "gaji_smaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "gaji_smaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("gaji_smaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("gaji_smaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "gaji_smaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "gaji_smaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_smaedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("gaji_smaadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("gaji_smadelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "m_sma" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		// To cancel, set return value to FALSE
													...
													$jabatan = $rsnew["jabatan_id"];
														...
														$tahun = $rsnew["tahun"];
														$bulan = $rsnew["bulan"];
														$absen =ExecuteRow("SELECT * FROM absen INNER JOIN absen_detil ON absen.id = absen_detil.pid WHERE absen_detil.pegawai='$nip' AND absen.bulan='$bulan' AND absen.tahun='$tahun'");

														//POTONGAN
														$querypotongan = ExecuteRow("SELECT * from potongan_sma WHERE nama='$nip' AND tahun ='$tahun' AND bulan='$bulan'ORDER BY id DESC");
														...
														//kehadiran
														$kehadiran= ExecuteRow("Select * from m_kehadiran where jenjang='4' AND jenis_jabatan='$type' AND sertif='$sertif'");	
														...
														// Gaji Pokok	
														$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND lama_kerja='$lama_kerja'");
														$rsnew["kehadiran"] = $absen["masuk"];
														$rsnew["piket_count"] = $absen["piket"];
														$rsnew["lembur"] = $absen["lembur"];	
