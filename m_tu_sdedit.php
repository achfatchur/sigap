...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="m_tu_sd" data-field="x_bulan" data-value-separator="<?php echo $m_tu_sd_edit->bulan->displayValueSeparatorAttribute() ?>" id="x_bulan" name="x_bulan"<?php echo $m_tu_sd_edit->bulan->editAttributes() ?>>
			<?php echo $m_tu_sd_edit->bulan->selectOptionListHtml("x_bulan") ?>
		</select>
</div>
