...
WHERE pegawai.type IS NOT NULL AND pegawai.jabatan = 151");	
//print_r($sql);
//die;
$data = [];
...
$template = 'template_yayasan_excel.xlsx';
$TBS->LoadTemplate($template, OPENTBS_ALREADY_UTF8);
$TBS->MergeBlock('data', $data);
$dateyear = date("F Y");
$TBS->Show(OPENTBS_DOWNLOAD, $dateyear.' Template Penyesuaian yayasan.xlsx');
exit();
?>